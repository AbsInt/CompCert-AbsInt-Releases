...
Proof.
  intros. functional inversion H; subst.
  (* addimm - addimm *)
  - UseGetSound. exists r; split; auto. rewrite <- H0. simpl. rewrite <- H1. rewrite Val.add_assoc. auto.
  (* addimm - subimm *)
  - Opaque Val.sub.
...
Transparent Val.sub.
  ...
  - UseGetSound. exists r; split; auto. rewrite <- H0. simpl. rewrite <- H1.
    ...
    rewrite Int.and_assoc. fold p. rewrite H2. auto.
  - UseGetSound. exists r; split; auto. rewrite <- H0. simpl. rewrite <- H1.
    destruct v; simpl; auto. unfold Int.rolm.
