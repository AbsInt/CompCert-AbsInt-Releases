...
Definition transl_load_store_multiple_condition l ofs :=
  ...
  | (m1 :: m2 :: l0, l1) => list_eq_dec preg_eq (map preg_of (m1 :: m2 :: l0)) (map IR (compute_ireg_list (preg_of m1)))
...
Definition transl_instr (f: Mach.function) (i: Mach.instruction)
  ...
  | Mrestorecallee ofs l =>
    if transl_load_store_multiple_condition l ofs then
      match split_by_type l with
      | (m1 :: l1, l2) => do r1 <- ireg_of m1;
                        do c <- transl_restorecallee_unroll (reg_list_offset (m1 :: l1) ofs) l2 k;
                        OK (Pe_lmw r1 SP (Cint (Int.repr (align ofs 4))) :: c)
      | _ => transl_restorecallee_unroll ofs l k
      end
    else
      match l with
  ...
  | Msavecallee ofs l =>
    if transl_load_store_multiple_condition l ofs then
      match split_by_type l with
      | (m1 :: l1, l2) => do r1 <- ireg_of m1;
                        do c <- transl_savecallee_unroll (reg_list_offset (m1 :: l1) ofs) l2 k;
                        OK (Pe_stmw r1 SP (Cint (Int.repr (align ofs 4))) :: c)
      | _ => transl_savecallee_unroll ofs l k
      end
    else
      match l with
