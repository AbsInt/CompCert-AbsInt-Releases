...
Lemma addimm_base_correct:
  forall (r1 r2: ireg) n k rs m,
  r1 <> GPR0 ->
  r2 <> GPR0 ->
  exists rs',
     exec_straight ge fn (addimm_base r1 r2 n k) rs m  k rs' m
...
Proof.
  ...
  split; intros; Simpl. rewrite Val.add_assoc. simpl.
...
Proof.
  ...
  destruct r1; try (apply addimm_base_correct); auto.
  destruct (Int.lt Int.zero n && Int.lt n (Int.repr 33)), (ireg_eq s r2); try (apply addimm_base_correct); auto.
  subst r2. econstructor; split. apply exec_straight_one; simpl; reflexivity.
  intuition Simpl.
Qed.
...
Proof.
  ...
  rewrite (OTHER1 r2); eauto with asmgen.
  reflexivity.
