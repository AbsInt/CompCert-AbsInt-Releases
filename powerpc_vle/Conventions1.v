...
Definition dummy_regs := R3 :: ErrorReg :: nil. (**r Used in [Coloring]. *)
...
Fixpoint loc_arguments_rec
  ...
  | Tlong :: tys =>
      ...
      | Some r1, Some r2 =>
          Two (R r1) (R r2) :: loc_arguments_rec tys (r + 2) ofs
      | _, _ =>
          let ofs := align ofs 2 in
          Two (S Outgoing ofs Tint) (S Outgoing (ofs + 1) Tint) ::
...
Proof.
  ...
  assert (A: forall r, In r param_regs -> is_caller_save r = true) by decide_goal.
