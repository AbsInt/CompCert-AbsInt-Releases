...
let mnemonic_names = StringSet.of_list
    ...
    ; "Pxor"
    (* e encoding *)
    ; "Pe_add16i"; "Pe_addi"; "Pe_add2is"; "Pe_addic"; "Pe_and2i_"; "Pe_and2is_"; "Pe_andi_"
    ; "Pe_b"; "Pe_bl"; "Pe_bs"
    ; "Pe_cmp16i"; "Pe_cmpl16i"; "Pe_creqv"; "Pe_cror"; "Pe_crxor"
    ; "Pe_mulli"; "Pe_mull2i"
    ; "Pe_lbz"; "Pe_lha"; "Pe_lhz"; "Pe_li"; "Pe_lis"; "Pe_lmw"; "Pe_lwz"; "Pe_lwzu"
    ; "Pe_or2i"; "Pe_or2is"; "Pe_ori"
    ; "Pe_rlwimi"; "Pe_rlwinm"
    ; "Pe_stb"; "Pe_sth"; "Pe_stmw"; "Pe_stw"; "Pe_stwu"; "Pe_subfic"
    ; "Pe_xori"
    (* se encoding *)
...
let pp_instructions pp ic =
  ...
  | Pe_mulli (ir1,ir2,n) -> instruction pp "Pe_mulli" [Ireg ir1; Ireg ir2; (Constant (Cint n))]
  | Pe_mull2i (ir1,n) -> instruction pp "Pe_mull2i" [Ireg ir1; Ireg ir1; (Constant (Cint n))] (* converted to explicit 3-address form for exec2crl compatibility *)
  ...
  | Pe_andi_ (rd, r1, n) -> instruction pp "Pe_andi_" [Ireg rd; Ireg r1; Constant (Cint n)]
  ...
  | Pe_addi (ir1,ir2,n) -> instruction pp "Pe_addi" [Ireg ir1; Ireg ir2; Constant (Cint n)]
  ...
  | Pe_lmw (r1, r2, c) -> instruction pp "Pe_lmw" [Ireg r1; Constant c; Ireg r2]
  | Pe_lwz (ir1,c,ir2)
  | Pfe_lwz (ir1,c,ir2)
  ...
  | Pe_ori (rd,r1,c) -> instruction pp "Pe_ori" [Ireg rd; Ireg r1; Constant (Cint c)]
  ...
  | Pe_stmw (r1, r2, c) -> instruction pp "Pe_stmw" [Ireg r1; Constant c; Ireg r2]
  | Pe_stw (ir1,c,ir2)
  | Pfe_stw (ir1,c,ir2)
