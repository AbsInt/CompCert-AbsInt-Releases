...
Proof.
  ...
  eapply tail_nolabel_trans. eapply addi_low_label. TailNoLabel.
Qed.
...
Proof.
  ...
  unfold select_encoding_instr. destruct r1; TailNoLabel.
  destruct r2; TailNoLabel. destruct (sreg_eq s s0), (sreg_eq s GPR0); simpl; TailNoLabel.
Qed.
...
Proof.
  ...
  case (Int.eq (Int.shru n (Int.repr 8)) Int.zero). TailNoLabel.
