...
Remark addimm_base_label:
  forall r1 r2 n k, tail_nolabel k (addimm_base r1 r2 n k).
Proof.
  intros; unfold addimm_base.
  case (Int.eq (high_s n) Int.zero). TailNoLabel.
  case (Int.eq (low_s n) Int.zero); TailNoLabel.
  eapply tail_nolabel_trans. eapply move_rr_label.
  TailNoLabel.
Qed.
Hint Resolve addimm_base_label: labels.

Remark addimm_label:
  forall r1 r2 n k, tail_nolabel k (addimm r1 r2 n k).
Proof.
  intros; unfold addimm.
  destruct r1; TailNoLabel.
  destruct (Int.lt Int.zero n && Int.lt n (Int.repr 33) && (ireg_eq s r2)); TailNoLabel.
Qed.
