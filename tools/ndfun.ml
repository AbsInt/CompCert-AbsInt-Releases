...
(*- E_COMPCERT_DEACTIVATED_CODE_NDFun_001 *)
(*- #Condition "Code is not compiled into CompCert." *)
(*- #Justification "Code is not part of CompCert" *)

(*- E_COMPCERT_CODE_NDFun_001 *)
(*- #Justify_Derived "Module ndfun.ml is an external helper tool. It preprocesses Coq code and is not part of CompCert." *)
