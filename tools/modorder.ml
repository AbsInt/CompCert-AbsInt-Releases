...
(*- E_COMPCERT_DEACTIVATED_CODE_Modorder_001 *)
(*- #Condition "Code is not compiled into CompCert." *)
(*- #Justification "Code is not part of CompCert" *)

(*- E_COMPCERT_CODE_Modorder_001 *)
(*- #Justify_Derived "Module modorder.ml is an external helper tool. It computes module dependencies and is not part of CompCert." *)
