...
let mnemonic_names = StringSet.of_list
    [ "Padc"; "Padd"; "Padds"; "Pand";"Pannot"; "Pasr"; "Pb"; "Pbc"; "Pbic";
      ...
      "Pfmovite"; "Pmovt"; "Pmovw"; "Pmul"; "Pmvn";  "Ploadsymbol_imm"; "Pnop";
      "Porr"; "Ppush"; "Prev"; "Prev16"; "Prsb"; "Prsbs"; "Prsc"; "Psbc";
      "Psbfx"; "Psdiv"; "Psmull"; "Pstm"; "Pstr"; "Pstr_p"; "Pstrb"; "Pstrb_p";
      "Pstrh"; "Pstrh_p"; "Psub"; "Psubs"; "Pudiv";"Pumull" ]
...
let pp_instructions pp ic =
  ...
  let [@ocaml.warning "+4"] instruction pp = function
    ...
    | Pfldm(r1, rl) -> instruction pp "Pfldm" ((Ireg r1)::(List.map (fun r -> DFreg r) rl))
    ...
    | Pfstm(r1, rl) -> instruction pp "Pfstm" ((Ireg r1)::(List.map (fun r -> DFreg r) rl))
