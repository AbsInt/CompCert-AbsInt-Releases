...
let mnemonic_names = StringSet.of_list
    [ "Padc"; "Padd"; "Padds"; "Pand";"Pannot"; "Pasr"; "Pb"; "Pbc"; "Pbic";
      ...
      "Pcmn"; "Pconstants"; "Pfcpy_iif"; "Pfcpy_fii"; "Pfcpy_fi"; "Pflid_lbl";
      "Pflis_lbl"; "Pdmb"; "Pdsb"; "Peor"; "Pfabsd"; "Pfabss"; "Pfaddd";
      "Pfadds"; "Pfcmpd"; "Pfcmps"; "Pfcmpzd"; "Pfcmpzs"; "Pfcpyd"; "Pfcpys";
      "Pfcpy_if";"Pfcvtds"; "Pfcvtsd"; "Pfdivd"; "Pfdivs"; "Pfldd";
      "Pflds"; "Pflid_imm"; "Pflis_imm"; "Pfldm"; "Pfmuld"; "Pfmuls";
      "Pfnegd"; "Pfnegs"; "Pfsitod"; "Pfsitos"; "Pfsqrt"; "Pfstd"; "Pfsts";
      "Pfstm"; "Pfsubd"; "Pfsubs"; "Pftosizd"; "Pftosizs"; "Pftouizd";
      "Pftouizs"; "Pfuitod"; "Pfuitos"; "Pinlineasm"; "Pisb"; "Plabel"; "Pldm";
      "Pldr"; "Ploadsymbol_lbl"; "Pldr_p"; "Pldrb"; "Pldrb_p"; "Pldrh";
      "Pldrh_p"; "Pldrsb"; "Pldrsh"; "Plsl"; "Plsr"; "Plsrs"; "Pmla"; "Pmov"; "Pmovite"; "Pmovitel";
      "Pfmovited"; "Pfmovites"; "Pmovt"; "Pmovw"; "Pmul"; "Pmvn"; 
      "Ploadsymbol_imm"; "Pnop"; "Porr"; "Ppush"; "Prev"; "Prev16"; "Prrx"; "Prsb";
      "Prsbs"; "Prsc"; "Psbc";  "Psbcs"; "Psbfx"; "Psdiv"; "Psmull"; "Pstm"; "Pstr";
      "Pstr_p"; "Pstrb"; "Pstrb_p"; "Pstrh"; "Pstrh_p"; "Psub"; "Psubs";
      "Pudiv";"Pumull" ]
(*- #End *)
...
(*- E_COMPCERT_CODE_AsmToJson_makedata_001 *)
...
(*- E_COMPCERT_CODE_AsmToJson_pp_pp_freg_pair_001 *)
(*- #Justify_Derived "Utility function" *)
let pp_freg_pair pp reg =
  pp_reg pp (TargetPrinter.double_reg_name reg)
(*- #End *)

(*- E_COMPCERT_CODE_AsmToJson_pp_freg_001 *)
(*- #Justify_Derived "Utility function" *)
let pp_freg pp reg =
  pp_reg pp (TargetPrinter.single_reg_name reg)
(*- #End *)

(*- E_COMPCERT_CODE_AsmToJson_pp_shiftreg_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_AsmToJson_pp_shiftop_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_AsmToJson_pp_testcond_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_AsmToJson_pp_symbol_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- #Link_to E_COMPCERT_TR_Function_VALEX_001 *)
let pp_instructions pp ic =
  ...
  let [@ocaml.warning "+4"] instruction pp = function
    ...
    | Pasr(r1, r2, so) -> instruction pp "Pasr" [Ireg r1; Ireg r2; Shift so]
    ...
    | Pfldm(r1, rl) -> instruction pp "Pfldm" ((Ireg r1)::(List.map (fun r -> Freg_pair r) rl))
    ...
    | Pfstm(r1, rl) -> instruction pp "Pfstm" ((Ireg r1)::(List.map (fun r -> Freg_pair r) rl))
    ...
    | Pldm(r1, rl) -> instruction pp "Pldm" ((Ireg r1)::(List.map (fun r -> Ireg r) rl))
    ...
    | Plsr(r1, r2, so) -> instruction pp "Plsr" [Ireg r1; Ireg r2; Shift so]
    | Plsrs(r1, r2, so) -> instruction pp "Plsrs" [Ireg r1; Ireg r2; Shift so]
    ...
    | Pmovitel(cond, (rh, rl), (ifsoh, ifsol), (ifnoth, ifnotl)) -> instruction pp "Pmovitel" [Ireg rh; Ireg rl; Condition (TargetPrinter.condition_name cond); Ireg ifsoh; Ireg ifsol; Condition (TargetPrinter.neg_condition_name cond); Ireg ifnoth; Ireg ifnotl]
    ...
    | Pmvn'(r1, r2) -> instruction pp "Pmvn" [Ireg r1; Shift (SOreg r2)]
    ...
    | Prrx(r1, r2) -> instruction pp "Prrx" [Ireg r1; Ireg r2]
    | Psbc(r1, r2, so) -> instruction pp "Psbc" [Ireg r1; Ireg r2; Shift so]
    | Psbcs(r1, r2, so) -> instruction pp "Psbcs" [Ireg r1; Ireg r2; Shift so]
    ...
    | Pstm(r1, rl) -> instruction pp "Pstm" ((Ireg r1)::(List.map (fun r -> Ireg r) rl))
