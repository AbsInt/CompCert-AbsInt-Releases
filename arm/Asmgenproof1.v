...
Proof.
  ...
  destruct (thumb tt && ireg_eq r1 SP && ireg_eq r2 SP && Int.ltu n (Int.repr 256)) eqn:H; [|clear H].
  econstructor; split. apply exec_straight_one; simpl; auto.
  do 3 (apply andb_true_iff in H; destruct H as [H]).
  destruct r1; inv H2. destruct r2; inv H1.
  split; intros; Simpl.
  destruct (Int.ltu (Int.repr (-256)) n).
  (* sub *)
  destruct (thumb tt && ireg_eq r1 SP && ireg_eq r2 SP) eqn:H.
  econstructor; split. apply exec_straight_one; simpl; auto.
  do 2 (apply andb_true_iff in H; destruct H as [H ]).
  destruct r1; inv H1.  destruct r2; inv H0.
