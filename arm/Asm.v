...
(*- E_COMPCERT_FTR_Function_Asm_dreg_0_001 *)
(*- #Justify_Derived "Internal type for double registers" *)
Inductive dreg: Type :=
...
(*- E_COMPCERT_FTR_Function_Asm_dreg_eq_001 *)
(*- #Justify_Derived "Internal equality function for double registers" *)
...
(*- E_COMPCERT_FTR_Function_Asm_crbit_eq_001 *)
(*- #Justify_Derived "Internal equality function for condition bits" *)
...
(*- E_COMPCERT_FTR_Function_Asm_freg_pair_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition freg_pair : Set := freg * freg.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Asm_ireg_pair_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition ireg_pair: Set := ireg * ireg.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Asm_preg_pair_001 *)
(*- #Justify_Derived "Internal type for pairs of pregs" *)
Definition preg_pair : Set := preg * preg.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Asm_coerce_pairs_001 *)
(*- #Justify_Derived "Internal coercions" *)
...
Module IndexedPreg <: INDEXED_TYPE.
  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_all_pregs_001 *)
  (*- #Justify_Derived "Internal constant list containing all registers" *)
  Definition all_pregs : list preg :=
     IR IR0  :: IR IR1  :: IR IR2  :: IR IR3  :: IR IR4  :: IR IR5  :: IR IR6  :: IR IR7
     :: IR IR8  :: IR IR9  :: IR IR10 :: IR IR11 :: IR IR12 :: IR IR13 :: IR IR14
     ...
     :: AllocReg DR0  :: AllocReg DR1  :: AllocReg DR2  :: AllocReg DR3  :: AllocReg DR4  :: AllocReg DR5
     :: AllocReg DR6  :: AllocReg DR7  :: AllocReg DR8  :: AllocReg DR9  :: AllocReg DR10 :: AllocReg DR11
     :: AllocReg DR11 :: AllocReg DR12 :: AllocReg DR13 :: AllocReg DR14 :: AllocReg DR15
     :: CR CN :: CR CZ :: CR CC :: CR CV :: PC :: ErrorReg :: nil.
  (*- #End *)

  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_all_pregs_complete_001 *)
  (*- #Justify_Derived "Auxiliary lemma" *)
  Lemma all_pregs_complete:
    forall (r: preg), In r all_pregs.
  Proof.
    assert (forall r, proj_sumbool (In_dec preg_eq r all_pregs) = true) by (destruct r as [r | r | r | | | r]; try destruct r; reflexivity).
    intros. specialize (H r). InvBooleans. auto.
  Qed.
 (*- #End *)

  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_Decidable_eq_preg_001 *)
  (*- #Justify_Derived "Auxliary instance" *)
  Local Instance Decidable_eq_preg: forall (x y: preg), Decidable (eq x y) := Decidable_eq preg_eq.
  (*- #End *)
  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_Finite_preg_001 *)
  (*- #Justify_Derived "Auxliary instance" *)
  Local Instance Finite_preg : Finite preg := {
      Finite_elements := all_pregs;
      Finite_elements_spec := all_pregs_complete
  }.
  (*- #End *)
  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_t_001 *)
  (*- #Justify_Derived "Internal type for indexed pregs" *)
  Definition t := preg.
  (*- #End *)
  Definition eq := preg_eq.
  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_index_001 *)
  (*- #Justify_Derived "Internal definition to map pregs to integers" *)
  Definition index (r: preg): positive :=
    match r with
    | IR0 => 1  | IR1 => 2  | IR2 => 3  | IR3 => 4
    | IR4 => 5  | IR5 => 6  | IR6 => 7  | IR7 => 8
    | IR8 => 9  | IR9 => 10 | IR10 => 11 | IR11 => 12
    | IR12 => 13 | IR13 => 14 | IR14 => 15
    | FR0 => 16 | FR1 => 17 | FR2 => 18 | FR3 => 19
    | FR4 => 20 | FR5 => 21 | FR6 => 22 | FR7 => 23
    | FR8 => 24 | FR9 => 25 | FR10 => 26 | FR11 => 27
    | FR12 => 28 | FR13 => 29 | FR14 => 30 | FR15 => 31
    | FR16 => 32 | FR17 => 33 | FR18 => 34 | FR19 => 35
    | FR20 => 36 | FR21 => 37 | FR22 => 38 | FR23 => 39
    | FR24 => 40 | FR25 => 41 | FR26 => 42 | FR27 => 43
    | FR28 => 44 | FR29 => 45 | FR30 => 46 | FR31 => 47
    | DR0 => 48  | DR1 => 49  | DR2 => 50  | DR3 => 51
    | DR4 => 52  | DR5 => 53  | DR6 => 54  | DR7 => 55
    | DR8 => 56  | DR9 => 57 | DR10 => 58 | DR11 => 59
    | DR12 => 60 | DR13 => 61 | DR14 => 62 | DR15 => 63
    | CN => 64 | CZ => 65 | CC => 66 | CV => 67
    | PC => 68 | ErrorReg => 69
    end.
  (*- #End *)

  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_index_inj_001 *)
  (*- #Justify_Derived "Auxiliary lemma" *)
  Lemma index_inj:
...
Module PregOrd := OrderedIndexed(IndexedPreg).
Module PregOrdFacts := OrderedTypeFacts(PregOrd).
...
(*- E_COMPCERT_FTR_Function_Asm_shift_op_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_testcond_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_code_constant_0_001 *)
(*- #Justify_Derived "Internal type used for constants in code" *)
...
Inductive instruction : Type :=
  ...
  | Pasr: ireg -> ireg -> shift_op -> instruction (**r arithmetic shift right *)
  ...
  | Pldm: ireg -> list ireg -> instruction (**r load multiple any32 *)
  ...
  | Plsr: ireg -> ireg -> shift_op -> instruction   (**r logical shift right *)
  | Plsrs: ireg -> ireg -> shift_op -> instruction  (**r logical shift right with update of condition flags *)
  ...
  | Pmvn': ireg -> ireg -> instruction             (**r integer complement, preserve carry *)
  | Porr: ireg -> ireg -> shift_op -> instruction  (**r bitwise or *)
  | Ppush: list ireg -> instruction (**r push registers on the stack instruction *)
  | Prsb: ireg -> ireg -> shift_op -> instruction  (**r integer reverse subtraction *)
  | Prrx: ireg -> ireg -> instruction             (**r rotate right with extend *)
  | Psbfx: ireg -> ireg -> int -> int -> instruction (**r signed bitfield extract *)
  | Pstm: ireg -> list ireg -> instruction (**r store multiple any32 *)
  ...
  | Pfldm: ireg -> list freg_pair -> instruction        (**r any64 load multiple to FP regs *)
  ...
  | Pfstm: ireg -> list freg_pair -> instruction        (**r any64 store from list of FP regs *)
  (* Pseudo-instructions *)
  ...
  | Pmovitel: testcond -> ireg_pair -> ireg_pair -> ireg_pair -> instruction (**r integer 64 bit conditional move *)
  ...
  | Pcfi_adjust: ptrofs -> instruction                   (**r .cfi_adjust debug directive *)
  | Pcfi_rel_offset: ptrofs -> instruction               (**r .cfi_rel_offset debug directive *)
  ...
  | Psbc: ireg -> ireg -> shift_op -> instruction     (**r sub with carry *)
  | Psbcs: ireg -> ireg -> shift_op -> instruction     (**r sub with carry with update of condition flags *)
...
(*- E_COMPCERT_FTR_Function_Asm_undef_flags_001 *)
(*- #Justify_Derived "Internal function to set flag registers to undefined" *)
...
(*- E_COMPCERT_FTR_Function_Asm_set_preg_pair_001 *)
...
(*- E_COMPCERT_FTR_Function_Asm_get_preg_pair_001 *)
(*- #Justify_Derived "Internal function to get the value of a register pair in the register mapping" *)
...
(*- E_COMPCERT_FTR_Function_Asm_get_pair_001 *)
(*- #Justify_Derived "Internal function to get the value of a register pair in the register mapping" *)
...
(*- E_COMPCERT_FTR_Function_Asm_set_res_pair_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
(*- E_COMPCERT_FTR_Function_Asm_nextinstr_nf_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
(*- E_COMPCERT_FTR_Function_Asm_eval_shift_op_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_exec_load_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_exec_store_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_exec_loadp_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_exec_storep_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_load_split_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition load_split (addr: val) (p: preg_pair) (rs: regset) (m: mem) :=
  let hireg := if Archi.big_endian then snd p else fst p in
  let loreg := if Archi.big_endian then fst p else snd p in
  match Mem.loadv Many32 m addr, Mem.loadv Many32 m (Val.add addr (Vint (Int.repr 4))) with
  | Some v1, Some v2 => Some (rs # hireg <- v2) # loreg <- v1
  | _, _ => None
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Asm_store_split_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition store_split (addr: val) (p: preg_pair) (rs: regset) (m: mem) :=
  let hireg := if Archi.big_endian then snd p else fst p in
  let loreg := if Archi.big_endian then fst p else snd p in
...
(*- E_COMPCERT_FTR_Function_Asm_exec_ldm_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Fixpoint exec_ldm (r1: ireg) (base: val) (l: list ireg) (rs: regset) (m: mem) :=
  match l with
  | r::l => match Mem.loadv Many32 m base with
          | Some v => exec_ldm r1 (Val.offset_ptr base (Ptrofs.repr 4)) l (rs#r <- v) m
          | None => Stuck
          end
  | nil => Next (nextinstr rs#r1 <- base) m
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Asm_exec_stm_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Fixpoint exec_stm (r1: ireg) (base: val) (l: list ireg) (rs: regset) (m: mem) :=
  match l with
  | r::l => match Mem.storev Many32 m base (rs r) with
           | Some m' => exec_stm r1 (Val.offset_ptr base (Ptrofs.repr 4)) l rs m'
           | None => Stuck
           end
  | nil => Next (nextinstr rs#r1 <- base) m
  end.
...
(*- E_COMPCERT_FTR_Function_Asm_exec_fldm_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Fixpoint exec_fldm (base: val) (l: list freg_pair) (rs: regset) (m: mem) :=
  match l with
  | p::l => match load_split base p rs m with
          | Some rs' => exec_fldm (Val.offset_ptr base (Ptrofs.repr 8)) l rs' m
          | None => Stuck
          end
  | nil => Next (nextinstr rs) m
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Asm_exec_fstm_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Fixpoint exec_fstm (base: val) (l: list freg_pair) (rs: regset) (m: mem) :=
  match l with
  | p::l => match store_split base p rs m with
           | Some m' => exec_fstm (Val.offset_ptr base (Ptrofs.repr 8)) l rs m'
           | None => Stuck
           end
  | nil => Next (nextinstr rs) m
  end.
...
(*- E_COMPCERT_FTR_Function_Asm_ldstm_iregs_condition_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition ldstm_iregs_condition r1 (l: list ireg) :=
  let rl := (map IR l) in
  LocallySorted_dec PregOrd.lt PregOrdFacts.lt_dec rl && negb (In_dec preg_eq (IR r1) rl).
(*- #End *)

(* Check that the list of freg_pairs is consecutive by comparing the hireg of the first and loreg of the second pair *)
(*- E_COMPCERT_FTR_Function_Asm_ldstm_fregs_condition_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition ldstm_fregs_condition (l: list freg_pair) : bool :=
  LocallySorted_dec
    (fun p0 p1 => Pos.succ(IndexedPreg.index (FR (fst p0))) = (IndexedPreg.index (FR (snd p1))))
    (fun p0 p1 => Pos.eq_dec (Pos.succ(IndexedPreg.index (FR (fst p0)))) (IndexedPreg.index (FR (snd p1)))) l.
(*- #End *)

(** Comparisons. *)

(*- E_COMPCERT_FTR_Function_Asm_compare_int_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_compare_float_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_compare_float32_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Asm_eval_testcond_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
Definition exec_instr (f: function) (i: instruction) (rs: regset) (m: mem) : outcome :=
  ...
  | Pasr r1 r2 so =>
      Next (nextinstr_nf (rs#r1 <- (Val.shr rs#r2 (eval_shift_op so rs)))) m
  | Pb lbl =>
  ...
  | Pldm r1 rl =>
      if ldstm_iregs_condition r1 rl
      then
        match rl with
        | nil => Stuck
        | _ => exec_ldm r1 (rs r1) rl rs m
        end
      else Stuck
  | Pldr r1 r2 sa =>
  ...
  | Plsr r1 r2 sa =>
      Next (nextinstr_nf (rs#r1 <- (Val.shru rs#r2 (eval_shift_op sa rs)))) m
  | Pmla r1 r2 r3 r4 =>
  ...
  | Pmvn' rd r =>
      Next (nextinstr (rs#rd <- (Val.notint rs#r)
                         #CC <- (rs#CC)
                         #CN <- Vundef
                         #CZ <- Vundef
                         #CV <- Vundef)) m
  ...
  | Pfcpy_iif rl rh p =>
      let bits := Val.bitsoffloat (get_preg_pair p rs) in
      Next (nextinstr (rs#rh <- (Val.hiword bits)
                         #rl <- (Val.loword bits))) m
  | Pfldd p1 r2 n => exec_loadp Mfloat64 (Val.add rs#r2 (Vint n)) p1 rs m
  | Pfldd_a p1 r2 n =>
      match load_split (Val.add rs#r2 (Vint n)) p1 rs m with
      | Some rs' => Next (nextinstr rs') m
      | None => Stuck
      end
  ...
  | Pfldm r1 rl =>
      if ldstm_fregs_condition rl then
        match rl with
        | nil => Stuck
        | _ => exec_fldm (rs r1) rl rs m
        end
      else Stuck
  | Pfstd p1 r2 n => exec_storep Mfloat64 (Val.add rs#r2 (Vint n)) p1 rs m
  | Pfstd_a p1 r2 n =>
      match store_split (Val.add rs#r2 (Vint n)) p1 rs m with
      | Some m' => Next (nextinstr rs) m'
      | None => Stuck
      end
  ...
  | Pmovitel cond (rdh, rdl) (ifsoh, ifsol) (ifnoth, ifnotl) =>
      match eval_testcond cond rs with
      | Some b =>
          let rs1 := rs#rdl <- (if b then rs#ifsol else rs#ifnotl) in
          let rs2 := rs1#rdh <- (if b then rs1#ifsoh else rs1#ifnoth) in
          Next (nextinstr rs2) m
      | None =>
          Next (nextinstr (set_preg_pair (IR rdh, IR rdl) Vundef rs)) m
      end
  ...
  | Padds rd r1 sa =>
      let sa := eval_shift_op sa rs in
      Next (nextinstr (rs#rd <- (Val.add rs#r1 sa)
                         #CC <- (Val.add_carry rs#r1 sa Vzero)
                         #CN <- Vundef
                         #CZ <- Vundef
                         #CV <- Vundef)) m
  | Padc rd r1 sa =>
      let sa := eval_shift_op sa rs in
      Next (nextinstr_nf (rs#rd <- (Val.add (Val.add rs#r1 sa) rs#CC))) m
  | Psubs rd r1 sa =>
      let sa := Val.notint (eval_shift_op sa rs) in
      Next (nextinstr (rs#rd <- (Val.add rs#r1 (Val.add sa Vone))
                         #CC <- (Val.add_carry rs#r1 sa Vone)
                         #CN <- Vundef
                         #CZ <- Vundef
                         #CV <- Vundef)) m
  | Psbc rd r1 sa =>
  ...
  | Prsbs rd r1 sa =>
      let sa := eval_shift_op sa rs in
      let rv1 := Val.notint rs#r1 in
      Next (nextinstr (rs#rd <- (Val.add rv1 (Val.add sa Vone))
                         #CC <- (Val.add_carry rv1 sa Vone)
                         #CN <- Vundef
                         #CZ <- Vundef
                         #CV <- Vundef)) m
  | Prsc rd r1 sa =>
      let sa := eval_shift_op sa rs in
      let rv1 := Val.notint rs#r1 in
      Next (nextinstr_nf (rs#rd <- (Val.add (Val.add rv1 sa) rs#CC))) m
  | Pcfi_rel_offset ofs =>
      Next (nextinstr rs) m
