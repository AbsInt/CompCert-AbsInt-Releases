...
(*- E_COMPCERT_CODE_PrintOp_comparison_name_001 *)
...
(*- E_COMPCERT_CODE_PrintOp_shift_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintOp_print_condition_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintOp_print_operation_001 *)
(*- #Justify_Derived "Utility function" *)
let print_operation reg pp = function
  | Omove, [r1] -> reg pp r1
  | Ointconst n, [] -> fprintf pp "%ld" (camlint_of_coqint n)
  | Olongconst n, [] -> fprintf pp "%Ld" (camlint64_of_coqint n)
  ...
  | Oumull, [r1;r2] -> fprintf pp "umull(%a, %a)" reg r1 reg r2
  ...
  | Obitsoffloat, [r1] -> fprintf pp "bitsoffloat(%a)" reg r1
...
(*- E_COMPCERT_CODE_PrintOp_print_addressing_001 *)
(*- #Justify_Derived "Utility function" *)
