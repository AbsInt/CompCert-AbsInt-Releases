...
(*- E_COMPCERT_FTR_Function_Op_shift_amount_0_001 *)
...
(*- E_COMPCERT_FTR_Function_Op_shift_0_001 *)
(*- #Justify_Derived "Internal type" *)
...
(*c Integer arithmetic: *)
  ...
  | Oumull: operation                   (**r [rd = r1 * r2, 64 bit unsigned] *)
...
(*c Conversions between int and float: *)
  ...
  | Obitsoffloat: operation              (**r [rd = to_bits(r1)] *)
...
Proof.
  generalize Int.eq_dec Int64.eq_dec Ptrofs.eq_dec ident_eq typ_eq; intros.
...
Definition eval_operation
  ...
  | Oumull, v1 :: v2 :: nil => Some (Val.mull' v1 v2)
  ...
  | Obitsoffloat, v1::nil => Some (Val.bitsoffloat v1)
...
Proof with (try exact I; try reflexivity).
  ...
  intros.
  destruct op; simpl; simpl in H0; FuncInv;
    compute in H1; inv H1; try subst v...
  congruence.
...
Definition symbol_addressing (addr: addressing) : option (ident * ptrofs) := None.
