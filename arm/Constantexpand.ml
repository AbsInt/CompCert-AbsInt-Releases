...
(*- E_COMPCERT_CODE_Constantexpand_zero_001 *)
...
(*- E_COMPCERT_CODE_Constantexpand_vfpv3_001 *)
(*- #Justify_Derived "Utility constants" *)
...
(*- E_COMPCERT_CODE_Constantexpand_state_001 *)
(*- #Justify_Derived "Internal state" *)
let currpos = ref 0
let size_constants = ref 0
let max_pos_constants = ref max_int
(*- #End *)

(*- E_COMPCERT_CODE_Constantexpand_distance_to_emit_constants_001 *)
...
(*- E_COMPCERT_CODE_Constantexpand_state_002 *)
(*- #Justify_Derived "Internal state" *)
...
let symbol_labels =
  (Hashtbl.create 39 : (ident * Ptrofs.int, label) Hashtbl.t)
(*- #End *)

(*- E_COMPCERT_CODE_Constantexpand_get_label_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_label_002 *)
(*- #Justify_Derived "Utility wrappers" *)
...
(*- E_COMPCERT_CODE_Constantexpand_reset_constants_001 *)
(*- #Justify_Derived "Utility function" *)
let reset_constants () =
...
(*- E_COMPCERT_CODE_Constantexpand_is_immediate_float64_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_is_immediate_float32_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_no_fallthrough_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_estimate_size_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_expand_constants_001 *)
(*- #Justify_Derived "Utility function" *)
let expand_constants () =
  let fold f tbl a =
    List.fold_left f a
      (* Sort according to the labels, we sort in descending order, so that after the fold_left the
         values are in ascending order *)
      (List.fast_sort (fun (lbl1, _) (lbl2, _) -> - (P.compare lbl1 lbl2))
         (Hashtbl.fold (fun r lbl accu -> (lbl, r) :: accu) tbl []))
  in
  let consts =
    fold (fun c (lbl, (id, ofs)) -> Symbol (lbl, id, ofs) :: c) symbol_labels [] in
  let consts =
    fold (fun c (lbl, bf) -> Float64 (lbl, bf)::c) float_labels consts in
  let consts =
    fold (fun c (lbl, bf) -> Float32 (lbl, bf) :: c) float32_labels consts in
  (* The order of the constants should be float32, float64 and then symbols, since
     symbols allow largers offsets. *)
  if consts <> [] then
    emit (Pconstants consts);
  reset_constants ()
(*- #End *)

(*- E_COMPCERT_CODE_Constantexpand_expand_instruction_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_expand_instructions_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Constantexpand_expand_constants_002 *)
(*- #Justify_Derived "Utility function" *)
