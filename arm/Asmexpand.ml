...
let _21 = coqint_of_camlint 21l
let _31 = coqint_of_camlint 31l
let _32 = coqint_of_camlint 32l
let _51 = coqint_of_camlint 51l
let _52 = coqint_of_camlint 52l
let _64 = coqint_of_camlint 64l
let _1024 = coqint_of_camlint 1024l
(*- #End *)
...
let expand_udivmod () =
  ...
  emit (Pcmp (IR6, SOimm _0));
  emit (Pbc (TCeq, ret_lbl));
  emit (Pmov (lo reg2, SOimm _0));
  emit (Pmov (hi reg2, SOimm _0));
  emit (Pmov (IR8, SOimm _1));
  emit (Plabel lbl_1);
  emit (Pcmp (hi reg1, SOimm _0));
  emit (Pbc (TClt, lbl_3));
  expand_lshl1 reg1 reg1;
  expand_lsubs reg3 reg0 reg1;
  emit (Pbc (TClo, lbl_2));
  emit (Padd (IR8, IR8, SOimm _1));
  emit (Pb lbl_1);
  emit (Plabel lbl_2);
  ...
  emit (Porr (lo reg2, lo reg2, SOimm _1));
  emit (Plabel lbl_4);
  expand_lshr1 reg1 reg1;
  emit (Psubs (IR8, IR8, SOimm _1));
  emit (Pbne lbl_3);
  emit (Plabel ret_lbl)
(*- #End *)
