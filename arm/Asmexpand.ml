...
module FixupEABI = struct
  ...
  (*- #Link_to E_COMPCERT_TR_Function_PRINT_PBLREG_001 *)
  (*- #Link_to E_COMPCERT_TR_Function_PRINT_PBLSYMB_001 *)
  (*- #Link_to E_COMPCERT_TR_Function_PRINT_PBREG_001 *)
  (*- #Link_to E_COMPCERT_TR_Function_PRINT_PBSYMB_001 *)
  (*- #Link_to E_COMPCERT_TR_Function_PRINT_INCOMING_ARGUMENTS_001 *)
