...
(*- E_COMPCERT_CODE_Asmexpand_type_direction_001 *)
(*- #Justify_Derived "Internal type for direction of fixup code. Incoming arguments or outgoing results." *)
type direction = Incoming | Outgoing
(*- #End *)

(*- E_COMPCERT_DEACTIVATED_CODE_FixupEABI_001 *)
(*- #Condition "CompCert target uses ABI other than EABI." *)
(*- #Justification "Code is active only when CompCert is configured for EABI calling convention." *)
module FixupEABI = struct

  (*- E_COMPCERT_CODE_Asmexpand_ireg_param_001 *)
  (*- #Justify_Derived "Utility function" *)
  let ireg_param = function
    | 0 -> IR0 | 1 -> IR1 | 2 -> IR2 | 3 -> IR3 | _ -> assert false
  (*- #End *)

  (*- E_COMPCERT_CODE_Asmexpand_freg_param_double_001 *)
  (*- #Justify_Derived "Utility function" *)
  let freg_param_double = function
    | 0 -> (FR1, FR0) | 1 -> (FR3, FR2) | 2 -> (FR5, FR4) | 3 -> (FR7, FR6) | _ -> assert false
  (*- #End *)

  (*- E_COMPCERT_CODE_Asmexpand_freg_param_single_001 *)
  (*- #Justify_Derived "Utility function" *)
  let freg_param_single = function
    | 0 -> FR0 | 1 -> FR1 | 2 -> FR2 | 3 -> FR3 | _ -> assert false
  (*- #End *)

  (*- E_COMPCERT_CODE_Asmexpand_fixup_double_001 *)
  (*- #Justify_Derived "Utility function" *)
  ...
  (*- E_COMPCERT_CODE_Asmexpand_fixup_single_001 *)
  (*- #Justify_Derived "Utility function" *)
  ...
  (*- E_COMPCERT_CODE_Asmexpand_fixup_conventions_001 *)
  (*- #Justify_Derived "Utility function" *)
  ...
  (*- E_COMPCERT_CODE_Asmexpand_eabi_fixup_arguments_001 *)
  (*- #Justify_Derived "Utility function" *)
  let fixup_arguments dir sg =
    fixup_conventions dir (proj_sig_args sg)
  (*- #End *)

  (*- E_COMPCERT_CODE_Asmexpand_eabi_fixup_result_001 *)
  (*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_DEACTIVATED_CODE_FixupHF_001 *)
(*- #Condition "CompCert target uses ABI other than EABI-HF." *)
(*- #Justification "Code is active only when CompCert is configured for EABI-HF calling convention." *)
module FixupHF = struct
  (*- E_COMPCERT_CODE_Asmexpand_hf_fixup_arguments_001 *)
  (*- #Justify_Derived "Utility function" *)
  let fixup_arguments dir sg =
  ...
  (*- E_COMPCERT_CODE_Asmexpand_hf_fixup_result_001 *)
  (*- #Justify_Derived "Utility function" *)
  let fixup_result dir sg =
    if sg.sig_cc.cc_vararg <> None then
...
(*- E_COMPCERT_CODE_Asmexpand_fixup_arguments_fixup_result_001 *)
(*- #Justify_Derived "Utility function" *)
