...
Definition destroyed_by_builtin (ef: external_function): list mreg :=
  ...
  | EF_builtin id sg =>
    if string_dec id "__builtin_isinf" then F6 :: nil
    else if string_dec id "__builtin_isinff" then F6 :: nil
    else if string_dec id "__builtin_isfinite" then F6 :: nil
    else if string_dec id "__builtin_isfinitef" then F6 :: nil
    else nil
  | _ => nil
  end.
