...
Definition destroyed_by_builtin (ef: external_function): list mreg :=
  ...
  | EF_builtin id sg =>
    if string_dec id "__builtin_isinf" then F0 :: F6 :: nil
    else if string_dec id "__builtin_isinff" then F0 :: F6 :: nil
    else if string_dec id "__builtin_isfinite" then F0 :: F6 :: nil
    else if string_dec id "__builtin_isfinitef" then F0 :: F6 :: nil
    else nil
  | _ => nil
  end.
...
Definition mregs_for_builtin (ef: external_function): list (option mreg) * list(option mreg) :=
  match ef with
    | EF_builtin id sg =>
      if string_dec id "__builtin_isinf" then (Some F0 :: nil, nil)
      else if string_dec id "__builtin_isinff" then (Some F0 :: nil, nil)
      else if string_dec id "__builtin_isfinite" then (Some F0 :: nil, nil)
      else if string_dec id "__builtin_isfinitef" then (Some F0 :: nil, nil)
      else (nil, nil)
    | _ => (nil, nil)
  end.
