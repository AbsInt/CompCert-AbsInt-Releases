...
(*- E_COMPCERT_DEACTIVATED_CODE_ExportCsyntax_001 *)
(*- #Condition "Code is not compiled into CompCert." *)
(*- #Justification "Code is part of the clightgen tool and not part of CompCert." *)

(*- E_COMPCERT_CODE_ExportCsyntax_001 *)
(*- #Justify_Derived "Module ExportCsyntax.ml is part of the clightgen tool and not part of CompCert." *)
