...
(*- E_COMPCERT_DEACTIVATED_CODE_ExportBase_001 *)
(*- #Condition "Code is not compiled into CompCert." *)
(*- #Justification "Code is part of the clightgen tool and not part of CompCert." *)

(*- E_COMPCERT_CODE_ExportBase_001 *)
(*- #Justify_Derived "Module ExportBase.ml is part of the clightgen tool and not part of CompCert." *)
...
let external_function p = function
  ...
  | EF_memcpy(sz, al) ->
      fprintf p "(EF_memcpy %Ld %Ld)" (camlint64_of_ptrofs sz) (camlint64_of_ptrofs al)
