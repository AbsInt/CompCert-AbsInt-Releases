...
(*- E_COMPCERT_DEACTIVATED_CODE_ExportCtypes_001 *)
(*- #Condition "Code is not compiled into CompCert." *)
(*- #Justification "Code is part of the clightgen tool and not part of CompCert." *)

(*- E_COMPCERT_CODE_ExportCtypes_001 *)
(*- #Justify_Derived "Module ExportCtypes.ml is part of the clightgen tool and not part of CompCert." *)
...
and rtyp p = function
  ...
  | Tarray(t, sz, _) ->
      fprintf p "(tarray %a %s)" typ t (Z.to_string sz)
