...
Module CC.
  Definition reg_cc (r: mreg): RegCC :=
    match r with
    | R2  | R3  | R4  | R5  | R6  | R7  | R8  | R9  | R10 | R11 => RCCaller
    | R12 | R13 | R14 | R15 | R16 | R17 | R18 | R19 | R20 | R21
    | R22 | R23 | R24 | R25 | R26 | R27 | R28 | R29 | R30 | R31 => RCCallee
    | ErrorReg => RCCaller
    end.
End CC.
...
Definition dummy_regs := R2 :: R3 :: nil. (**r Used in [Coloring]. *)
...
Proof.
  intros. unfold loc_result, mreg_pair_type, mreg_type.
...
Definition long_arg (r ofs: Z)
  ...
  | Some r1, Some r2 =>
    Two (R r2) (R r1) :: rec (r + 2) ofs
  | Some r1, None =>
    Two (S Outgoing ofs Tint) (R r1) :: rec (r + 1) (ofs + 1)
  | _, _ =>
...
Proof.
  ...
  assert (CSP: forall r, In r param_regs -> is_caller_save r = true).
  { decide_goal. }
