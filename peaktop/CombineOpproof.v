...
Proof.
  ...
  (* subimm - subimm *)
  - UseGetSound. simpl.
    rewrite <- H0. repeat rewrite Val.sub_add_opp.
    rewrite Int.neg_add_distr. rewrite Val.add_assoc. auto.
  (* subimm - addimm *)
  - UseGetSound; simpl. rewrite <- H0.
    repeat rewrite Val.sub_add_opp. rewrite Val.add_assoc. simpl.
    rewrite <- Int.sub_add_opp.
    rewrite Int.sub_add_opp. rewrite Int.neg_add_distr.
    rewrite Int.neg_involutive. rewrite Int.add_commut.
    rewrite Int.sub_add_opp. reflexivity.
  (* andimm - andimm *)
  - UseGetSound; simpl.
