...
Definition destroyed_by_op (op: operation): list mreg :=
  ...
  | Omadd => R3 :: R4 :: nil
  | Omsub => R3 :: R4 :: nil
  | Ointofsingle => R3 :: R4 :: nil
  | Ointuofsingle => R3 :: R4 :: nil
...
Definition mregs_for_operation (op: operation): list (option (rpair mreg)) * option (rpair mreg) :=
  match op with
  | Omul => (Some (One R3) :: None :: nil, Some (One R3))
  | Omulimm _ => (None :: None :: nil, Some (One R3))
  | Omulhs => (Some (One R3) :: None :: nil, Some (One R3))
  | Omulhu => (Some (One R3) :: None :: nil, Some (One R3))
  | Odiv => (Some (One R3) :: None :: nil, Some (One R3))
  | Odivu => (Some (One R3) :: None :: nil, Some (One R3))
  | Omod => (Some (One R3) :: None :: nil, Some (One R3))
  | Omodu => (Some (One R3) :: None :: nil, Some (One R3))
  | Omadd => (Some (One R3) :: None :: None :: nil, Some (One R3))
  | Omsub => (Some (One R3) :: None :: None :: nil, Some (One R3))
  | _ => (nil, None)
  end.
...
Definition mregs_for_builtin (ef: external_function): list (option mreg) * list(option mreg) :=
  ...
  | EF_builtin name sg =>
    if string_dec name "__builtin_negl" then
      (Some R7 :: Some R6 :: nil, Some R5 :: Some R4 :: nil)
    else if string_dec name "__builtin_addl" then
      (Some R5 :: Some R4 :: Some R7 :: Some R6 :: nil, Some R5 :: Some R4 :: nil)
    else if string_dec name "__builtin_subl" then
      (Some R5 :: Some R4 :: Some R7 :: Some R6 :: nil, Some R5 :: Some R4 :: nil)
    else if string_dec name "__builtin_mull" then
           (Some R5 :: Some R4 :: nil, Some R5 :: Some R4 :: nil)
