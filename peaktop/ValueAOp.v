...
(** Value analysis for PEAKTOP operators *)
...
Definition eval_static_operation (op: operation) (vl: list aval): aval :=
  ...
  | Omadd, v1::v2::v3::nil => add (mul v1 v2) v3
  | Omsub, v1::v2::v3::nil => sub (mul v1 v2) v3
...
Proof.
  ...
  destruct (Val.eq a1 Vone); eauto with va. simpl. eapply vmatch_top.
  eapply vnormalize_type_sound; eauto.
  destruct (Val.eq a1 Vzero); eauto with va. simpl. eapply vmatch_top.
  eapply vnormalize_type_sound; eauto. simpl. constructor.
Qed.
