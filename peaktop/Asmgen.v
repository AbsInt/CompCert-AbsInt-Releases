...
Definition transl_op
   ...
   | Osel ty, a1 :: a2 :: a3 :: nil =>
       ...
       do r2 <- reg_of a2;
       do r3 <- reg_of a3;
       if reg_eq r2 r3 then
         OK (Pmov_rr rd r2 :: k)
       else
         OK (Pcmov r1 rd r2 r3 :: k)
   | _, _ =>
...
Definition it1_is_parent (before: bool) (i: Mach.instruction) : bool :=
  ...
  | Mgetparam ofs ty dst => forallb_rpair (fun x => negb (mreg_eq x R2)) dst
  | Mop Omove args res => before && forallb_rpair (fun x => negb (mreg_eq x R2)) res
  | _ => false
  end.
