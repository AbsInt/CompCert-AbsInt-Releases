...
(*- E_COMPCERT_CODE_JsonAST_pp_section_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_JsonAST_pp_int_opt_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_JsonAST_pp_fundef_001 *)
(*- #Link_to E_COMPCERT_TR_Function_VALEX_001 *)
let pp_fundef pp_inst pp (name,fn) =
  if  C2C.atom_is_weak name then
     Diagnostics.warning Diagnostics.no_loc Diagnostics.Weak_sdump "weak is not supported in sdump";
...
(*- E_COMPCERT_CODE_JsonAST_pp_init_data_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_JsonAST_pp_vardef_001 *)
(*- #Link_to E_COMPCERT_TR_Function_VALEX_001 *)
...
(*- E_COMPCERT_CODE_JsonAST_pp_program_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_JsonAST_pp_mnemonics_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_JsonAST_jdump_magic_number_001 *)
(*- #Justify_Derived "Utility constant" *)
let jdump_magic_number = "CompCertJDUMPRelease: " ^ Version.version
(*- #End *)

(*- E_COMPCERT_CODE_JsonAST_pp_ast_001 *)
(*- #Justify_Derived "Utility function" *)
let pp_ast pp pp_inst ast sourcename =
  let get_args () =
    let buf = Buffer.create 100 in
    Buffer.add_string buf (String.escaped Sys.executable_name);
  ...
  let dump_compile_info pp () =
    pp_jobject_start pp;
    pp_jmember ~first:true pp "directory" pp_jstring (String.escaped (Sys.getcwd ()));
    pp_jmember pp "command" pp_jstring (get_args ());
    pp_jmember pp "file" pp_jstring (String.escaped sourcename);
    pp_jobject_end pp in
  pp_jobject_start pp;
  ...
  pp_jmember pp "Compilation Unit" pp_jstring (String.escaped sourcename);
