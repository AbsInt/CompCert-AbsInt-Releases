...
let print_inline_asm print_preg oc txt sg args res =
  let (operands, ty_operands) =
    ...
    | tres -> (builtin_arg_of_res res :: args, proj_xtype_typ tres :: proj_sig_args sg) in
...
(*- E_COMPCERT_CODE_PrintAsmaux_print_nonexec_stack_note_001 *)
(*- #Justify_Derived "Utility function" *)
