...
(*- E_COMPCERT_CODE_aisannot_t_001 *)
...
(*- E_COMPCERT_CODE_aisannot_offsets_001 *)
...
(*- E_COMPCERT_CODE_aisannot_size_chunk_001 *)
(*- #Justify_Derived "Utility function" *)
let size_chunk c =
  sprintf "%ld" (camlint_of_coqint (size_chunk c))
(*- #End *)

(*- E_COMPCERT_CODE_aisannot_addr_global_001 *)
...
(*- E_COMPCERT_CODE_aisannot_warn_lval_arg_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_aisannot_ais_expr_arg_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_aisannot_ais_annot_list_001 *)
(*- #Justify_Derived "Variable for global state" *)
let ais_annot_list: (t list) list ref = ref []
(*- #End *)

(*- E_COMPCERT_CODE_aisannot_get_ais_annots_001 *)
(*- #Justify_Derived "Functional decomposition" *)
let get_ais_annots () =
...
(*- E_COMPCERT_CODE_aisannot_re_loc_param_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_loc_param = Str.regexp "# file:\\([^ ]+\\) line:\\([^ ]+\\)"
(*- #End *)

(*- E_COMPCERT_CODE_aisannot_loc_of_txt_001 *)
(*- #Justify_Derived "Functional decomposition" *)
let loc_of_txt txt =
  try
...
(*- E_COMPCERT_CODE_aisannot_re_ais_annot_param_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_ais_annot_param = Str.regexp "%%\\|%[el][0-9]+\\|%here\\|\007"
(*- #End *)

(*- E_COMPCERT_CODE_aisannot_ais_annot_txt_001 *)
  ...
  let annot  =
    ...
    | Bad_parameter s ->
      if warn then begin
        ...
        (*- #Link_to E_COMPCERT_TR_Function_AISANNOT_002 *)
...
(*- E_COMPCERT_CODE_aisannot_add_ais_annot_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_aisannot_json_ais_annot_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_aisannot_validate_ais_annot_001 *)
      ...
      | Str.Delim s ->
        ...
        try
          ...
          if Cutil.is_float_type env arg.C.etyp then
            (*- #Link_to E_COMPCERT_TR_Robustness_AISANNOT_004 *)
