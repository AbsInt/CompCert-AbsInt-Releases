...
Proof.
  intros; red; intros.
  unfold return_regs. destruct l; simpl.
...
Proof.
  intros; red; intros.
  unfold tailcall_regs, pre_return_regs. destruct l; simpl.
- destruct (is_callee_save r); auto.
- destruct sl; auto; red; auto.
Qed.
...
- destruct (is_auto_save r); auto.
  destruct (is_caller_save r); simpl; auto.
- destruct sl; auto; red; auto. 
Qed.
...
- (* tailcall *)
  ...
  econstructor; eauto.
  eapply wt_find_function; eauto.
  apply wt_tailcall_regs; auto. apply wt_parent_locset; auto.
...
- (* return *)
  ...
  unfold mreg_preserved_across_call, is_caller_save in H. unfold is_auto_save, is_callee_save. destruct (reg_cc r) eqn:Er; simpl in H; congruence.
...
- (* external function *)
  ...
  apply wt_external_call_regs; auto. apply wt_parent_locset; auto.
  red; simpl; intros.
  rewrite locmap_get_set_loc_result_preserved_across_call; auto.
  destruct l; simpl in *.
  + destruct (is_auto_save r) eqn:E1; auto.
    unfold mreg_preserved_across_call in H.
    destruct (is_caller_save r) eqn:E2; [discriminate|].
    decompose [Logic.or] (reg_cc_complete r); try congruence.
    apply AGCS; auto.
  + destruct sl; auto; try congruence. apply AGCS; congruence. apply AGCS; congruence.
