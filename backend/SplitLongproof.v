...
Proof.
  unfold lowlong; red. intros until x.
  destruct (SelectOp.lowlong a) eqn:?.
  - intros. eapply SelectOpproof.eval_lowlong; eauto.
...
Proof.
  unfold highlong; red. intros until x.
  destruct (SelectOp.highlong a) eqn:?.
  intros. eapply SelectOpproof.eval_highlong; eauto.
...
Proof.
  ...
  apply eval_splitlong2; auto; [|destruct x, y; auto].
  intros.
  exploit eval_mul'. eexact H2. eexact H4. intros [v5 [E5 L5]].
  ...
  inv L5. inv L6. inv L7. inv L8. inv L9. inv L10. inv L11.
