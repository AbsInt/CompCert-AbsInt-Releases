...
Lemma eval_select_long:
  forall le cond al vl a1 v1 a2 v2 a,
  select_long cond al a1 a2 = Some a ->
...
Proof.
  unfold select_long. intros.
  destruct (select Tlong cond al a1 a2) eqn:?.
  inv H. eapply eval_select; eauto. destruct Archi.ptr64 eqn:?; try congruence.
  destruct (select Tint cond al (highlong a1) (highlong a2)) eqn:?; try congruence.
  destruct (select Tint cond al (lowlong a1) (lowlong a2)) eqn:?; inv H.
  exploit eval_lowlong. eexact H1. intros [v3 [A3 B3]].
  exploit eval_lowlong. eexact H2. intros [v4 [A4 B4]].
  exploit eval_select. eexact Heqo1. eexact H0. eauto. eauto. intros [v5 [A5 B5]].
  exploit eval_highlong. eexact H1. intros [v6 [A6 B6]].
  exploit eval_highlong. eexact H2. intros [v7 [A7 B7]].
  exploit eval_select. eexact Heqo0. eexact H0. eauto. eauto. intros [v8 [A8 B8]].
  econstructor; split. EvalOp.
  destruct (eval_condition cond vl m); eauto.
  destruct b.
  destruct v1; simpl; try rewrite Heqb; auto. inv B3. inv B5. inv B6. inv B8. simpl.
  rewrite Int64.ofwords_recompose. auto.
  destruct v2; simpl; try rewrite Heqb; auto. inv B4. inv B5. inv B7. inv B8. simpl.
  rewrite Int64.ofwords_recompose. auto.
Qed.
...
Proof.
  ...
  destruct (select_long (Ccompu Clt)) eqn:?; [|eexact H1].
  destruct (select_long (Ccompu Ceq)) eqn:?; [|eexact H1].
  ...
  exploit eval_select_long. eexact Heqo. EvalOp. eexact A3. eexact A4. intros [v5 [A5 B5]].
  exploit eval_select_long. eexact Heqo0. EvalOp. EvalOp. eexact A5. intros [v6 [A6 B6]].
...
Proof.
  ...
  destruct (Zle_bool 0 (Z.pos mx - 2 ^ 52)) eqn:Esubn.
