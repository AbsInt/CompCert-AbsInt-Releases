...
(*- E_COMPCERT_CODE_Selectionaux_001 *)
(*- #Justify_Derived "Module Selectionaux.ml is part of CompCert's translation of simple if statements. The heuristic decides whether the if-conversion should be performed in the Selection pass." *)
open AST
open Cminor
...
let fast_cmove ty =
  ...
  | "powerpc_vle", _ ->
      (match ty with Tint | Tsingle -> true | _ -> false)
  | "powerpc", "e5500" -> 
