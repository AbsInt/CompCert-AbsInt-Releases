...
Definition find_function
    {F V}  (ge: Genv.t (AST.fundef F) V) (ros: reg + ident) (rs: regset) : option (AST.fundef F) :=
  match ros with
...
Proof.
  ...
  simpl in H1. fold fundef in *. rewrite F1 in H1. apply Genv.find_funct_ptr_iff in H1.
