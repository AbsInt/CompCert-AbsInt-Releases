...
Lemma tailcall_regs_lessdef:
  forall caller1 callee1 caller2 callee2,
  locmap_lessdef caller1 caller2 ->
  locmap_lessdef callee1 callee2 ->
  locmap_lessdef (tailcall_regs caller1 callee1) (tailcall_regs caller2 callee2).
Proof.
...
- (* Ltailcall *)
  ...
  eapply find_function_translated; eauto using tailcall_regs_lessdef, match_parent_locset.
  apply sig_preserved.
  econstructor; eauto using tailcall_regs_lessdef, match_parent_locset.
- (* Lbuiltin *)
...
- (* external function *)
  ...
  simpl. econstructor; eauto using locmap_setpair_lessdef, external_call_regs_lessdef, match_parent_locset.
- (* return *)
  inv STK. inv H1.
  left; econstructor; split.
