...
Lemma pre_return_regs_lessdef:
  forall caller1 callee1 caller2 callee2,
  locmap_lessdef caller1 caller2 ->
  locmap_lessdef callee1 callee2 ->
  locmap_lessdef (pre_return_regs caller1 callee1) (pre_return_regs caller2 callee2).
Proof.
...
Lemma external_call_regs_lessdef:
  forall caller1 caller2 ls1 ls2,
  locmap_lessdef caller1 caller2 ->
  locmap_lessdef ls1 ls2 -> 
  locmap_lessdef (external_call_regs caller1 ls1) (external_call_regs caller2 ls2).
Proof.
  intros; red; intros. destruct l; simpl.
...
Lemma restore_auto_save_regs_lessdef:
  forall caller1 callee1 caller2 callee2,
  locmap_lessdef caller1 caller2 ->
  locmap_lessdef callee1 callee2 ->
  locmap_lessdef (restore_auto_save_regs caller1 callee1) (restore_auto_save_regs caller2 callee2).
Proof.
  intros; red; intros. destruct l; simpl.
- destruct (Conventions1.is_auto_save r); auto.
- destruct sl; auto.
Qed. 

Lemma undef_callee_may_modify_regs_lessdef:
  forall callee1 callee2,
  locmap_lessdef callee1 callee2 ->
  locmap_lessdef (undef_callee_may_modify_regs callee1) (undef_callee_may_modify_regs callee2).
Proof.
  intros; red; intros. destruct l; simpl.
- destruct (Conventions1.is_modifiable_by_callee r); auto.
- destruct sl; auto.
Qed. 
...
- (* Ltailcall *)
  ...
  eapply find_function_translated; eauto using pre_return_regs_lessdef, match_parent_locset.
  apply sig_preserved.
  econstructor; eauto using pre_return_regs_lessdef, match_parent_locset.
- (* Lbuiltin *)
...
- (* Lreturn *)
  ...
  constructor; eauto using restore_auto_save_regs_lessdef, pre_return_regs_lessdef, match_parent_locset.
- (* internal function *)
...
- (* external function *)
  ...
  simpl. econstructor; eauto using locmap_setpair_lessdef, restore_auto_save_regs_lessdef, undef_callee_may_modify_regs_lessdef, match_parent_locset.
- (* return *)
  inv STK. inv H1.
  left; econstructor; split.
