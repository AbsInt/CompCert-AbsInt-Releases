...
Definition tailcall_rettype_match (r1 r2: rettype) : Prop :=
  simpl_rettype_match ptr_return_ptr_reg r1 r2.

Definition tailcall_matching_rettype (r1 r2: rettype) : bool :=
   simpl_matching_rettype ptr_return_ptr_reg r1 r2.

Lemma tailcall_matching_rettype_correct:
  forall r1 r2,  tailcall_matching_rettype r1 r2 = true <-> tailcall_rettype_match r1 r2.
Proof.
  apply simpl_matching_rettype_correct.
Qed.

Lemma tailcall_rettype_match_proj_sig:
  forall sg1 sg2,
  tailcall_rettype_match (sig_res sg1) (sig_res sg2) -> proj_sig_res sg1 = proj_sig_res sg2.
Proof.
  unfold proj_sig_res. intros. eapply simpl_rettype_match_proj_rettype. eauto.
Qed.
