...
(*- E_COMPCERT_CODE_RTLgenaux_001 *)
(*- #Justify_Derived "Module RTLgenaux.ml is part of CompCert's RTL translation phase. The heuristics in this file decide which transformation functions from the RTLgen pass should be used." *)
