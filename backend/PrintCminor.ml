...
(*- E_COMPCERT_CODE_PrintCminor_associativity_001 *)
(*- #Justify_Derived "Type definition" *)
type associativity = LtoR | RtoL | NA
(*- #End *)

(*- E_COMPCERT_CODE_PrintCminor_precedence_001 *)
...
(*- E_COMPCERT_CODE_PrintCminor_StringSet_001 *)
(*- #Justify_Derived "Type definitions" *)
module StringSet = Set.Make(String)
(*- #End *)

(*- E_COMPCERT_CODE_PrintCminor_keywords_001 *)
...
(*- E_COMPCERT_CODE_PrintCminor_re_ident_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_ident = Str.regexp {|[A-Za-z_][A-Za-z_$0-9]*$\|\$[1-9][0-9]*$|}
(*- #End *)

(*- E_COMPCERT_CODE_PrintCminor_ident_name_001 *)
(*- #Justify_Derived "Utility function" *)
let ident_name id =
...
(*- E_COMPCERT_CODE_PrintCminor_name_of_unop_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_comparison_name_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_name_of_binop_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_expr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_expr_001 *)
(*- #Justify_Derived "Utility function" *)
let print_expr p e = expr p (0, e)
(*- #End *)

(*- E_COMPCERT_CODE_PrintCminor_print_expr_list_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_name_of_type_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_sig_001 *)
(*- #Justify_Derived "Utility function" *)
let print_sig p sg =
  List.iter
...
(*- E_COMPCERT_CODE_PrintCminor_just_skips_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_stmt_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*  | Sifthenelse(e, Sskip, s2) ->
  ...
  | Sswitch(long, e, cases, dfl) ->
    let print_case (n,x) =
      ...
      fprintf p "@ case %s: exit %d;" (Z.to_string n) x
    in
...
(*- E_COMPCERT_CODE_PrintCminor_print_varlist_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_function_001 *)
(*- #Justify_Derived "Utility function" *)
let print_function p id f =
  fprintf p "@[<hov 4>\"%s\"(@[<hov 0>%a@])@ : @[<hov 0>%a@]@]@ "
            ...
            print_sig f.fn_sig;
  fprintf p "@[<v 2>{@ ";
  let stksz = Z.to_string f.fn_stackspace in
  if not (Z.eq f.fn_stackspace Z.zero) then
    fprintf p "stack %s;@ " stksz;
  if f.fn_vars <> [] then
...
(*- E_COMPCERT_CODE_PrintCminor_print_extfun_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_init_data_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_init_data_list_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_globvar_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_globdef_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_print_program_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCminor_destination_001 *)
(*- #Justify_Derived "Variable for global state" *)
let destination : string option ref = ref None
(*- #End *)

(*- E_COMPCERT_CODE_PrintCminor_print_if_001 *)
