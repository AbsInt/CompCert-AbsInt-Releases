...
(*- E_COMPCERT_CODE_Linearizeaux_001 *)
(*- #Justify_Derived "Module Linearizeaux.ml is helper code for the transition from LTL to Linear. Computed results are later checked by a formally verified validator." *)
