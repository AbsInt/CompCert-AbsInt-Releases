...
(*- E_COMPCERT_CODE_PrintRTL_req_001 *)
(*- #Justify_Derived "Utility function" *)
let reg pp r =
  fprintf pp "x%d" (P.to_int r)
(*- #End *)

(*- E_COMPCERT_CODE_PrintRTL_regs_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintRTL_ros_001 *)
(*- #Justify_Derived "Utility function" *)
let ros pp = function
  | Coq_inl r -> reg pp r
...
(*- E_COMPCERT_CODE_PrintRTL_print_succ_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintRTL_print_instruction_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintRTL_print_function_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintRTL_print_globdef_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintRTL_print_program_001 *)
(*- #Justify_Derived "Utility function" *)
let print_program pp (prog: RTL.program) =
  List.iter (print_globdef pp) prog.prog_defs
(*- #End *)

(*- E_COMPCERT_CODE_PrintRTL_destination_001 *)
(*- #Justify_Derived "Variable for global state" *)
let destination : string option ref = ref None
(*- #End *)

(*- E_COMPCERT_CODE_PrintRTL_print_if_001 *)
