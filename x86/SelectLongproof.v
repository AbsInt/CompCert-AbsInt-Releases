...
Theorem eval_mul': binary_constructor_sound mul' Val.mull'.
Proof.
  unfold mul'. intros; red; intros.
  destruct Archi.splitlong. apply SplitLongproof.eval_mul'; auto.
  exploit eval_longofintu. eexact H. intros (v1 & A1 & B1).
  exploit eval_longofintu. eexact H0. intros (v2 & A2 & B2).
  exploit eval_mull. eexact A1. eexact A2. intros (v3 & A3 & B3).
  exists v3; split; eauto.
  destruct x, y; auto. inv B1. inv B2. inv B3. simpl.
  unfold Int64.mul', Int64.mul. rewrite ! Int64.int_unsigned_repr; auto.
Qed.
