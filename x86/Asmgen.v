...
Definition preg_of_rpair (p: rpair mreg) : res preg :=
  match p with One r => OK (preg_of r) | _ => Error(msg "Asmgen.preg_of_rpair") end.
...
Definition transl_op
             (op: operation) (args: list (rpair mreg)) (res: rpair mreg) (k: code) : Errors.res code :=
  match op, args with
  | Omove, a1 :: nil =>
      do r <- preg_of_rpair res;
      do r1 <- preg_of_rpair a1;
      mk_mov r r1 k
  | Ointconst n, nil =>
  ...
  | Oindirectsymbol id, nil =>
      ...
      OK (Pmov_rs r id :: k)
  | Ocast8signed, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; mk_intconv Pmovsb_rr r r1 k
  | Ocast8unsigned, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; mk_intconv Pmovzb_rr r r1 k
  | Ocast16signed, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Pmovsw_rr r r1 :: k)
  | Ocast16unsigned, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Pmovzw_rr r r1 :: k)
  | Oneg, a1 :: nil =>
      do r <- ireg_of_rpair res;
      do a1 <- ireg_of_rpair a1;
      assertion (ireg_eq a1 r);
      OK (Pnegl r :: k)
  | Osub, a1 :: a2 :: nil =>
      do r <- ireg_of_rpair res;
  ...
  | Omulhs, a1 :: a2 :: nil =>
      ...
      do r2 <- ireg_of_rpair a2;
      do r <- ireg_of_rpair res;
      assertion (ireg_eq r1 RAX);
      assertion (ireg_eq r RDX);
      OK (Pimull_r r2 :: k)
  | Omulhu, a1 :: a2 :: nil =>
      do r1 <- ireg_of_rpair a1;
      do r2 <- ireg_of_rpair a2;
  ...
  | Omull', a1 :: a2 :: nil =>
      ...
      assertion (ireg_eq r1 RAX);
      assertion (ireg_eq rh RDX);
      assertion (ireg_eq rl RAX);
      OK (Pmull_r r2 :: k)
  | Odiv, a1 :: a2 :: nil =>
      do r <- ireg_of_rpair res;
      do r1 <- ireg_of_rpair a1;
      do r2 <- ireg_of_rpair a2;
      assertion (ireg_eq r1 RAX);
      assertion (ireg_eq r2 RCX);
      assertion (ireg_eq r RAX);
  ...
  | Oshldimm n, a1 :: a2 :: nil =>
      ...
      do r2 <- ireg_of_rpair a2;
      assertion (ireg_eq r1 r);
      OK (Pshld_ri r r2 n :: k)
  | Olea addr, _ =>
      do args <- mmap (@error_single mreg) args;
      do am <- transl_addressing addr args; do r <- ireg_of_rpair res;
...
(* 64-bit integer operations *)
  ...
  | Ocast32signed, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Pmovsl_rr r r1 :: k)
  | Ocast32unsigned, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Pmovzl_rr r r1 :: k)
  | Onegl, a1 :: nil =>
      if Archi.ptr64 then
        do r <- ireg_of_rpair res;
        do r1 <- ireg_of_rpair a1;
        ...
        assertion (ireg_eq ah RDX);
        assertion (ireg_eq al RAX);
        assertion (ireg_eq rh RDX);
        assertion (ireg_eq rl RAX);
        OK (Pnegl RAX :: Padcl_ri RDX Int.zero :: Pnegl RDX :: k)
  | Oaddl, a1 :: a2 :: nil =>
      ...
      assertion (ireg_eq ah RDX);
      assertion (ireg_eq al RAX);
      assertion (ireg_eq bh RCX);
      assertion (ireg_eq bl RBX);
      assertion (ireg_eq rh RDX);
      assertion (ireg_eq rl RAX);
      OK (Paddl_rr RAX RBX :: Padcl_rr RDX RCX :: k)
  | Oaddlimm n, a1 :: nil =>
      do r <- ireg_of_rpair res;
      do r1 <- ireg_of_rpair a1;
      assertion (ireg_eq r1 r);
  ...
  | Osubl, a1 :: a2 :: nil =>
      if Archi.ptr64 then
        ...
        assertion (ireg_eq rh RDX);
        assertion (ireg_eq rl RAX);
        OK (Psubl_rr RAX RBX :: Psbbl_rr RDX RCX :: k)
  | Omull, a1 :: a2 :: nil =>
      do r <- ireg_of_rpair res;
      do r1 <- ireg_of_rpair a1;
      do r2 <- ireg_of_rpair a2;
...
(**)
  ...
  | Osingleoffloat, a1 :: nil =>
      do r <- freg_of_rpair res;
      do r1 <- freg_of_rpair a1;
      OK (Pcvtsd2ss_ff r r1 :: k)
  | Ofloatofsingle, a1 :: nil =>
      do r <- freg_of_rpair res; do r1 <- freg_of_rpair a1; OK (Pcvtss2sd_ff r r1 :: k)
  | Ointoffloat, a1 :: nil =>
      do r <- ireg_of_rpair res; do r1 <- freg_of_rpair a1; OK (Pcvttsd2si_rf r r1 :: k)
  | Ofloatofint, a1 :: nil =>
      do r <- freg_of_rpair res; do r1 <- ireg_of_rpair a1; OK (Pcvtsi2sd_fr r r1 :: k)
  | Ointofsingle, a1 :: nil =>
      do r <- ireg_of_rpair res; do r1 <- freg_of_rpair a1; OK (Pcvttss2si_rf r r1 :: k)
  | Osingleofint, a1 :: nil =>
      do r <- freg_of_rpair res; do r1 <- ireg_of_rpair a1; OK (Pcvtsi2ss_fr r r1 :: k)
  | Olongoffloat, a1 :: nil =>
      do r <- ireg_of_rpair res; do r1 <- freg_of_rpair a1; OK (Pcvttsd2sl_rf r r1 :: k)
  | Ofloatoflong, a1 :: nil =>
      do r <- freg_of_rpair res; do r1 <- ireg_of_rpair a1; OK (Pcvtsl2sd_fr r r1 :: k)
  | Olongofsingle, a1 :: nil =>
      do r <- ireg_of_rpair res; do r1 <- freg_of_rpair a1; OK (Pcvttss2sl_rf r r1 :: k)
  | Osingleoflong, a1 :: nil =>
      do r <- freg_of_rpair res; do r1 <- ireg_of_rpair a1; OK (Pcvtsl2ss_fr r r1 :: k)
  | Ocmp c, args =>
      do r <- ireg_of_rpair res;
      do args <- mmap (@error_single mreg) args;
