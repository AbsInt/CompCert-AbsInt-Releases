...
Module CC.
  Definition reg_cc (r: mreg): RegCC :=
    ...
    | SI | DI => if negb Archi.ptr64 || Archi.win64 then Callee else Caller 
    | R8 | R9 | R10 | R11 => Caller
    | R12 | R13 | R14 | R15 => Callee
    | X0 | X1 | X2 | X3 | X4 | X5 | X6 | X7 => Caller
    | X8 | X9 | X10 | X11 | X12 | X13 | X14 | X15 => if Archi.win64 then Callee else Caller
    | FP0 => Caller
    end.
End CC.
