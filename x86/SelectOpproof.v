...
Proof.
  ...
  - (* BI_mull *)
    ...
    + econstructor; split. EvalOp. econstructor. EvalOp. reflexivity.
       econstructor. EvalOp. reflexivity. econstructor; eauto. reflexivity.
       destruct v1, v0; auto. simpl. unfold Int64.mul', Int64.mul.
       rewrite ! Int64.int_unsigned_repr; auto.
    + econstructor; split. EvalOp. reflexivity. auto.
Qed.
