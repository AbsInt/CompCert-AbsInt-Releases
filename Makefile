...
VLIB+=\
	 UnionFind.v FSetAVLplus.v Heaps.v Lattice.v \
...
# Only TriCore needs Machtyping for the Asmgen pass.
ifeq ($(ARCH),tricore)
BACKEND+=Machtyping.v
endif
...
ifneq ($(CLIGHTGEN_ONLY),true)
CFRONTEND+=\
	SimplExprspec.v SimplExprproof.v SimplLocalsproof.v \
...
extraction/STAMP: $(FILES:.v=.vo) $(EXTRACTION_DEPS)
	...
	$(COQEXEC) $(EXTRACTION) -output-directory extraction
