...
val set_composite_size: ident -> atom -> struct_or_union -> int64 option -> unit
val set_member_atom: str_id:atom -> string -> fld_id:atom -> unit
val set_member_offset: str_id:atom -> fld_id:atom -> int64 -> unit
val set_bitfield_offset: str_id:atom -> fld_id:atom -> bit_ofs:int64 -> byte_ofs:int64 -> size:int64 -> unit
...
val start_live_range: (atom * atom) -> positive -> (int * (int * (int * int) option) AST.builtin_arg) -> unit
val end_live_range: (atom * atom) -> positive -> unit
val stack_variable: (atom * atom) -> int * (int * (int * int) option) AST.builtin_arg -> unit
