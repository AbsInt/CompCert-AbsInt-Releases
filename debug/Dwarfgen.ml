...
(*- E_COMPCERT_CODE_Dwarfgen_IntSet_001 *)
(*- #Justify_Derived "Type definition" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_mmap_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_mmap_opt_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_TARGET_001 *)
(*- #Justify_Derived "Type definition" *)
module type TARGET =
    sig
...
(*- E_COMPCERT_CODE_Dwarfgen_dwarf_accu_001 *)
(*- #Justify_Derived "Type definition" *)
type dwarf_accu =
    {
     typs:  IntSet.t;
...
(*- E_COMPCERT_CODE_Dwarfgen_up_typs_001 *)
(*- #Justify_Derived "Type definition" *)
let up_typs acc t =
  {acc with typs = IntSet.add t acc.typs;}
(*- #End *)

(*- E_COMPCERT_CODE_Dwarfgen_up_locs_001 *)
(*- #Justify_Derived "Type definition" *)
let up_locs acc loc =
  {acc with locs = loc@acc.locs;}
(*- #End *)

(*- E_COMPCERT_CODE_Dwarfgen_up_ranges_001 *)
(*- #Justify_Derived "Type definition" *)
let up_ranges acc r =
...
(*- E_COMPCERT_CODE_Dwarfgen_empty_accu_001 *)
...
module Dwarfgenaux (Target: TARGET) =
  struct
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_int_type_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let int_type_to_entry id i =
      let encoding = encoding_of_ikind i in
      let int = {
        base_type_byte_size = sizeof_ikind i;
        base_type_encoding = Some encoding;
        base_type_name = string_entry (typ_to_string (TInt (i,[])));
      } in
      new_entry id (DW_TAG_base_type int)
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_float_type_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let float_type_to_entry id f =
      let byte_size = sizeof_fkind f in
      let float = {
        base_type_byte_size = byte_size;
        base_type_encoding = Some DW_ATE_float;
        base_type_name = string_entry (typ_to_string (TFloat (f,[])));
      } in
      new_entry id (DW_TAG_base_type float)
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_void_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_file_loc_opt_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_typedef_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_array_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let array_to_entry id (t, sz) =
      let arr_entry = new_entry id (DW_TAG_array_type t) in
      let children = List.map (fun a ->
        ...
        new_entry (next_id ()) (DW_TAG_subrange_type s)) sz in
      add_children arr_entry children
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_enum_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let enum_to_entry id e =
      let enumerator_to_entry (n,c) =
        let tag =
          {
           enumerator_value = Int64.to_int c;
           enumerator_name = string_entry n;
         } in
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_member_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_struct_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_union_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_composite_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_infotype_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let infotype_to_entry id = function
      | IntegerType i -> int_type_to_entry id i
      | FloatType f -> float_type_to_entry id f
      | PointerType p ->  new_entry id (DW_TAG_pointer_type p)
      | ArrayType (ty, sz) -> array_to_entry id (ty, sz)
      ...
      | ConstType c -> new_entry id (DW_TAG_const_type c)
      | VolatileType v ->  new_entry id (DW_TAG_volatile_type v)
      | Void -> void_to_entry id
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_needs_types_001 *)
    (*- #Justify_Derived "Utility function" *)
    let needs_types id d =
      ...
      | FunctionType f ->
          ...
          | Some t -> add_type t d
          | None -> d,false in
          List.fold_left (fun (d,c) (pt,_) ->
            let d,c' = add_type pt d in
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_gen_types_001 *)
    (*- #Justify_Derived "Utility function" *)
    let gen_types needed =
      ...
      | None -> res
      | Some id ->
          let size_t_typ = Cutil.size_t_ikind () in
          let encoding = encoding_of_ikind (size_t_typ) in
          let tag = {
            base_type_byte_size = Cutil.sizeof_ikind size_t_typ;
            base_type_encoding = Some encoding;
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_global_variable_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_gen_splitlong_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_translate_function_loc_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_range_entry_loc_001 *)
    (*- #Justify_Derived "Utility function" *)
    let range_entry_loc (sp,l) =
      let rec aux = function
        | BA (i, None) ->  [DW_OP_reg i]
        | BA (i, Some (s,o)) -> [DW_OP_reg i; DW_OP_bit_piece (s, o)]
        | BA_addrstack ofs ->
            let ofs = camlint64_of_ptrofs ofs in
            [DW_OP_bregx (sp,ofs)]
        | BA_splitlong (hi,lo) ->
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_location_entry_001 *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_function_parameter_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_scope_range_001 *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_local_variable_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_scope_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    and scope_to_entry f_id acc sc id =
      let r, acc = scope_range f_id id acc in
      let vars,acc = mmap_opt (local_to_entry  f_id) acc sc in
      let entry = new_entry id (DW_TAG_lexical_block r) in
      add_children entry vars,acc
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_local_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_fun_scope_to_entries_001 *)
    (*- #Justify_Derived "Utility function" *)
    let fun_scope_to_entries f_id acc id =
      ...
      | Some id ->
          ...
          (match sc with
          | Scope sc -> mmap_opt (local_to_entry f_id) acc sc
          | _ -> assert false)
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_function_to_entry_001 *)
    (*- #Link_to E_COMPCERT_TR_Function_DEBUG_001 *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_definition_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_StringMap_001 *)
(*- #Justify_Derived "Type definition" *)
module StringMap = Map.Make(String)
(*- #End *)

(*- E_COMPCERT_DEACTIVATED_CODE_Dwarfgen_diab_001 *)
...
(*- E_COMPCERT_CODE_Dwarfgen_diab_file_loc_001 *)
(*- #Justify_Derived "Utility function" *)
let diab_file_loc sec (f,l)  =
  Diab_file_loc ((diab_file_loc sec f),l)
(*- #End *)

(*- E_COMPCERT_CODE_Dwarfgen_diab_gen_compilation_section_001 *)
(*- #Justify_Derived "Utility function" *)
let diab_gen_compilation_section sec_name s defs acc =
  ...
  let cp = {
    ...
    compile_unit_prod_name = Simple_string PrintAsmaux.producer_string
  } in
...
(*- E_COMPCERT_CODE_Dwarfgen_gen_diab_debug_info_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_gnu_file_loc_001 *)
(*- #Justify_Derived "Utility function" *)
let gnu_file_loc (f,l) =
  Gnu_file_loc ((Fileinfo.find_file f),l)
(*- #End *)

(*- E_COMPCERT_CODE_Dwarfgen_string_table_001 *)
(*- #Justify_Derived "Variable for local state" *)
let string_table: (string,int) Hashtbl.t = Hashtbl.create 7
(*- #End *)

(*- E_COMPCERT_CODE_Dwarfgen_gnu_string_entry_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_gen_gnu_debug_info_001 *)
(*- #Link_to E_COMPCERT_TR_Function_DEBUG_002 *)
let gen_gnu_debug_info sec_name var_section : debug_entries =
  ...
  let cp = {
    ...
    compile_unit_prod_name = gnu_string_entry PrintAsmaux.producer_string;
  } in
  let cp = new_entry (next_id ()) (DW_TAG_compile_unit cp) in
