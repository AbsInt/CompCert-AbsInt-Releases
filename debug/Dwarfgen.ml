...
module Dwarfgenaux (Target: TARGET) =
  struct
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_pointer_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_Dwarfgen_const_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let const_to_entry id c =
      new_entry id (DW_TAG_const_type ({const_type = c.cst_type}))
    (*- #End *)

    (*- E_COMPCERT_CODE_Dwarfgen_volatile_to_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Dwarfgen_prod_name_001 *)
(*- #Justify_Derived "Utility function" *)
let prod_name =
  let version_string =
