...
module DwarfPrinter(Target: DWARF_TARGET):
  ...
  struct
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_include_comment_001 *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_comment_001 *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_string_of_comment_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_string_of_byte_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (* Print a label *)
    (*- E_COMPCERT_CODE_DwarfPrinter_print_label_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_add_byte_001 *)
    (*- #Justify_Derived "Utility function" *)
    let add_byte buf value ct =
      Buffer.add_string buf (string_of_byte value ct)
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_add_abbr_uleb_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_add_file_loc_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_add_name_001 *)
    (*- #Justify_Derived "Utility function" *)
    let add_name buf = add_string buf 0x3 "DW_AT_name"
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_add_name_opt_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_add_location_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_add_range_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_abbrev_string_of_entity_001 *)
    (*- #Justify_Derived "Utility function" *)
    let abbrev_string_of_entity entity has_sibling =
      ...
      | DW_TAG_unspecified_parameter e ->
          ...
          add_attr_some e (add_abbr_entry (0x34,"DW_AT_artificial",DW_FORM_flag))
      | DW_TAG_variable e ->
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_abbrev_start_addr_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let abbrev_start_addr = ref (-1)
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_curr_abbrev_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let curr_abbrev = ref 1
    (*- #End *)

    (* Function to get unique abbreviation ids *)
    (*- E_COMPCERT_CODE_DwarfPrinter_next_abbrev_001 *)
    (*- #Justify_Derived "Utility function" *)
    let next_abbrev () =
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_compute_abbrev_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_abbrev_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_abbrev oc =
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_debug_start_addr_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let debug_start_addr = ref (-1)
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_debug_stmt_list_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let debug_stmt_list = ref (-1)
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_debug_ranges_addr_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let debug_ranges_addr = ref (-1)
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_entry_labels_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let entry_labels: (int,int) Hashtbl.t = Hashtbl.create 7
    (*- #End *)

    (* Translate the ids to address labels *)
    (*- E_COMPCERT_CODE_DwarfPrinter_entry_to_label_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_loc_labels_001 *)
    (*- #Justify_Derived "Variable for local state" *)
    let loc_labels: (int,int) Hashtbl.t = Hashtbl.create 7
    (*- #End *)

    (* Translate the ids to address labels *)
    (*- E_COMPCERT_CODE_DwarfPrinter_loc_to_label_001 *)
    (*- #Justify_Derived "Utility function" *)
    let loc_to_label id =
      try
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_loc_ref_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_opt_value_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_flag_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_flag oc c b =
      output_string oc (string_of_byte b c)
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_string_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_uleb128_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_uleb128 oc c d =
      fprintf oc "	.uleb128	%d%a\n" d print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_uleb128_64_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_uleb128_64 oc c d =
      fprintf oc "	.uleb128	%Lu%a\n" d print_comment c
    (*- #End *)


    (*- E_COMPCERT_CODE_DwarfPrinter_print_sleb128_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_sleb128 oc c d =
      fprintf oc "	.sleb128	%d%a\n" d print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_sleb128_64_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_sleb128_64 oc c d =
      fprintf oc "	.sleb128	%Ld%a\n" d print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_byte_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_byte oc c b =
      fprintf oc "	.byte		0x%X%a\n" b print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_byte64_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_byte64 oc c b =
      fprintf oc "	.byte		0x%LX%a\n" b print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_2byte_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_2byte oc c b =
      fprintf oc "	.2byte		0x%X%a\n" b print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_ref_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_file_loc_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_loc_expr_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_loc_expr oc = function
      ...
      | DW_OP_plus_uconst i ->
          ...
          print_uleb128_64 oc "Constant" i
      | DW_OP_piece i ->
          print_byte oc "DW_op_piece" dw_op_piece;
          print_uleb128 oc "Piece" i
      | DW_OP_bit_piece (s, o) ->
        print_byte oc "DW_op_bit_pice" dw_op_bit_piece;
        print_uleb128 oc "Bit size" s;
        print_uleb128 oc "Offset" o
      | DW_OP_reg i ->
          if i < 32 then
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_loc_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_list_loc_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_data_location_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_addr_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_addr oc c a =
      fprintf oc "	%s		%a%a\n" address label a print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_data4_addr_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_data4_addr oc c a =
      fprintf oc "	.4byte	%a%a\n" label a print_comment c
    (*- #End *)

    (*- E_COMPCERT_CODE_DwarfPrinter_print_bound_value_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_base_type_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_range_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_compilation_unit_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_enumeration_type_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_enumerator_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_formal_parameter_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_member_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_member oc mb =
      print_opt_value oc "DW_AT_byte_size" mb.member_byte_size print_byte64;
      print_opt_value oc "DW_AT_bit_offset" mb.member_bit_offset print_byte64;
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_structure_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_structure oc st =
      print_file_loc oc st.structure_file_loc;
      print_opt_value oc "DW_AT_byte_size" st.structure_byte_size print_uleb128_64;
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_subprogram_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_subrange_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_subroutine_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_typedef_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_union_type_001 *)
    (*- #Justify_Derived "Utility function" *)
    let print_union_type oc ut =
      print_file_loc oc ut.union_file_loc;
      print_opt_value oc "DW_AT_byte_size" ut.union_byte_size print_uleb128_64;
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_variable_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    let  print_entry oc entry =
      entry_iter_sib (fun sib entry ->
        ...
        begin
          ...
          | DW_TAG_lexical_block lb -> print_range oc lb
          | DW_TAG_member mb -> print_member oc mb
          | DW_TAG_pointer_type pt -> print_ref oc "DW_AT_type" pt
          ...
          | DW_TAG_unspecified_parameter up -> print_opt_value oc "DW_AT_artificial" up print_flag
          | DW_TAG_variable var -> print_variable oc var
          | DW_TAG_volatile_type vt ->  print_ref oc "DW_AT_type" vt
        end) (fun e ->
          if e.children <> [] then
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_debug_info_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_location_entry_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_location_entry_abs_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_location_list_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_list_opt_001 *)
    (*- #Justify_Derived "Utility function" *)
    let list_opt l f =
      match l with
      | [] -> ()
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_diab_entries_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_ranges_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_gnu_entries_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_DwarfPrinter_print_debug_001 *)
    (*- #Justify_Derived "Utility function" *)
