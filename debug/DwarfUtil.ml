...
(* Sizeof functions for the encoding of uleb128 and sleb128 *)
(*- E_COMPCERT_CODE_DwarfUtil_sizeof_uleb128_64_001 *)
(*- #Justify_Derived "Utility function" *)
let sizeof_uleb128_64 value =
  let size = ref 1 in
...
(*- E_COMPCERT_CODE_DwarfUtil_sizeof_sleb128_64_001 *)
(*- #Justify_Derived "Utility function" *)
let sizeof_sleb128_64 value =
  let size = ref 1 in
...
let size_of_loc_expr = function
  | DW_OP_bregx (a,b) -> 1 + (sizeof_uleb128 a)  + (sizeof_sleb128_64 b)
  | DW_OP_plus_uconst a -> 1 + (sizeof_uleb128_64 a)
  | DW_OP_piece a -> 1 + (sizeof_uleb128 a)
  | DW_OP_bit_piece (a,b) -> 1 + (sizeof_uleb128 a) + (sizeof_uleb128 b)
