...
type composite_field =
    {
     ...
     cfd_bit_offset:  int64 option;
     cfd_byte_offset: int64 option;
     cfd_byte_size:   int64 option;
   }
...
type var_range =
    {
     ...
     var_loc:     int * (int *  (int * int) option) builtin_arg;
   }

type var_location =
  | RangeLoc of var_range list
  | FunctionLoc of  int * (int *  (int * int) option) builtin_arg (* Stack allocated variables *)
