...
Lemma transl_savecallee_label:
  forall l ofs k c,
    transl_savecallee ofs l k = OK c ->
    tail_nolabel k c.
Proof.
  intros until k. functional induction transl_savecallee ofs l k; intros; TailNoLabel.
  - eapply tail_nolabel_trans.
    eapply store_pair_label; eauto.
    apply IHr; auto.
...
Remark transl_restorecallee_label:
  ...
  tail_nolabel k c.
Proof.
  intros until k. functional induction transl_restorecallee ofs l k; intros; TailNoLabel.
  - eapply tail_nolabel_trans.
    eapply load_pair_label; eauto.
    apply IHr; auto.
...
- eapply storeind_label; eauto.
- eapply transl_restorecallee_label; eauto.
- eapply transl_savecallee_label; eauto.
...
- (* Mrestorecallee *)
  exploit load_stack_regs_extends; eauto. intros [rs1 [A B]].
  left; eapply exec_straight_steps; eauto.
  intros. simpl in TR. destruct l. monadInv TR.
  rewrite (sp_val _ _ _ AG) in A.
...
- (* Msavecallee *)
  ...
  intros. simpl in TR. destruct l. monadInv TR.
  rewrite (sp_val _ _ _ AG) in A.
  exploit transl_savecallee_correct; eauto. discriminate.
  intros [rs2 [C D]].
  exists rs2; split. eauto. split.
