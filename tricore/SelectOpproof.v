...
Proof.
  ...
  - econstructor; split. EvalOp.
    ...
    destruct n2 as [n2 Hn2]; simpl.
    rewrite Hn2. f_equal.
    apply Int.shl_mul.
  - econstructor; split. EvalOp.
    apply Val.lessdef_same. rewrite Val.add_commut. f_equal.
    destruct v1; simpl; eauto.
    destruct n1 as [n1 Hn1]; simpl.
    rewrite Hn1. f_equal.
    apply Int.shl_mul.
  - TrivialExists.
Qed.
...
Proof.
  ...
  rewrite Val.sign_ext_shr_shl; auto.
Qed.
...
Proof.
  ...
  simpl. f_equal. f_equal. destruct (eval_condition cond vl m); auto.
...
Proof.
  ...
  - (* BI_cadd *)
    ...
    inv SEL. inv SEM.
    econstructor. split.
    econstructor. econstructor; eauto. econstructor; eauto. econstructor; eauto. econstructor.
    reflexivity. destruct v1, v0, v2; auto. simpl.
...
Proof.
  ...
  - InvEval. inv H0. TrivialExists. simpl. destruct v1; auto. simpl.
    rewrite <- (Int64.ofwords_recompose i) at 2.  rewrite Int64.decompose_neg.
