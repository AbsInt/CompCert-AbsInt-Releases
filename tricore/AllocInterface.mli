...
val class_of_ptype: AST.ptype -> int

val interferes_caller_save: AST.ptype -> Machregs.mreg -> bool

val classes: int list

val default_ptype_of_class: int -> AST.ptype
...
val expand_loc: Locations.ploc -> Locations.ploc AST.rpair
