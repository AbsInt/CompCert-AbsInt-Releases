...
Definition type_of_operation (op: operation) : list typ * typ :=
  ...
  | Oxnor => (Tint :: Tint :: nil, Tint)
  | Oxnorimm _ => (Tint :: nil, Tint)
  | Oxor => (Tint :: Tint :: nil, Tint)
  | Oxorimm _ => (Tint :: nil, Tint)
  
  | Osl => (Tint :: Tint :: nil, Tint)
  | Oslimm _ => (Tint :: nil, Tint)
  | Oasr => (Tint :: Tint :: nil, Tint)
  | Oasrimm _ => (Tint :: nil, Tint)
  | Olsr => (Tint :: Tint :: nil, Tint)
  | Olsrimm _ => (Tint :: nil, Tint)
  ...
  | Oextr _ _ => (Tint :: nil, Tint)
  | Oextru _ _ => (Tint :: nil, Tint)
  | Oinsert _ _ => (Tint :: Tint :: nil, Tint)
  | Oinsertimm _ _ _ => (Tint :: nil, Tint)
...
Proof.
  intros. unfold Val.has_type, Val.add. destruct Archi.ptr64, v1, v2; simpl; auto.
Qed.
...
Proof with (try exact I; try reflexivity; auto using Val.Vptr_has_type).
  ...
  - unfold Val.has_type, Val.and. destruct v0, v1; trivial.
  - destruct v0...
  - destruct v0, v1...
  (* conditional move *)
  - unfold Val.select. destruct (eval_condition c vl m); simpl... apply Val.normalize_type.
...
Proof.
  intros. simpl. apply Int.zero_ext_range_eq. assumption.
Qed.
