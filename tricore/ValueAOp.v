...
Definition eval_static_operation (op: operation) (vl: list aval): aval :=
  ...
  | Osel ty, v1::v2::v3::nil => select (eval_static_condition (Ccompimm Cne Int.zero) (v1 :: nil)) v2 v3 ty
...
Proof.
  ...
  apply (pcast_sound a1 b1); auto. apply select_sound; auto.
  ...
  exploit (eval_static_condition_sound (Ccompimm Cne Int.zero) (a1 :: nil) m).
  econstructor; eauto with va. econstructor. simpl. auto with va. auto with va.
