...
(*- E_COMPCERT_FTR_Function_Csem_genv_0_001 *)
(*- #Justify_Derived "Internal type for representing a global environment in the Csem Semantic" *)
Record genv := { genv_genv :> Genv.t fundef type; genv_cenv :> composite_env }.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Csem_globalenv_001 *)
(*- #Justify_Derived "Function to get a global environment from a program" *)
...
(*- E_COMPCERT_FTR_Function_Csem_env_001 *)
(*- #Justify_Derived "Internal definition for the local environment in the Csem Semantic" *)
Definition env := PTree.t (block * type). (* map variable -> location & type *)
(*- #End *)

(*- E_COMPCERT_FTR_Function_Csem_empty_env_001 *)
(*- #Justify_Derived "Empty local environment" *)
...
(*- E_COMPCERT_FTR_Function_Csem_deref_loc_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_015 *)
...
(*- E_COMPCERT_FTR_Function_Csem_assign_loc_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ASSIGNMENT_OPERATORS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_ASSIGNMENT_OPERATORS_007 *)
(*- #Link_to E_COMPCERT_TOR_Function_ASSIGNMENT_OPERATORS_008 *)
...
(*- E_COMPCERT_FTR_Function_Csem_alloc_variables_0_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_bind_parameters_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_ARGS_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_block_of_binding_001 *)
(*- #Justify_Derived "Auxiliary function" *)
Definition block_of_binding (id_b_ty: ident * (block * type)) :=
  match id_b_ty with (id, (b, ty)) => (b, 0, sizeof ge ty) end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Csem_blocks_of_env_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_003 *)
...
(*- E_COMPCERT_FTR_Function_Csem_select_switch_default_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_STATEMENT_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_select_switch_case_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_STATEMENT_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_select_switch_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_STATEMENT_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_seq_of_labeled_statement_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_STATEMENT_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_cast_arguments_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_FUNC_CALL_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_020 *)
...
(*- E_COMPCERT_FTR_Function_Csem_lred_0_1_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_LVALUE_001 *)
  | red_var_local: forall x ty m b,
      e!x = Some(b, ty) ->
      lred (Evar x ty) m
           (Eloc b Ptrofs.zero Full ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_lred_0_2_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_LVALUE_002 *)
  | red_var_global: forall x ty m b,
      ...
      lred (Evar x ty) m
           (Eloc b Ptrofs.zero Full ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_lred_0_3_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDR_IND_OPERATORS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_LVALUE_003 *)
  | red_deref: forall b ofs ty1 ty m,
      lred (Ederef (Eval (Vptr b ofs) ty1) ty) m
           (Eloc b ofs Full ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_lred_0_4_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_MEMBERS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_MEMBERS_004 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_lred_0_5_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_MEMBERS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_MEMBERS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_MEMBERS_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_LVALUE_005 *)
...
(*- E_COMPCERT_FTR_Function_Csem_rred_0_1_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_001 *)
  | red_rvalof: forall b ofs bf ty m t v,
      ...
      rred (Evalof (Eloc b ofs bf ty) ty) m
         t (Eval v ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_2_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDR_IND_OPERATORS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_002 *)
  | red_addrof: forall b ofs ty1 ty m,
      rred (Eaddrof (Eloc b ofs Full ty1) ty) m
        E0 (Eval (Vptr b ofs) ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_3_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_UNARY_OP_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_UNARY_OP_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_UNARY_OP_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_UNARY_OP_004 *)
  | red_unop: forall op v1 ty1 ty m v,
      ...
      rred (Eunop op (Eval v1 ty1) ty) m
        E0 (Eval v ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_4_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_004 *)
  | red_binop: forall op v1 ty1 v2 ty2 ty m v,
      ...
      rred (Ebinop op (Eval v1 ty1) (Eval v2 ty2) ty) m
        E0 (Eval v ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_5_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_019 *)
  | red_cast: forall ty v1 ty1 m v,
      sem_cast v1 ty1 ty m = Some v ->
      rred (Ecast (Eval v1 ty1) ty) m
        E0 (Eval v ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_6_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_AND_OPERATOR_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_AND_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_006 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_7_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_AND_OPERATOR_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_AND_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_007 *)
  | red_seqand_false: forall v1 ty1 r2 ty m,
      bool_val v1 ty1 m = Some false ->
      rred (Eseqand (Eval v1 ty1) r2 ty) m
        E0 (Eval (Vint Int.zero) ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_8_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_OR_OPERATOR_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_OR_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_008 *)
  | red_seqor_true: forall v1 ty1 r2 ty m,
      bool_val v1 ty1 m = Some true ->
      rred (Eseqor (Eval v1 ty1) r2 ty) m
        E0 (Eval (Vint Int.one) ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_9_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_OR_OPERATOR_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOGICAL_OR_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_009 *)
  | red_seqor_false: forall v1 ty1 r2 ty m,
      bool_val v1 ty1 m = Some false ->
      rred (Eseqor (Eval v1 ty1) r2 ty) m
        E0 (Eparen r2 type_bool ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_10_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONDITIONAL_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_010 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_011 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_11_001 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_12_001 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_13_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ASSIGNMENT_OPERATORS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_ASSIGNMENT_OPERATORS_007 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_014 *)
  | red_assign: forall b ofs ty1 bf v2 ty2 m v t m' v',
      ...
      rred (Eassign (Eloc b ofs bf ty1) (Eval v2 ty2) ty1) m
         t (Eval v' ty1) m'
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_14_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ASSIGNMENT_OPERATORS_011 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_015 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_15_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_POSTFIX_OPERATORS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_POSTFIX_OPERATORS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_016 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_017 *)
  | red_postincr: forall id b ofs ty bf m t v1 op,
      ...
      rred (Epostincr id (Eloc b ofs bf ty) ty) m
         t (Ecomma (Eassign (Eloc b ofs bf ty)
                   ...
                   (Eval v1 ty) ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_16_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMMA_OPERATOR_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_018 *)
  | red_comma: forall v ty1 r2 ty m,
      typeof r2 = ty ->
      rred (Ecomma (Eval v ty1) r2 ty) m
        E0 r2 m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_17_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_019 *)
  | red_paren: forall v1 ty1 ty2 ty m v,
      ...
      rred (Eparen (Eval v1 ty1) ty2 ty) m
        E0 (Eval v ty) m
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_rred_0_18_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_020 *)
...
(*- E_COMPCERT_FTR_Function_Csem_callred_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_FUNC_CALL_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_kind_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_001 *)
Inductive kind : Type := LV | RV.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Csem_context_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXPRESSIONS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_010 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_imm_safe_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TRANSITION_ERROR_001 *)
...
Proof.
  ...
  set (sg := mksignature (Targ AST.Tint :: AST.Targ t :: AST.Targ t :: nil) t cc_default).
...
(*- E_COMPCERT_FTR_Function_Csem_cont_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BREAK_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_BREAK_STATEMENT_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_COND_STRUCT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COND_STRUCT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_COND_STRUCT_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONTINUE_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONTINUE_STATEMENT_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_DO_STATEMENT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXP_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXP_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_ARGS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_GOTO_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_IF_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_LABEL_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_007 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_004 *)
Inductive cont: Type :=
  | Kstop: cont
...
(*- E_COMPCERT_FTR_Function_Csem_call_cont_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_GOTO_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_is_call_cont_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_state_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXECUTION_STATES_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_find_label_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_GOTO_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_GOTO_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_JUMP_STATEMENTS_002 *)
...
(*- E_COMPCERT_FTR_Function_Csem_estep_0_1_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXPRESSIONS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_estep_0_2_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXPRESSIONS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_002 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_estep_0_3_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXPRESSIONS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_007 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_009 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_010 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_011 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_EXPR_STATE_003 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_estep_0_4_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TRANSITION_ERROR_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_1_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXPRESSION_AND_NULL_STATEMENTS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXP_001 *)
  | step_do_1: forall f x k e m,
      sstep (State f (Sdo x) k e m)
         E0 (ExprState f x (Kdo k) e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_2_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXPRESSION_AND_NULL_STATEMENTS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_EXP_002 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_3_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENTS_AND_BLOCKS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENT_001 *)
  | step_seq:  forall f s1 s2 k e m,
      sstep (State f (Ssequence s1 s2) k e m)
         E0 (State f s1 (Kseq s2 k) e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_4_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENTS_AND_BLOCKS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENT_002 *)
  | step_skip_seq: forall f s k e m,
      sstep (State f Sskip (Kseq s k) e m)
         E0 (State f s k e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_5_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONTINUE_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONTINUE_STATEMENT_003 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_6_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BREAK_STATEMENT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_BREAK_STATEMENT_003 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_7_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COND_STRUCT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_IF_STATEMENT_002 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_8_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COND_STRUCT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_COND_STRUCT_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_IF_STATEMENT_002 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_9_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_WHILE_STATEMENT_001 *)
  | step_while: forall f x s k e m,
      sstep (State f (Swhile x s) k e m)
        E0 (ExprState f x (Kwhile1 x s k) e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_10_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_002 *)
  | step_while_false: forall f v ty x s k e m,
      ...
      sstep (ExprState f (Eval v ty) (Kwhile1 x s k) e m)
        E0 (State f Sskip k e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_11_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_003 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_12_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_004 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_13_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_WHILE_005 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_14_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_DO_STATEMENT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_001 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_15_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_002 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_16_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_004 *)
  | step_dowhile_false: forall f v ty x s k e m,
      ...
      sstep (ExprState f (Eval v ty) (Kdowhile2 x s k) e m)
         E0 (State f Sskip k e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_17_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_005 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_18_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_DOWHILE_003 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_19_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FOR_STATEMENT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_001 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_20_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_002 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_21_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_003 *)
  | step_for_false: forall f v ty a2 a3 s k e m,
      ...
      sstep (ExprState f (Eval v ty) (Kfor2 a2 a3 s k) e m)
         E0 (State f Sskip k e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_22_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_004 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_23_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_005 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_24_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_006 *)
  | step_break_for3: forall f a2 a3 s k e m,
      sstep (State f Sbreak (Kfor3 a2 a3 s k) e m)
         E0 (State f Sskip k e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_25_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ITERATION_STATEMENTS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LOOP_FOR_007 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_26_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_RETURN_STATEMENT_002 *)
  | step_return_0: forall f k e m m',
      Mem.free_list m (blocks_of_env e) = Some m' ->
      sstep (State f (Sreturn None) k e m)
         E0 (Returnstate Vundef (call_cont k) m')
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_27_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_RETURN_STATEMENT_003 *)
  | step_return_1: forall f x k e m,
      sstep (State f (Sreturn (Some x)) k e m)
         E0 (ExprState f x (Kreturn k) e  m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_28_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_003 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_29_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_004 *)
...
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_32_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_003 *)
  | step_skip_break_switch: forall f x k e m,
      ...
      sstep (State f x (Kswitch2 k) e m)
         E0 (State f Sskip k e m)
(*- #End *)
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_33_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SWITCH_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_34_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_LABELED_STATEMENT_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_LABEL_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_35_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_GOTO_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_36_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_006 *)
...
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_ARGS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_DEFINITION_011 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_37_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_002 *)
...
(*- E_COMPCERT_FTR_Function_Csem_sstep_0_38_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALLS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_DEFINITION_012 *)
(*- #Link_to E_COMPCERT_TOR_Function_RETURN_STATEMENT_003 *)
...
(*- E_COMPCERT_FTR_Function_Csem_step_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_TRANSITION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENTS_AND_BLOCKS_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENTS_AND_BLOCKS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_STATEMENTS_AND_BLOCKS_004 *)
...
(*- E_COMPCERT_FTR_Function_Csem_initial_state_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_STARTUP_001 *)
...
(*- E_COMPCERT_FTR_Function_Csem_final_state_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_TERMINATION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_002 *)
...
(*- E_COMPCERT_FTR_Function_Csem_semantics_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_EXECUTION_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_PROGRAM_TERMINATION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_002 *)
