...
(*- E_COMPCERT_FTR_Function_Initializers_constval_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONSTANT_EXPRESSIONS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_CONSTANT_EXPRESSIONS_011 *)
Fixpoint constval (ce: composite_offset_env) (a: expr) : res val :=
  match a with
  | Eval v ty =>
      match v with
...
Definition constval_cast (ce: composite_offset_env) (a: expr) (ty: type): res val :=
...
Definition transl_init_single (ce: composite_offset_env) (ty: type) (a: expr) : res init_data :=
...
Definition transl_init_bitfield (ce: composite_offset_env) (s: state)
...
Fixpoint transl_init_rec (ce: composite_offset_env) (s: state)
...
with transl_init_array (ce: composite_offset_env) (s: state)
...
with transl_init_struct (ce: composite_offset_env) (s: state)
...
Definition transl_init (ce: composite_offset_env) (ty: type) (i: initializer)
                       : res (list init_data) :=
