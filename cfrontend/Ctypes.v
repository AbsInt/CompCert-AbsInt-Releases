...
Require Import Axioms Coqlib Zbits Maps Errors.
Require Import AST Linking Compopts.
Require Archi.
...
(*- E_COMPCERT_FTR_Function_Ctypes_signedness_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Inductive signedness : Type :=
  | Signed: signedness
  | Unsigned: signedness.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_intsize_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_floatsize_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_attr_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_noattr_001 *)
(*- #Justify_Derived "Auxiliary constant used as shortcut" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_type_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Inductive type : Type :=
...
(*- E_COMPCERT_FTR_Function_Ctypes_intsize_eq_001 *)
(*- #Justify_Derived "Auxiliary function needed for decidable equality" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_signedness_eq_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_attr_of_type_001 *)
(*- #Justify_Derived "Helper function for extracting attributes from internal type" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_change_attributes_001 *)
(*- #Justify_Derived "Helper function to update attributes of an internal type via f" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_remove_attributes_001 *)
(*- #Justify_Derived "Helper function for removing attributes from internal type" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_bitsize_intsize_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_struct_or_union_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Inductive struct_or_union : Type := Struct | Union.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_member_0_001 *)
(*- #Justify_Derived "Internal type used for distinguishing bitfield form plain access" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_members_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Definition members : Type := list member.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_composite_definition_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Inductive composite_definition : Type :=
  Composite (id: ident) (su: struct_or_union) (m: members) (a: attr).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_name_member_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_type_member_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_member_is_padding_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_composite_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TYPE_REPRESENTATION_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_composite_env_001 *)
(*- #Justify_Derived "Internal type for the environment of composites in Csem Semantic" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_bitfield_0_001 *)
(*- #Justify_Derived "Internal type used for distinguishing bitfield access" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_type_int32s_001 *)
(*- #Justify_Derived "Auxiliary constant used as shortcut" *)
Definition type_int32s := Tint I32 Signed noattr.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Ctypes_type_bool_001 *)
(*- #Justify_Derived "Auxiliary constant used as shortcut" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_typeconv_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ARITHMETIC_CONVERSION_001 *)
...
Definition default_argument_conversion (ty: type) : type :=
  match ty with
  | Tint (I8 | I16 | IBool) _ _ => Tint I32 Signed noattr
  | Tfloat _ _          => if supports_double then Tfloat F64 noattr else Tfloat F32 noattr
  | Tarray t sz a       => Tpointer t noattr
  | Tfunction _ _ _     => Tpointer ty noattr
  | _                   => remove_attributes ty
  end.
...
(*- E_COMPCERT_FTR_Function_Ctypes_complete_type_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_align_attr_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_013 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_MEM_ALIGNMENT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_013 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_align_attr_two_p_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_two_p_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
Lemma alignof_two_p:
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_pos_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
Lemma alignof_pos:
...
(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EABI_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNCTION_CALL_ARGS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_FUNC_RETURN_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_012 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_014 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_003 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_pos_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
Lemma sizeof_pos:
...
(*- E_COMPCERT_FTR_Function_Ctypes_bitalignof_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
Definition bitalignof (t: type) := Z.shiftl (alignof env t) 3.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_bitsizeof_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
Definition bitsizeof  (t: type) := sizeof env t * 8.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_bitalignof_intsize_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_align_p_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition align' (pos amount: Z) : Z :=
  match Z_is_power2 amount with
  | Some p => Z.shiftl (Z.shiftr (pos + amount - 1) p) p
  | None => align pos amount
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_align_p_align_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
Lemma align'_align:
  forall x y, align' x y = align x y.
Proof.
  unfold align'. intros. destruct (Z_is_power2 y) eqn:?; auto.
  unfold align. generalize (Z_is_power2_nonneg y z Heqo). intros.
  destruct (Z_is_power2_sound y z Heqo).
  rewrite Zshiftl_mul_two_p, Zshiftr_div_two_p, H0; auto.
Qed.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_next_field_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_019 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_020 *)
...
(** Byte level position and a bitfield designator, giving the location of the bits to access within the storage unit for the bitfield. *)
(*- E_COMPCERT_FTR_Function_Ctypes_offset_001 *)
(*- #Justify_Derived "Internal type for offsets of composite members" *)
Definition offset : Type := Z * bitfield.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_layout_field_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_019 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_020 *)
Definition layout_field (pos: Z) (m: member) : res offset :=
  match m with
  | Member_plain _ t =>
      OK (Z.shiftr (align' pos (bitalignof t)) 3, Full)
...
(*- E_COMPCERT_FTR_Function_Ctypes_bitalignof_intsize_pos_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_next_field_incr_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
Lemma next_field_incr:
  forall pos m, pos <= next_field pos m.
Proof.
  intros. unfold next_field. destruct m; rewrite align'_align.
- set (al := bitalignof t).
  assert (A: al > 0).
  { unfold al, bitalignof. generalize (alignof_pos env t).
    rewrite Zshiftl_mul_two_p by lia. change (two_p 3) with 8. lia. }
...
- inv L. rewrite align'_align. simpl.
  set (al := bitalignof t).
  set (q := align pos al).
  assert (A: al > 0).
  { unfold al, bitalignof. generalize (alignof_pos env t).
    rewrite Zshiftl_mul_two_p by lia. change (two_p 3) with 8.
    lia. }
  assert (B: pos <= q) by (apply align_le; auto).
  assert (C: (al | q)) by (apply align_divides; auto).
  assert (D: (8 | q)). 
  { apply Z.divide_transitive with al; auto. unfold al, bitalignof.
    rewrite Zshiftl_mul_two_p by lia.
    apply Z.divide_factor_r. }
  assert (E: q / 8 * 8 = q).
  { destruct D as (n & E). rewrite E. rewrite Z.div_mul by lia. auto. }
  rewrite Zshiftr_div_two_p by lia. change (two_p 3) with 8.
  rewrite E. rewrite align'_align. lia.
- unfold next_field.
...
- inv L; simpl.  rewrite align'_align.
  set (q := align pos (bitalignof t)).
  assert (A: (bitalignof t | q)).
  { apply align_divides. unfold bitalignof. generalize (alignof_pos env t).
    rewrite Zshiftl_mul_two_p by lia. change (two_p 3) with 8.
    lia. }
  destruct A as [n E]. exists n. rewrite E. unfold bitalignof.
  rewrite Zshiftr_div_two_p by lia.
  rewrite Zshiftl_mul_two_p by lia. change (two_p 3) with 8.
  rewrite Z.mul_assoc, Z.div_mul by lia. auto.
- destruct (zle width 0); try discriminate.
  destruct (zlt (bitsize_intsize sz) width); try discriminate.
  set (s := bitalignof_intsize sz) in *.
  assert (A: s > 0) by (apply bitalignof_intsize_pos).
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_composite_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_MEM_ALIGNMENT_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_bitsizeof_struct_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EABI_001 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_bytes_of_bits_001 *)
(*- #Justify_Derived "Auxiliary Definition" *)
Definition bytes_of_bits (n: Z) := (n + 7) / 8.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_struct_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EABI_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_003 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_union_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EABI_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_003 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_composite_two_p_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_composite_pos_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_bitsizeof_struct_incr_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_union_pos_001 *)
(*- #Justify_Derived "Auxiliary Lemma" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_field_offset_rec_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_LVALUE_004 *)
Fixpoint field_offset_rec (env: composite_env) (id: ident) (ms: members) (pos: Z)
                          {struct ms} : res offset :=
  match ms with
  | nil => Error (MSG "Unknown field " :: CTX id :: nil)
  | m :: ms =>
...
(*- E_COMPCERT_FTR_Function_Ctypes_field_offset_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_LVALUE_004 *)
Definition field_offset (env: composite_env) (id: ident) (ms: members) : res offset :=
...
(*- E_COMPCERT_FTR_Function_Ctypes_union_field_offset_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_019 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_020 *)
...
- destruct (ident_eq id (name_member m)).
  + inv H0. set (ty := type_member m) in *.
    ...
    * inv H. unfold layout_start, layout_width. rewrite align'_align.
      rewrite align_same. change (Z.shiftr 0 3) with 0. unfold bitsizeof. lia.
      unfold bitalignof. generalize (alignof_pos env t).
      rewrite Zshiftl_mul_two_p by lia. change (two_p 3) with 8.
      lia.
      apply Z.divide_0_r.
    * destruct (zle width 0); try discriminate.
...
(** * Whole-composite offset precomputation and caching *)

(** As calling [field_offset] alone throughout the compilation process 
  would be inefficient, we precompute the offsets for every composite and
  every member.
*)

(* Maps members of a single composite to their offsets *)
(*- E_COMPCERT_FTR_Function_Ctypes_composite_offsets_001 *)
(*- #Justify_Derived "Internal type for the precomputed offsets of a single composite members" *)
Definition composite_offsets : Type := PTree.t (res offset).
(*- #End *)
(* An offset environment maps a composite id to a member id to an offset *)
(*- E_COMPCERT_FTR_Function_Ctypes_offset_env_001 *)
(*- #Justify_Derived "Internal type for the precomputed offsets of composite members" *)
Definition offset_env: Type := PTree.t composite_offsets.
(*- #End *)
(* An augmented version of [composite_env] that also contains precomputed offsets *)
Record composite_offset_env: Type := {
  coe_env:> composite_env;
  coe_offsets:> offset_env;
}.

Definition empty_composite_offset_env := {|
  coe_env := PTree.empty _;
  coe_offsets := PTree.empty _;
|}.

(*- E_COMPCERT_FTR_Function_Ctypes_layout_struct_rec_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Fixpoint layout_struct_rec (env: composite_env) (ms: members) (pos: Z) {struct ms} : composite_offsets :=
  match ms with
  | nil => PTree.empty _
  | m :: ms =>
    let ms_offsets := layout_struct_rec env ms (next_field env pos m) in
    let offset := layout_field env pos m in
    PTree.set (name_member m) offset ms_offsets
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_layout_struct_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Definition layout_struct (env: composite_env) (ms: members) : composite_offsets :=
  layout_struct_rec env ms 0.
(*- #End *)

Lemma layout_struct_rec_sound (env: composite_env) (ms: members) (i: ident) (ofs: res offset) :
  forall pos,
  (layout_struct_rec env ms pos) ! i = Some ofs ->
  field_offset_rec env i ms pos = ofs.
Proof.
  induction ms.
  - intros pos H2.
  ...
  - destruct (ident_eq i (name_member a)).
    + subst.
      intros pos H2.
      unfold layout_struct_rec in H2.
      unfold field_offset_rec.
      destruct (ident_eq (name_member a) (name_member a)) eqn:E; try contradiction.
      rewrite PTree.gss in H2. 
      inversion H2. reflexivity.
    + intros pos H2.
      simpl.
      destruct (ident_eq i (name_member a)) eqn:E; try contradiction.
      unfold layout_struct_rec in H2.
      rewrite (PTree.gso _) in H2; try assumption.
      apply IHms. assumption.
Qed.

Lemma layout_struct_sound (env: composite_env) (ms: members) (i: ident) (ofs: res offset) :
  (layout_struct env ms) ! i = Some ofs ->
  field_offset env i ms = ofs.
Proof.
  apply layout_struct_rec_sound.
Qed.

(*- E_COMPCERT_FTR_Function_Ctypes_layout_union_rec_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Fixpoint layout_union_rec (env: composite_env) (ms: members) {struct ms} : composite_offsets :=
  match ms with
  | nil => PTree.empty _
  | m :: ms =>
    let ms_offsets := layout_union_rec env ms in
    let offset := layout_field env 0 m in
    PTree.set (name_member m) offset ms_offsets
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_layout_union_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Definition layout_union (env: composite_env) (ms: members) : composite_offsets :=
  layout_union_rec env ms.
(*- #End *)

Lemma layout_union_rec_sound (env: composite_env) (ms: members) (i: ident) (ofs: res offset) :
  (layout_union_rec env ms) ! i = Some ofs ->
  union_field_offset env i ms = ofs.
Proof.
  induction ms.
  - intros H2.
    rewrite PTree.gempty in H2; discriminate.
  - destruct (ident_eq i (name_member a)).
    + subst.
      intros H2.
      unfold union_field_offset.
      destruct (ident_eq (name_member a) (name_member a)) eqn:E; try contradiction.
      unfold layout_union_rec in H2.
      rewrite PTree.gss in H2.
      inversion H2. reflexivity.
    + intros H2.
      simpl.
...
Lemma layout_union_sound (env: composite_env) (ms: members) (i: ident) (ofs: res offset) :
  (layout_union env ms) ! i = Some ofs ->
  union_field_offset env i ms = ofs.
Proof.
  apply layout_union_rec_sound.
Qed.

Definition precompute_single_composite_offsets (env: composite_env) (co: composite) : composite_offsets :=
  match co.(co_su) with 
    | Struct => layout_struct env (co_members co) 
    | Union => layout_union env (co_members co) 
  end.

(** Precomputes a cache of offsets for a given [composite_env]. Both structs and unions are supported. *)
(*- E_COMPCERT_FTR_Function_Ctypes_precompute_single_composite_offsets_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Definition precompute_offsets (env: composite_env) : offset_env :=
  PTree.map1 (precompute_single_composite_offsets env) env.
(*- #End *)

(** Looks up a precomputed offset of a member in a given composite. *)
(*- E_COMPCERT_FTR_Function_Ctypes_precompute_offsets_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_SUPPORTED_TYPES_001 *)
Definition lookup_offset (offset_env: offset_env) (composite_id: ident) (member_id: ident) : res offset :=
  match offset_env!composite_id with
  | None => Error (MSG "Composite not found in env " :: CTX composite_id :: nil)
  | Some co_offsets =>
    match co_offsets!member_id with
      | None => Error (MSG "Member not found in composite " :: CTX member_id :: nil)
      | Some offset => offset
    end
  end.
(*- #End *)

(** Looks up a precomputed offset of a member in a given struct. Fails if [composite_id] is not found or refers to a non-struct. *)
Definition lookup_struct_offset (env: composite_offset_env) (composite_id: ident) (member_id: ident) : res offset :=
  match env.(coe_env)!composite_id with
  | None => Error (MSG "Composite not found in env " :: CTX composite_id :: nil)
  | Some co =>
    match co.(co_su) with
    | Struct => lookup_offset env composite_id member_id
    | _ => Error (MSG "Composite is not a struct " :: CTX composite_id :: nil)
    end
  end.

(** Looks up a precomputed offset of a member in a given union. Fails if [composite_id] is not found or refers to a non-union. *)
Definition lookup_union_offset (env: composite_offset_env) (composite_id: ident) (member_id: ident) : res offset :=
  match env.(coe_env)!composite_id with
  | None => Error (MSG "Composite not found in env " :: CTX composite_id :: nil)
  | Some co =>
    match co.(co_su) with
    | Union => lookup_offset env composite_id member_id
    | _ => Error (MSG "Composite is not a union " :: CTX composite_id :: nil)
    end
end.

(** Consistency properties of the offset cache.  *)

Lemma lookup_offset_sound (ce: composite_env) (oe: offset_env) (ce_oe_match: precompute_offsets ce = oe):
  forall id i ofs,
  lookup_offset oe id i = OK ofs ->
  exists co, ce ! id = Some co /\
  match co.(co_su) with
  | Struct => field_offset ce i co.(co_members) = OK ofs
  | Union => union_field_offset ce i co.(co_members) = OK ofs
  end.
Proof.
  intros.
  unfold lookup_offset in H.
  destruct oe ! id eqn:E1; try discriminate.
  destruct c!i eqn:E2; try discriminate.

  unfold precompute_offsets in ce_oe_match.
  pose proof (PTree.gmap1 (precompute_single_composite_offsets ce) id ce).
  rewrite <- ce_oe_match in E1.
  rewrite E1 in H0.
  ...
  exists c0.
  split. reflexivity.
  unfold precompute_single_composite_offsets in H2.
  - destruct c0.(co_su).
    + subst.
      apply layout_struct_sound. assumption.
    + subst.
      apply layout_union_sound. assumption.
Qed.

Lemma lookup_struct_offset_sound (env: composite_offset_env) (ce_oe_match: precompute_offsets env.(coe_env) = env.(coe_offsets)):
  forall id i ofs,
  lookup_struct_offset env id i = OK ofs ->
  exists co, env.(coe_env) ! id = Some co /\
  field_offset env.(coe_env) i co.(co_members) = OK ofs.
Proof.
  intros.
  unfold lookup_struct_offset in H.
  destruct (env.(coe_env) ! id) eqn:E1; try discriminate.
  destruct c.(co_su) eqn:E2; try discriminate.
  destruct (lookup_offset_sound env.(coe_env) env.(coe_offsets) ce_oe_match id i ofs H) as [c1 [H1 H2]].
...
Lemma lookup_union_offset_sound (env: composite_offset_env) (ce_oe_match: precompute_offsets env.(coe_env) = env.(coe_offsets)):
  forall id i ofs,
  lookup_union_offset env id i = OK ofs ->
  exists co, env.(coe_env) ! id = Some co /\
  union_field_offset env.(coe_env) i co.(co_members) = OK ofs.
Proof.
  intros.
  unfold lookup_union_offset in H.
  destruct (env.(coe_env) ! id) eqn:E1; try discriminate.
  destruct c.(co_su) eqn:E2; try discriminate.
  destruct (lookup_offset_sound env.(coe_env) env.(coe_offsets) ce_oe_match id i ofs H) as [c1 [H1 H2]].
  rewrite E1 in H1. inversion H1.
...
(*- E_COMPCERT_FTR_Function_Ctypes_mode_0_001 *)
(*- #Justify_Derived "Internal type used for distinguishing accesses" *)
Inductive mode: Type :=
...
(*- E_COMPCERT_FTR_Function_Ctypes_access_mode_001 *)
(*- #Justify_Derived "Helper function used to determine access modes" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_type_is_volatile_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TYPE_QUALIFIERS_006 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_alignof_blockcopy_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_MEM_ALIGNMENT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_REDUCTION_RVALUE_014 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_rank_type_001 *)
(*- #Justify_Derived "Helper function used for building the environment of compsites" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_rank_members_001 *)
(*- #Justify_Derived "Helper function used for building the environment of compsites" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_type_of_params_001 *)
(*- #Justify_Derived "Helper function used for extracting types from internal type" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_composite_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EABI_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SIZEOF_OPERATOR_003 *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_sizeof_composite_pos_001 *)
(*- #Justify_Derived "Helper lemma used for building the environment of composites" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_complete_members_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_002 *)
...
(** Optional struct alignment constraints pair [(sz,mal)].
    If the size of the struct is larger than [sz] we increase
    the alignment of the struct to at least to [2^mal]. If
    the alignment is already set via some attribute we ignore
    the minimal alignment. *)
(*- E_COMPCERT_FTR_Function_Ctypes_struct_alignment_constraint_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_012 *)
Parameter struct_alignment_constraint : option (Z * nat).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_min_alignment_two_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_012 *)
Definition min_alignment_two (su: struct_or_union) (sz: Z) :=
  match su, struct_alignment_constraint with
  | Struct, Some (l, al) => if Z.ltb l sz then Some al else None
  | _, _ => None
  end.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_align_attr_composite_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_012 *)
Definition align_attr_composite a su sz al :=
  let al := align_attr a al in
  match attr_alignas a with
  | Some a => al
  | None => match min_alignment_two su sz with
           | None => al
           | Some mal => Z.max (two_power_nat mal) al
           end
  end.
(*- #End *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_composite_of_def_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_COMPOUND_SPECIFIERS_002 *)
Program Definition composite_of_def
  ...
  | None, true =>
      let sz_ua := sizeof_composite env su m in
      let al := align_attr_composite a su sz_ua (alignof_composite env m) in
      OK {| co_su := su;
            co_members := m;
            co_attr := a;
            co_sizeof := align sz_ua al;
            co_alignof := al;
...
Next Obligation.
  ...
  apply align_le. unfold align_attr_composite.
  destruct (attr_alignas a); try apply alignof_composite_pos.
  destruct (min_alignment_two su (sizeof_composite env su m)); try apply alignof_composite_pos.
  apply Z.max_case.  apply two_power_nat_pos. apply alignof_composite_pos.
Defined.
Next Obligation.
  unfold align_attr_composite. destruct (attr_alignas).
  apply align_attr_two_p. apply alignof_composite_two_p.
  destruct (min_alignment_two su (sizeof_composite env su m)).
  apply Z.max_case; eauto. apply align_attr_two_p. apply alignof_composite_two_p.
  apply align_attr_two_p. apply alignof_composite_two_p.
Defined.
Next Obligation.
  apply align_divides.
  unfold align_attr_composite.
  destruct (attr_alignas a); try apply alignof_composite_pos.
  destruct (min_alignment_two su (sizeof_composite env su m)); try apply alignof_composite_pos.
  apply Z.max_case.  apply two_power_nat_pos. apply alignof_composite_pos.
Defined.
...
(*- E_COMPCERT_FTR_Function_Ctypes_add_composite_definitions_001 *)
(*- #Justify_Derived "Function to add a composite to the internal environment of composites" *)
...
(*- E_COMPCERT_FTR_Function_Ctypes_build_composite_env_001 *)
(*- #Justify_Derived "Function to build an environment of composites" *)
...
Record composite_consistent (env: composite_env) (co: composite) : Prop := {
  ...
  co_consistent_alignof:
     co_alignof co = align_attr_composite (co_attr co) (co_su co)
                       (sizeof_composite env (co_su co) (co_members co))
                       (alignof_composite env (co_members co));
...
Proof.
  ...
  symmetry; rewrite B. f_equal. apply sizeof_composite_stable; auto.
...
(*- E_COMPCERT_FTR_Function_Ctypes_fundef_0_001 *)
(*- #Justify_Derived "Internal type for functions in Csem Semantic" *)
...
- precomputed offsets for all the structs and unions in the environment
- a proof that these precomputed offsets are consistent with the environment. *)

(*- E_COMPCERT_FTR_Function_Ctypes_program_0_001 *)
(*- #Justify_Derived "Internal type for programs in Csem Semantic" *)
Record program : Type := {
  ...
  prog_offsets: offset_env;
  prog_offsets_eq : precompute_offsets prog_comp_env = prog_offsets
}.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Ctypes_program_of_program_001 *)
(*- #Justify_Derived "Internal conversion function for internal types" *)
...
Definition composite_offsets_of_program (p: program) : composite_offset_env :=
  {|
    coe_env := p.(prog_comp_env);
    coe_offsets := p.(prog_offsets);
  |}.
...
Program Definition make_program (types: list composite_definition)
  ...
  | OK ce =>
    OK {| prog_defs := defs;
      ...
      prog_comp_env := ce;
      prog_comp_env_eq := _;
      prog_offsets := precompute_offsets ce;
      prog_offsets_eq := _;
    |}
  end.
      ...
      | inleft (exist typs EQ) =>
          ...
          | exist env (conj P Q) => Some (
            {| 
              ...
              prog_comp_env := env;
              prog_comp_env_eq := P;
              prog_offsets := precompute_offsets env;
              prog_offsets_eq := eq_refl;
            |}
          )      
          end
      end
