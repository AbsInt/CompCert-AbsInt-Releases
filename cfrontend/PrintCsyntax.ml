...
(*- E_COMPCERT_CODE_PrintCSyntax_name_unop_001 *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_binop_001 *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_inttype_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_floattype_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_longtype_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_attributes_001 *)
(*- #Justify_Derived "Utility function" *)
let attributes a =
...
(*- E_COMPCERT_CODE_PrintCSyntax_attributes_space_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_optid_001 *)
(*- #Justify_Derived "Utility function" *)
let name_optid id =
  if id = "" then "" else " " ^ id
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_name_cdecl_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_type_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_associativity_001 *)
(*- #Justify_Derived "Type definition" *)
type associativity = LtoR | RtoL | NA
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_precedence_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_pointer_hook_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_typed_value_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_value_001 *)
(*- #Justify_Derived "Utility function" *)
let print_value p v = print_typed_value p v Tvoid
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_expr_001 *)
(*- #Justify_Derived "Utility function" *)
let rec expr p (prec, e) =
  ...
  | Ebuiltin(EF_memcpy(sz, al), _, args, _) ->
      fprintf p "__builtin_memcpy_aligned@[<hov 1>(%Ld,@ %Ld,@ %a)@]"
                (camlint64_of_ptrofs sz) (camlint64_of_ptrofs al)
                exprlist (true, args)
...
(*- E_COMPCERT_CODE_PrintCSyntax_exprlist_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_extended_asm_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_expr_001 *)
(*- #Justify_Derived "Utility function" *)
let print_expr p e = expr p (0, e)
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_print_exprlist_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_stmt_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_cases_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_case_label_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_stmt_for_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_name_function_parameters_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_function_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_fundef_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_fundecl_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_string_of_init_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_chop_last_nul_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_init_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_composite_init_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_re_string_literal_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_string_literal = Str.regexp "__stringlit_[0-9]+"
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_print_globvar_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_globvardecl_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_globdecl_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_globdef_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_struct_or_union_001 *)
(*- #Justify_Derived "Utility function" *)
let struct_or_union = function Struct -> "struct" | Union -> "union"
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_declare_composite_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_define_composite_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_print_program_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_PrintCSyntax_destination_001 *)
(*- #Justify_Derived "Variable for global state" *)
let destination : string option ref = ref None
(*- #End *)

(*- E_COMPCERT_CODE_PrintCSyntax_print_if_001 *)
