...
(*- E_COMPCERT_CODE_Transform_temporaries_001 *)
(*- #Justify_Derived "Variable for local state" *)
let temporaries = ref ([]: decl list)
(*- #End *)

(*- E_COMPCERT_CODE_Transform_reset_temps_001 *)
(*- #Justify_Derived "Utility function" *)
let reset_temps () =
  temporaries := []
(*- #End *)

(*- E_COMPCERT_CODE_Transform_get_temps_001 *)
(*- #Justify_Derived "Utility function" *)
let get_temps () =
...
(*- E_COMPCERT_CODE_Transform_new_temp_var_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_new_temp_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_attributes_to_remove_from_temp_001 *)
(*- #Justify_Derived "Utility function" *)
let attributes_to_remove_from_temp = add_attributes [AConst] [AVolatile]
(*- #End *)

(*- E_COMPCERT_CODE_Transform_mk_temp_001 *)
(*- #Justify_Derived "Utility function" *)
let mk_temp env ty =
...
(*- E_COMPCERT_CODE_Transform_invariant_lvalue_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_bind_lvalue_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_context_001 *)
...
(*- E_COMPCERT_CODE_Transform_op_for_assignop_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_op_for_incr_decr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_assignop_for_incr_decr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_expand_assign_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_expand_assignop_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_expand_preincrdecr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_expand_postincrdecr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_stmt_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_fundef_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Transform_program_001 *)
(*- #Justify_Derived "Utility function" *)
let program
