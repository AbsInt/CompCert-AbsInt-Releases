...
(*- E_COMPCERT_CODE_Cprint_print_idents_in_full_001 *)
(*- #Justify_Derived "Variables for global state" *)
let print_idents_in_full = ref false
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_print_debug_idents_001 *)
(*- #Justify_Derived "Variables for global state" *)
let print_debug_idents = ref false
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_print_line_numbers_001 *)
(*- #Justify_Derived "Variables for global state" *)
let print_line_numbers = ref false
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_location_001 *)
...
(*- E_COMPCERT_CODE_Cprint_ident_001 *)
(*- #Justify_Derived "Utility function" *)
let ident pp i =
...
(*- E_COMPCERT_CODE_Cprint_const_001 *)
(*- #Justify_Derived "Utility function" *)
let const pp = function
  ...
  | CFloat (FInfinity s, fk) ->
      fprintf pp "%sinf" (if s then "-" else "")
  | CFloat (FBits pl,fk) ->
      if fk = FFloat then begin
        (* For floats we only have 32 bits *)
        assert (Int64.of_int32 (Int64.to_int32 pl) = pl);
        fprintf pp "%f" (Int32.float_of_bits (Int64.to_int32 pl))
      end else
        fprintf pp "%f" (Int64.float_of_bits pl)
  | CStr s ->
      fprintf pp "\"";
...
(*- E_COMPCERT_CODE_Cprint_attr_arg_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_attribute_001 *)
...
(*- E_COMPCERT_CODE_Cprint_attributes_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_name_of_ikind_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_name_of_fkind_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_dcl_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_typ_001 *)
(*- #Justify_Derived "Utility function" *)
let typ pp ty =
  dcl pp ty (fun _ -> ())
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_typ_raw_001 *)
(*- #Justify_Derived "Utility function" *)
let typ_raw pp ty =
  dcl ~pp_indication:false pp ty (fun _ -> ())
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_associativity_001 *)
(*- #Justify_Derived "Type definition" *)
type associativity = LtoR | RtoL | NA
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_precedence_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_exp_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_init_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_simple_decl_001 *)
(*- #Justify_Derived "Utility function" *)
let simple_decl pp (id, ty) =
  dcl pp ty (fun pp -> fprintf pp " %a" ident id)
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_storage_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_full_decl_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_asm_operand_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_asm_operands_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cprint_asm_flags_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_exp_of_stmt_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_stmt_001 *)
(*- #Justify_Derived "Utility function" *)
let rec stmt pp s =
  location pp s.sloc;
  match s.sdesc with
...
(*- E_COMPCERT_CODE_Cprint_slabel_001 *)
(*- #Justify_Derived "Functional decomposition" *)
...
(*- E_COMPCERT_CODE_Cprint_stmt_block_001 *)
(*- #Justify_Derived "Utility function" *)
and stmt_block pp s =
  match s.sdesc with
  | Sblock [] -> ()
...
(*- E_COMPCERT_CODE_Cprint_opt_exp_001 *)
(*- #Justify_Derived "Utility function" *)
and opt_exp pp s =
...
(*- E_COMPCERT_CODE_Cprint_fundef_001 *)
(*- #Justify_Derived "Functional decomposition" *)
let fundef pp f =
...
(*- E_COMPCERT_CODE_Cprint_field_001 *)
(*- #Justify_Derived "Functional decomposition" *)
let field pp f =
...
(*- E_COMPCERT_CODE_Cprint_globdecl_001 *)
(*- #Justify_Derived "Utility function" *)
let globdecl pp g =
  location pp g.gloc;
  match g.gdesc with
...
(*- E_COMPCERT_CODE_Cprint_program_001 *)
(*- #Justify_Derived "Utility function" *)
let program pp prog =
  fprintf pp "@[<v 0>";
...
(*- E_COMPCERT_CODE_Cprint_destination_001 *)
(*- #Justify_Derived "Variables for global state" *)
let destination : string option ref = ref None
(*- #End *)

(*- E_COMPCERT_CODE_Cprint_print_if_001 *)
