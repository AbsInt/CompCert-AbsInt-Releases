...
(*- E_COMPCERT_CODE_Unblock_local_initializer_001 *)
(*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_003 *)
let rec local_initializer env path init k =
  ...
  | Init_array il ->
      let (ty_elt, sz) =
        ...
        | _ ->
          (*- #Link_to E_COMPCERT_TR_Robustness_UNBLOCK_006 *)
          Diagnostics.fatal_error Diagnostics.no_loc "wrong type for array initializer" in
...
(*- E_COMPCERT_CODE_Unblock_add_inits_stmt_001 *)
...
(*- E_COMPCERT_CODE_Unblock_local_variables_001 *)
(*- #Justify_Derived "Variable for local state" *)
let local_variables = ref ([]: decl list)
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_global_variables_001 *)
(*- #Justify_Derived "Variable for local state" *)
...
(*- E_COMPCERT_CODE_Unblock_remove_const_001 *)
(*- #Justify_Derived "Utility function" *)
...
let process_compound_literal islocal env ty init =
  ...
  if islocal then begin
    ...
    (*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_001 *)
    global_variables :=
...
(*- E_COMPCERT_CODE_Unblock_expand_expr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Unblock_expand_init_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Unblock_debug_fun_001 *)
(*- #Justify_Derived "Utility constant" *)
let debug_fun = ref None
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_debug_annot_001 *)
(*- #Justify_Derived "Utility function" *)
let debug_annot kind args =
  let (debug_id, debug_ty) = match !debug_fun with
    | None -> assert false
    | Some (id, ty) -> id, ty in
  { sloc = no_loc;
    sdesc = Sdo {
...
(*- E_COMPCERT_CODE_Unblock_string_const_001 *)
(*- #Justify_Derived "Utility function" *)
let string_const str =
  let c = CStr str in { edesc = EConst c; etyp = type_of_constant c }
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_integer_const_001 *)
(*- #Justify_Derived "Utility function" *)
let integer_const n =
  (* Check that the value is in range for type IInt *)
  assert (Int32.to_int (Int32.of_int n) = n);
...
(*- E_COMPCERT_CODE_Unblock_debug_lineno_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Unblock_empty_string_001 *)
(*- #Justify_Derived "Utility constant" *)
let empty_string = string_const ""
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_curr_fun_id_001 *)
(*- #Justify_Derived "Variable for local state" *)
let curr_fun_id = ref 0
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_debug_var_decl_001 *)
(*- #Justify_Derived "Utility function" *)
let debug_var_decl ctx id =
  Debug.add_lvar_scope !curr_fun_id id (List.hd ctx)
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_debug_scope_001 *)
(*- #Justify_Derived "Utility function" *)
let debug_scope ctx =
...
(*- E_COMPCERT_CODE_Unblock_add_lineno_001 *)
(*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_005 *)
...
(*- E_COMPCERT_CODE_Unblock_block_contains_decl_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Unblock_next_scope_id_001 *)
(*- #Justify_Derived "Variable for local state" *)
let next_scope_id = ref 0
(*- #End *)

(*- E_COMPCERT_CODE_Unblock_new_scope_id_001 *)
(*- #Justify_Derived "Utility function" *)
let new_scope_id () =
  incr next_scope_id;
  let id = !next_scope_id in
  assert (id >= 0);
  id
(*- #End *)
...
(*- E_COMPCERT_CODE_Unblock_process_decl_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Unblock_unblock_stmt_001 *)
...
(*- E_COMPCERT_CODE_Unblock_unblock_block_001 *)
(*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_005 *)
...
(*- E_COMPCERT_CODE_Unblock_unblock_fundef_001 *)
(*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_004 *)
...
(*- E_COMPCERT_CODE_Unblock_unblock_decl_001 *)
(*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_001 *)
...
(*- E_COMPCERT_CODE_Unblock_unblock_glob_001 *)
(*- #Link_to E_COMPCERT_TR_Function_UNBLOCK_001 *)
...
(*- E_COMPCERT_CODE_Unblock_programm_001 *)
(*- #Justify_Derived "Utility function" *)
let program p =
  next_scope_id := 0;
  let env = Env.initial () in
  let (debug_id, ident_info) = (Env.lookup_ident env "__builtin_debug") in
  let typ = match ident_info with
    | Env.II_ident (_, ty) -> ty
    | _ -> assert false in
  debug_fun := Some (debug_id, typ);
  unblock_glob env [] p
(*- #End *)
