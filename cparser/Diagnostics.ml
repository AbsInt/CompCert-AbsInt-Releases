...
(*- E_COMPCERT_CODE_Diagnostics_unknown_warning_001 *)
(*- #Justify_Derived "Utility function" *)
...
let warning_options =
  ...
  [Exact ("-Wfatal-errors"), Set error_fatal;
   Exact ("-fcolor-diagnostics"), Set color_diagnostics; (* Print color diagnostics *)
   Exact ("-fno-color-diagnostics"), Unset color_diagnostics; (* Disable color diagnostics *)
   Exact ("-fdiagnostics-color"), Set color_diagnostics; (* Print color diagnostics *)
   Exact ("-fno-diagnostics-color"), Unset color_diagnostics; (* Disable color diagnostics *)
...
let warning_help = {|Diagnostic options:
  ...
  -fcolor-diagnostics Turn on colored diagnostics
  -fno-color-diagnostics Turn off colored diagnostics
  -fdiagnostics-color Alias for -fcolor-diagnostics
  -fno-diagnostics-color Alias for -fno-color-diagnostics
