...
(*- E_COMPCERT_CODE_Cabshelper_isStatic_001 *)
...
(*- E_COMPCERT_CODE_Cabshelper_isExtern_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cabshelper_isInline_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cabshelper_isTypedef_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cabshelper_get_definitionloc_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cabshelper_get_statementloc_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Cabshelper_string_of_loc_001 *)
(*- #Justify_Derived "Utility function" *)
let string_of_loc l =
  Printf.sprintf "%s:%d" l.filename l.lineno
(*- #End *)

(*- E_COMPCERT_CODE_Cabshelper_format_loc_001 *)
(*- #Justify_Derived "Utility function" *)
let format_loc pp l =
