...
type struct_passing_style =
  ...
  | SP_int1to8                          (* by value, as either an int or a long long if size is <= 8 and
                                           by reference if it is larger.
                                           Note that the reference is classified as Param_unchanged in
                                           StructPassing.classify_param, i.e. if the struct is modified
                                           in the callee, first a copy is created. *)
(*- #End *)
...
type t = {
  ...
  wchar_ikind: C.ikind;
  size_t_ikind: C.ikind;
  ptrdiff_t_ikind: C.ikind;
  sizeof_intreg: int;
  alignof_ptr: int;
  alignof_short: int;
  alignof_int: int;
...
let il32pll64 = {
  ...
  sizeof_fun = None;
  wchar_ikind = IInt;
  size_t_ikind = IULongLong;
  ptrdiff_t_ikind = ILongLong;
  sizeof_intreg = 8;
  alignof_ptr = 8;
  alignof_short = 2;
  alignof_int = 4;
...
let deactivate_double conf =
  { conf with sizeof_double = conf.sizeof_float;
...
(*- E_COMPCERT_CODE_Machine_x86_002 *)
(*- #Justify_Derived "Utility constant" *)
let x86_32_macos =
...
(*- E_COMPCERT_CODE_Machine_x86_003 *)
(*- #Justify_Derived "Utility constant" *)
let x86_32_bsd =
  x86_32_macos
(*- #End *)

(*- E_COMPCERT_CODE_Machine_x86_004 *)
(*- #Justify_Derived "Utility constant" *)
let x86_64 =
...
(*- E_COMPCERT_CODE_Machine_x86_005 *)
(*- #Justify_Derived "Utility constant" *)
let win32 =
...
(*- E_COMPCERT_CODE_Machine_x86_006 *)
(*- #Justify_Derived "Utility constant" *)
let win64 =
...
let ppc_32_diab_bigendian =
  { ppc_32_bigendian with wchar_ikind = IUShort; }
(*- #End *)
...
(*- E_COMPCERT_CODE_Machine_arm_002 *)
(*- #Justify_Derived "Utility constant" *)
let arm_nodouble_littleendian = deactivate_double arm_littleendian
(*- #End *)

(*- E_COMPCERT_CODE_Machine_arm_003 *)
(*- #Justify_Derived "Utility constant" *)
let arm_bigendian =
...
(*- E_COMPCERT_CODE_Machine_arm_004 *)
(*- #Justify_Derived "Utility constant" *)
let arm_nodouble_bigendian = deactivate_double arm_bigendian
(*- #End *)
...
(*- E_COMPCERT_CODE_Machine_riscv_002 *)
(*- #Justify_Derived "Utility constant" *)
let rv64 =
...
(*- E_COMPCERT_CODE_Machine_aarch64_002 *)
(*- #Justify_Derived "Utility constant" *)
let aarch64_apple =
...
(*- E_COMPCERT_CODE_Machine_tricore_001 *)
(*- #Justify_Derived "Utility constant" *)
(* TODO verify struct passing/return style *)
let tricore =
  deactivate_double
    { ilp32ll64 with name = "tricore";
                     char_signed = true;
                     alignof_longlong = 4;
                     alignof_double = 4;
                     alignof_longdouble = 4;
                     struct_passing_style = SP_int1to8;
                     struct_return_style = SR_int1to8;
                     size_t_ikind = IULong;
                     ptrdiff_t_ikind = ILong;
    }
