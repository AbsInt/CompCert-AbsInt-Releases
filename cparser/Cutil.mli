...
val has_used_attribute : attributes -> bool
  (* Do the attributes contain the "used" attribute *)
val has_weak_attribute : attributes -> bool
(* Do the attributes contain the "weak" attribute *)
val has_noret_attribute : attributes -> bool
(* Do the attributes contain the "noreturn" attribute *)
val has_use_bol_attribute : attributes -> bool
(* Do the attributes contain the "use_bol" attribute *)
val has_no_use_bol_attribute : attributes -> bool
(* Do the attributes contain the "no_use_bol" attribute *)
val has_alias_attribute : attributes -> bool
(* Do the attributes contain the "alias" attribute *)
val get_alias_attribute : attributes -> string option
(* Get the alias target from the attribute if it is of the correct form *)
...
val sizeof : Env.t -> typ -> int64 option
...
val offsetof:
  Env.t -> typ -> field -> int64
(* Compute the offset of a struct member *)
val cautious_mul: int64 -> int64 -> int64 option
...
val find_flex_array_mem: Env.t -> ident -> string option
  (* Return the name of the flexible array member of a struct or [None]
     if the struct contains no flexible array member *)
