...
(* The [transf_asm] function in this module takes a full GCC-style
   ...
   CompCert, namely:
   - 0 or 1 output of kind "r" or architecture specific float kind
   - 0, 1 or several inputs of kind "r" or architecture specific float kind.
...
(*- E_COMPCERT_CODE_ExtendedAsm_StringMap_001 *)
(*- #Justify_Derived "Type definition" *)
module StringMap = Map.Make(String)
(*- #End *)

(*- E_COMPCERT_CODE_ExtendedAsm_name_of_label_001 *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_set_label_reg_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_set_label_regpair_001 *)
(*- #Link_to E_COMPCERT_TR_Function_EXTASM_004 *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_set_label_mem_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_set_label_const_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_is_reg_pair_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_re_valid_input_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_valid_input = Str.regexp "[a-zA-Z]+$"
(*- #End *)

(*- E_COMPCERT_CODE_ExtendedAsm_contains_float_cstr_001 *)
(*- #Justify_Derived "Utility function" *)
let contains_float_cstr cstr =
  match CBuiltins.asm_float_reg_cstr with
  | None -> false
  | Some c -> String.contains cstr c
(*- #End *)

(*- E_COMPCERT_CODE_ExtendedAsm_transf_inputs_001 *)
(*- #Link_to E_COMPCERT_TR_Function_EXTASM_002 *)
let rec transf_inputs loc env accu pos pos' subst = function
  ...
  | (lbl, cstr, e) :: inputs ->
      ...
      if valid && contains_float_cstr cstr then begin
        let float_cst = match CBuiltins.asm_float_reg_cstr with
          | Some c -> c
          | _ -> assert false (* Can never happen since contains_float_cstr is true *)
        in
        if not (Cutil.is_float_type env e.etyp) then
          (*- #Link_to E_COMPCERT_TR_Robustness_EXTASM_014 *)
          Diagnostics.error loc "constraint '%c' expects a floating-point expression" float_cst;
        transf_inputs loc env (e :: accu) (pos + 1) (pos' + 1)
                    (set_label_reg lbl pos pos' subst) inputs
      end else
      ...
      if valid && (String.contains cstr 'i'
        ...
        let n =
          ...
          | Some n -> n
          (*- #Link_to E_COMPCERT_TR_Robustness_EXTASM_009 *)
        ...
        (*- #Link_to E_COMPCERT_TR_Robustness_EXTASM_006 *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_re_valid_output_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_valid_output = Str.regexp "=[a-zA-Z]+$"
(*- #End *)

(*- E_COMPCERT_CODE_ExtendedAsm_transf_outputs_001 *)
(*- #Link_to E_COMPCERT_TR_Function_EXTASM_003 *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_check_clobbers_001 *)
let check_clobbers loc clob =
  List.iter
    (fun c ->
      ...
      then ()
      (*- #Link_to E_COMPCERT_TR_Robustness_EXTASM_010 *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_re_asm_placeholder_001 *)
(*- #Justify_Derived "Utility constant" *)
let re_asm_placeholder =
  Str.regexp "\\(%[QR]?\\([0-9]+\\|\\[[a-zA-Z_][a-zA-Z_0-9]*\\]\\)\\|%%\\)"
(*- #End *)

(*- E_COMPCERT_CODE_ExtendedAsm_rename_placeholders_001 *)
let rename_placeholders loc template subst =
  let rename p =
    if p = "%%" then p else
      ...
      with Not_found ->
        (*- #Link_to E_COMPCERT_TR_Robustness_EXTASM_011 *)
        (*- #Link_to E_COMPCERT_TR_Robustness_EXTASM_013 *)
...
(*- E_COMPCERT_CODE_ExtendedAsm_transf_asm_001 *)
(*- #Link_to E_COMPCERT_TR_Function_EXTASM_001 *)
