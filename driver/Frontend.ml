...
(*- E_COMPCERT_CODE_Frontend_predefined_macros_002 *)
(*- #Justify_Derived "Utility constant" *)
let re_version = Str.regexp {|\([0-9]+\)\.\([0-9]+\)|}
(*- #End *)

(*- E_COMPCERT_CODE_Frontend_predefined_macros_003 *)
(*- #Justify_Derived "Utility constant" *)
let (v_major, v_minor) =
...
(*- E_COMPCERT_CODE_Frontend_predefined_macros_004 *)
(*- #Justify_Derived "Utility constant" *)
let v_number =
  assert (v_minor < 100);
  100 * v_major + v_minor
...
(*- E_COMPCERT_CODE_Frontend_predefined_macros_001 *)
(*- #Link_to E_COMPCERT_TR_Function_PREPROCESSING_003 *)
...
(*- E_COMPCERT_CODE_Frontend_abi_macros_001 *)
(*- #Link_to E_COMPCERT_TR_Function_PREPROCESSING_003 *)
let abi_macros () =
  let wchar_typ = Cprint.name_of_ikind (Cutil.wchar_ikind())
  and size_t_typ = Cprint.name_of_ikind (Cutil.size_t_ikind ())
  and ptrdiff_t_typ = Cprint.name_of_ikind (Cutil.ptrdiff_t_ikind ()) in
  [
    sprintf "-D__COMPCERT_WCHAR_TYPE__=%s" wchar_typ;
    sprintf "-D__COMPCERT_SIZE_T_TYPE__=%s" size_t_typ;
    sprintf "-D__COMPCERT_PTRDIFF_T_TYPE__=%s" ptrdiff_t_typ;
  ]
(*- #End *)

(*- E_COMPCERT_CODE_Frontend_preprocess_001 *)
...
(*- E_COMPCERT_CODE_Frontend_parse_c_file_001 *)
let parse_c_file sourcename ifile =
  ...
  let ast =
    Parse.preprocessed_file
      ...
      (*- #Link_to E_COMPCERT_TR_Function_STRUCT_PASSING_001 *)
...
(*- E_COMPCERT_CODE_Frontend_init_001 *)
(*- #Justify_Derived "Utility function" *)
let init () =
  Machine.config:=
    begin match Configuration.arch with
    | "powerpc"     -> if Configuration.model = "e5500" || Configuration.model = "ppc64" then
                         if Configuration.abi = "linux" then Machine.ppc_32_r64_linux_bigendian
                         else if Configuration.gnu_toolchain then Machine.ppc_32_r64_bigendian
                         else Machine.ppc_32_r64_diab_bigendian
                       else
                         if Configuration.abi = "linux" then Machine.ppc_32_linux_bigendian
                         else if Configuration.gnu_toolchain then Machine.ppc_32_bigendian
                         else Machine.ppc_32_diab_bigendian
    | "powerpc_vle" -> if Configuration.gnu_toolchain then Machine.ppcvle_32_bigendian
                       else Machine.ppcvle_32_diab_bigendian
    | "arm"         -> if Configuration.is_big_endian
                       then if Configuration.has_double then Machine.arm_bigendian else Machine.arm_nodouble_bigendian
                       else if Configuration.has_double then Machine.arm_littleendian else Machine.arm_nodouble_littleendian
    ...
    | "peaktop" -> Machine.peaktop
    | "tricore" -> Machine.tricore
    | _         -> assert false
  end;
...
(*- E_COMPCERT_CODE_Frontend_gnu_prepro_opt_key_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Frontend_gnu_prepro_opt_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Frontend_gnu_prepro_opt_e_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Frontend_gnu_prepro_actions_001 *)
(*- #Link_to E_COMPCERT_TR_Function_PREPROCESSING_005 *)
...
(*- E_COMPCERT_CODE_Frontend_prepro_actions_001 *)
(*- #Link_to E_COMPCERT_TR_Function_PREPROCESSING_005 *)
(*- #Link_to E_COMPCERT_TR_Function_DRIVER_001 *)
let prepro_actions = [
...
(*- E_COMPCERT_CODE_Frontend_gnu_prepro_help_001 *)
(*- #Justify_Derived "Utility constant" *)
let gnu_prepro_help =
...
(*- E_COMPCERT_CODE_Frontend_prepro_help_001 *)
(*- #Justify_Derived "Utility constant" *)
