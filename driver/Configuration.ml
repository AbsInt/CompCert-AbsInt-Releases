...
let replace_ini_var vars =
  List.map (Str.global_substitute re_ini_var (fun _ -> ini_dir)) vars
(*- #End *)
...
let arch =
  ...
  | "powerpc"|"powerpc_vle"|"arm"|"x86"|"riscV"|"aarch64"|"peaktop"|"tricore" as a -> a
  | v -> bad_config "arch" [v]
(*- #End *)
...
(*- E_COMPCERT_CODE_Configuration_pic_supported_001 *)
(*- #Justify_Derived "Configuration constant" *)
...
(*- E_COMPCERT_CODE_Configuration_has_double_001 *)
(*- #Justify_Derived "Configuration constant" *)
let has_double = get_bool_config "has_double"
(*- #End *)

(*- E_COMPCERT_CODE_Configuration_alias_supported_001 *)
(*- #Justify_Derived "Configuration constant" *)
let alias_supported = elf_target && gnu_toolchain
(*- #End *)
