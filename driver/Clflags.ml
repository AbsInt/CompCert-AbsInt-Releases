...
(*- E_COMPCERT_CODE_Cflags_options_001 *)
...
let option_midiv = ref false
let option_muse_bol = ref true
let option_mzicond = ref false
...
let option_small_data =
  ref (if (Configuration.arch = "powerpc" || Configuration.arch = "powerpc_vle")
...
let option_inline_runtime = ref false
