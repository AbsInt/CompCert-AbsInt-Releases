...
Proof.
  ...
  destruct (Allocation.transf_program p17) as [p18|e] eqn:P18; simpl in T; try discriminate.
  set (p19 := Tunneling.tunnel_program p18) in *.
  destruct (Linearize.transf_program p19) as [p20|e] eqn:P20; simpl in T; try discriminate.
  set (p21 := CleanupLabels.transf_program p20) in *.
  destruct (partial_if debug Debugvar.transf_program p21) as [p22|e] eqn:P22; simpl in T; try discriminate.
  destruct (Stacking.transf_program p22) as [p23|e] eqn:P23; simpl in T; try discriminate.
  ...
  exists p18; split. apply Allocproof.transf_program_match; auto.
  exists p19; split. apply Tunnelingproof.transf_program_match.
  exists p20; split. apply Linearizeproof.transf_program_match; auto.
  exists p21; split. apply CleanupLabelsproof.transf_program_match; auto.
  exists p22; split. eapply partial_if_match; eauto. apply Debugvarproof.transf_program_match.
  exists p23; split. apply Stackingproof.transf_program_match; auto.
