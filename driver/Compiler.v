...
Require Renumber.
Require Constprop.
Require BaseExtraction.
Require CSE.
Require Deadcode.
Require BaseMerge.
Require Unusedglob.
Require PointerCasts.
Require RTLtyping.
Require SimplPCasts.
Require Allocation.
Require Tunneling.
...
Require BaseExtractionproof.
Require CSEproof.
Require Deadcodeproof.
Require BaseMergeproof.
Require Unusedglobproof.
Require PointerCastsproof.
Require SimplPCastsproof.
Require Allocproof.
...
Parameter print_typedRTL: Z -> RTLtyping.program -> unit.
...
Definition transf_rtl_program (f: RTL.program) : res Asm.program :=
  ...
  @@@ time "Inlining" Inlining.transf_program
   ...
   @@ print (print_RTL 5)
   @@ total_if Compopts.optim_extractaddr (time "BaseExtraction" BaseExtraction.transf_program)
   @@ print (print_RTL 6)
   @@ total_if Compopts.optim_extractaddr (time "Renumbering" Renumber.transf_program)
   @@ print (print_RTL 7)
  @@@ partial_if Compopts.optim_CSE (time "CSE" CSE.transf_program)
   @@ print (print_RTL 8)
  @@@ partial_if Compopts.optim_redundancy (time "Redundancy elimination" Deadcode.transf_program)
   @@ print (print_RTL 9)
  @@ total_if Compopts.optim_extractaddr (time "BaseMerge" BaseMerge.transf_program)
   @@ print (print_RTL 10)
  @@@ time "Unused globals" Unusedglob.transform_program
   @@ print (print_RTL 11)
   @@ time "Pointer casts" PointerCasts.transf_program
   @@ print (print_RTL 12)
   @@ time "Renumbering again" Renumber.transf_program
   @@ print (print_RTL 13)
  @@@ time "RTL typing" RTLtyping.type_program
   @@ print (print_typedRTL 14)
   @@ time "Pointer cast simplification" SimplPCasts.transf_program
   @@ print (print_typedRTL 15)
...
Definition CompCert's_passes :=
  ...
  ::: mkpass (match_if Compopts.optim_extractaddr BaseExtractionproof.match_prog)
  ::: mkpass (match_if Compopts.optim_extractaddr Renumberproof.match_prog)
  ::: mkpass (match_if Compopts.optim_CSE CSEproof.match_prog)
  ::: mkpass (match_if Compopts.optim_redundancy Deadcodeproof.match_prog)
  ::: mkpass (match_if Compopts.optim_extractaddr BaseMergeproof.match_prog)
  ::: mkpass Unusedglobproof.match_prog
  ::: mkpass PointerCastsproof.match_prog
  ::: mkpass Renumberproof.match_prog
  ::: mkpass RTLtyping.match_prog
  ::: mkpass SimplPCastsproof.match_prog
...
Proof.
  ...
  set (p12 := total_if optim_extractaddr BaseExtraction.transf_program p11) in *.
  set (p13 := total_if optim_extractaddr Renumber.transf_program p12) in *.
  destruct (partial_if optim_CSE CSE.transf_program p13) as [p14|e] eqn:P14; simpl in T; try discriminate.
  destruct (partial_if optim_redundancy Deadcode.transf_program p14) as [p15|e] eqn:P15; simpl in T; try discriminate.
  set (p16 := total_if optim_extractaddr BaseMerge.transf_program p15) in *.
  destruct (Unusedglob.transform_program p16) as [p17|e] eqn:P17; simpl in T; try discriminate.
  set (p18 := (PointerCasts.transf_program p17)) in *.
  set (p19 := (Renumber.transf_program p18)) in *.
  destruct (RTLtyping.type_program p19) as [p20|e] eqn:P20; simpl in T; try discriminate.
  set (p21 := (SimplPCasts.transf_program p20)) in *.
  destruct (Allocation.transf_program p21) as [p22|e] eqn:P22; simpl in T; try discriminate.
  set (p23 := Tunneling.tunnel_program p22) in *.
  destruct (Linearize.transf_program p23) as [p24|e] eqn:P24; simpl in T; try discriminate.
  set (p25 := CleanupLabels.transf_program p24) in *.
  destruct (partial_if debug Debugvar.transf_program p25) as [p26|e] eqn:P26; simpl in T; try discriminate.
  destruct (Stacking.transf_program p26) as [p27|e] eqn:P28; simpl in T; try discriminate.
  ...
  exists p12; split. apply total_if_match. apply BaseExtractionproof.transf_program_match.
  exists p13; split. apply total_if_match. apply Renumberproof.transf_program_match.
  exists p14; split. eapply partial_if_match; eauto. apply CSEproof.transf_program_match.
  exists p15; split. eapply partial_if_match; eauto. apply Deadcodeproof.transf_program_match.
  exists p16; split. apply total_if_match. apply BaseMergeproof.transf_program_match.
  exists p17; split. apply Unusedglobproof.transf_program_match; auto.
  exists p18; split. eapply PointerCastsproof.transf_program_match.
  exists p19; split. eapply Renumberproof.transf_program_match; auto. 
  exists p20; split. eapply RTLtyping.type_program_match; auto.
  exists p21. split. eapply SimplPCastsproof.transf_program_match; auto.
  exists p22; split. apply Allocproof.transf_program_match; auto.
  exists p23; split. apply Tunnelingproof.transf_program_match.
  exists p24; split. apply Linearizeproof.transf_program_match; auto.
  exists p25; split. apply CleanupLabelsproof.transf_program_match; auto.
  exists p26; split. eapply partial_if_match; eauto. apply Debugvarproof.transf_program_match.
  exists p27; split. apply Stackingproof.transf_program_match; auto.
...
Ltac DestructM :=
  ...
  eapply compose_forward_simulations.
    eapply match_if_simulation. eassumption. exact BaseExtractionproof.transf_program_correct.
  eapply compose_forward_simulations.
    eapply match_if_simulation. eassumption. exact Renumberproof.transf_program_correct.
  eapply compose_forward_simulations.
  ...
  eapply compose_forward_simulations.
    eapply match_if_simulation. eassumption. exact BaseMergeproof.transf_program_correct.
  eapply compose_forward_simulations.
    eapply Unusedglobproof.transf_program_correct; eassumption.
  eapply compose_forward_simulations.
  eapply PointerCastsproof.transf_program_correct; eassumption.
   eapply compose_forward_simulations. eapply Renumberproof.transf_program_correct; eassumption.
    eapply compose_forward_simulations.
    eapply RTLtyping.transf_program_correct; eassumption.
  eapply compose_forward_simulations.
    eapply SimplPCastsproof.transf_program_correct; eassumption.
  eapply compose_forward_simulations.
