...
val loc_of_error : string -> Errors.errcode list -> (string * int)
    (** Checks whether the error message is attached to a source-level
        identifer and returns it or the file location otherwise *)
