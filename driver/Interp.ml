...
(*- E_COMPCERT_DEACTIVATED_CODE_Interp_001 *)
(*- #Condition "CompCert is launched in interpreter mode" *)
(*- #Justification "Code is unreachable for for nomnale use of CompCert as a compiler." *)

(* Configuration *)

(*- E_COMPCERT_CODE_Interp_trace_001 *)
(*- #Justify_Derived "Variable for global state" *)
let trace = ref 1   (* 0 if quiet, 1 if normally verbose, 2 if full trace *)
(*- #End *)

(*- E_COMPCERT_CODE_Interp_type_mode_001 *)
(*- #Justify_Derived "Type definition" *)
type mode = First | Random | All
(*- #End *)

(*- E_COMPCERT_CODE_Interp_mode_001 *)
(*- #Justify_Derived "Variable for global state" *)
let mode = ref First
(*- #End *)
...
(*- E_COMPCERT_CODE_Interp_print_id_ofs_001 *)
...
(*- E_COMPCERT_CODE_Interp_print_eventval_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_print_eventval_list_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_print_event_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_name_of_fundef_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_name_of_function_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_invert_local_variable_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_print_pointer_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_print_val_001 *)
(*- #Justify_Derived "Utility function" *)
let print_val = PrintCsyntax.print_value
(*- #End *)

(*- E_COMPCERT_CODE_Interp_print_val_list_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_print_state_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_compare_mem_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_some_expr_001 *)
(*- #Justify_Derived "Utility constant" *)
let some_expr = Eval(Vint Int.zero, Tvoid)
(*- #End *)

(*- E_COMPCERT_CODE_Interp_rank_cont_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_compare_cont_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_rank_state_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_mem_state_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_compare_state_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_extract_string_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_re_conversion_001 *)
(*- #Justify_Derived "Utility constant" *)
...
(*- E_COMPCERT_CODE_Interp_format_float_001 *)
(*- #Justify_Derived "Utility function" *)
external format_float: string -> float -> string
  = "caml_format_float"
(*- #End *)

(*- E_COMPCERT_CODE_Interp_format_int32_001 *)
(*- #Justify_Derived "Utility function" *)
external format_int32: string -> int32 -> string
  = "caml_int32_format"
(*- #End *)

(*- E_COMPCERT_CODE_Interp_format_int64_001 *)
(*- #Justify_Derived "Utility function" *)
external format_int64: string -> int64 -> string
  = "caml_int64_format"
(*- #End *)

(*- E_COMPCERT_CODE_Interp_format_value_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_do_printf_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_monadic_bind_on_optional_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_convert_external_arg_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_convert_external_args_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_do_external_function_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_do_inline_assembly_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_world_001 *)
(*- #Justify_Derived "Utility function" *)
let rec world ge m =
  lazy (Determinism.World(world_io ge m, world_vload ge m, world_vstore ge m))
(*- #End *)

(*- E_COMPCERT_CODE_Interp_world_io_001 *)
(*- #Justify_Derived "Utility function" *)
and world_io ge m id args =
  None
(*- #End *)

(*- E_COMPCERT_CODE_Interp_world_vload_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_world_vstore_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_do_event_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_do_events_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_strict_nboolean_or_001 *)
(*- #Justify_Derived "Utility function" *)
let (|||) a b = a || b (* strict boolean or *)
(*- #End *)

(*- E_COMPCERT_CODE_Interp_diagnose_stuck_expr_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_diagnose_stuck_state_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_do_step_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_explore_one_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_explore_all_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_world_program_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_change_main_function_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_call_other_main_function_001 *)
(*- #Justify_Derived "Utility function" *)
let call_other_main_function main_id main_ty main_ty_res =
  let main_var = Evalof(Evar(main_id, main_ty), main_ty) in
  let body =
    Ssequence(Sdo(Ecall(main_var, Enil, main_ty_res)),
              Sreturn(Some(Eval(Vint _0l, type_int32s)))) in
  { fn_return = type_int32s; fn_callconv = cc_default;
    fn_params = []; fn_vars = []; fn_body = body }
(*- #End *)

(*- E_COMPCERT_CODE_Interp_find_main_function_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_Interp_fixup_main_001 *)
(*- #Justify_Derived "Utility function" *)
let fixup_main p =
...
(*- E_COMPCERT_CODE_Interp_execute_001 *)
(*- #Justify_Derived "Utility function" *)
let execute prog =
  Random.self_init();
