...
(** Flag -fconst-prop.  For constant propagation. *)
Parameter optim_constprop: unit -> bool.

(** Flag -fextract-addr. For extraction of addresses from load/store. *)
Parameter optim_extractaddr: unit -> bool.
...
(** Whether the architecture supports double *)
Parameter supports_double : bool.

(** Whether the runtime library should be inlined *)
Parameter inlined_runtime: unit -> bool.
