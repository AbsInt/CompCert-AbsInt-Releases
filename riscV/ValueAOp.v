...
Definition eval_static_operation (op: operation) (vl: list aval): aval :=
  ...
  | Osel ty, v1::v2::v3::nil => select_bool v1 v2 v3 ty
  | Oczero_eq, c::v::nil =>  select (eval_static_condition (Ccompimm Ceq Int.zero) (c :: nil)) (I Int.zero) v Tint
  | Oczero_ne, c::v::nil => select (eval_static_condition (Ccompimm Cne Int.zero) (c :: nil)) (I Int.zero) v Tint
  | _, _ => Vbot
  end.
...
Proof.
  ...
  apply select_bool_sound; eauto.
  apply select_sound; eauto with va. simpl.
  eapply cmp_bool_sound; eauto. constructor. constructor.
  apply select_sound; eauto with va. simpl.
  eapply cmp_bool_sound; eauto. constructor. constructor.
Qed.
