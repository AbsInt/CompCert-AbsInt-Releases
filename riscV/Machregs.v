...
Definition mregs_for_operation (op: operation): list (option (rpair mreg)) * option (rpair mreg) := (nil, None).
...
Definition builtin_constraints (ef: external_function) :
  ...
  match ef with
  | EF_builtin id sg =>
      if string_dec id "__builtin_csr_read" then OK_const :: nil
      else if string_dec id "__builtin_csr_write" then OK_const :: OK_const :: nil
      else if string_dec id "__builtin_csr_readwrite" then OK_const :: OK_const :: nil
      else if string_dec id "__builtin_csr_clear_bits" then OK_const :: OK_const :: nil
      else if string_dec id "__builtin_csr_set_bits" then OK_const :: OK_const :: nil
      else nil
