...
Module CC.
  Definition reg_cc (r: mreg): RegCC :=
    ...
    | R5 | R6 | R7 => RCCaller
    | R8 | R9 => RCCallee
    | R10 | R11 | R12 | R13 | R14 | R15 | R16 | R17 => RCCaller
    | R18 | R19 | R20 | R21 | R22 | R23 | R24 | R25 | R26 | R27 => RCCallee
    | R28 | R29 | R30 => RCCaller
    | F0 | F1 | F2 | F3 | F4 | F5 | F6 | F7 => RCCaller
    | F8 | F9 => RCCallee
    | F10 | F11 | F12 | F13 | F14 | F15 | F16 | F17 => RCCaller
    | F18 | F19 | F20 | F21 | F22 | F23 | F24 | F25 | F26 | F27 => RCCallee
    | F28 | F29 | F30 | F31 => RCCaller
    end.
End CC.
...
Definition dummy_regs := R6 :: F0 :: nil. (**r Used in [Coloring]. *)
...
Definition allocatable_registers (_: unit) :=
  {| preferred_regs := (R10 :: R11 :: R12 :: R13 :: R14 :: R15 :: nil) :: float_caller_save_regs :: nil :: nil;
     remaining_regs := (R5  :: R6  :: R7  :: R16 :: R17 :: R28 :: R29 :: R30 :: int_callee_save_regs) :: float_callee_save_regs :: nil :: nil|}.
...
Definition loc_result (s: signature) : rpair mreg :=
  ...
  | Tlong => if Archi.ptr64 then One R10 else Two R11 R10
  end.
...
Proof.
  ...
  destruct (proj_sig_res sig); simpl; auto; destruct Archi.ptr64 eqn:E; auto.
  simpl. destruct Archi.ptr64 eqn:E'; auto.
Qed.
...
Definition split_long_arg (va: bool) (ri rf ofs: Z)
  ...
  | Some r1, Some r2 =>
      Two (R r2) (R r1) :: rec (ri + 2) rf ofs
  | Some r1, None =>
      Two (S Outgoing ofs Tint) (R r1) :: rec (ri + 1) rf (ofs + 1)
  | None, _ =>
...
Proof.
  ...
  assert (CSI: forall r, In r int_param_regs -> is_caller_save r = true).
  { decide_goal. }
  assert (CSF: forall r, In r float_param_regs -> is_caller_save r = true).
  { decide_goal. }
  assert (CSFX: forall r, In r float_extra_param_regs -> is_caller_save r = true).
  { decide_goal. }
