...
(*- E_COMPCERT_CODE_Switchaux_001 *)
(*- #Justify_Derived "Module Switchaux.ml is helper code for the linearization of switch statements. Computed results are later checked by a formally verified validator." *)
