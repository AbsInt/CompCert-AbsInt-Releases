...
(*- E_COMPCERT_CODE_PrintAST_name_of_type_001 *)
...
(*- E_COMPCERT_CODE_PrintAST_name_of_ptype_001 *)
(*- #Justify_Derived "Utility function" *)
let name_of_ptype = function
  | Pptr -> "ptr"
  | Ptyp t -> name_of_type t
(*- #End *)

(*- E_COMPCERT_CODE_PrintAST_name_of_xtype_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintAST_name_of_chunk_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintAST_name_of_external_001 *)
(*- #Justify_Derived "Utility function" *)
let name_of_external = function
  ...
  | EF_free -> "free"
  | EF_memcpy(sz, al) ->
      sprintf "memcpy size %Ld align %Ld " (camlint64_of_ptrofs sz) (camlint64_of_ptrofs al)
...
(*- E_COMPCERT_CODE_PrintAST_print_builtin_arg_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintAST_print_builtin_args_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintAST_print_builtin_res_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_CODE_PrintAST_print_rpair_001 *)
(*- #Justify_Derived "Utility function" *)
