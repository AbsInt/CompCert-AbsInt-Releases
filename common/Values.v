...
Definition has_rettype_list : list val -> list xtype -> Prop := list_forall2 has_rettype.

Lemma has_proj_xtype_typ: forall v t,
  has_rettype v t -> has_type v (proj_xtype_typ t).
Proof.
...
(*- E_COMPCERT_FTR_Function_Values_Val_has_inj_typ_xtype_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma has_inj_typ_xtype: forall v t,
  has_type v t -> has_rettype v (inj_typ_xtype t).
Proof.
...
(** Matching values to ptype. *)
Definition has_ptype (v: val) (ty: ptype) := Val.has_type v (proj_ptype_typ ty).
Definition has_ptype_list (vl: list val) (tyl: list ptype) := Val.has_type_list vl (map proj_ptype_typ tyl).

Lemma has_ptype_def:
  forall v ty, 
  has_ptype v ty -> Val.has_type v (proj_ptype_typ ty).
Proof.
  intros. apply H.
Qed.

Lemma has_ptype_list_def:
  forall vl tyl, 
  has_ptype_list vl tyl -> Val.has_type_list vl (map proj_ptype_typ tyl).
Proof.
  intros. apply H.
Qed.

Global Hint Resolve has_ptype_def has_ptype_list_def : core.

Lemma has_ptype_sub:
  forall ty1 ty2 v,
  subptype ty1 ty2 -> has_ptype v ty1 -> has_ptype v ty2.
Proof.
  intros. unfold has_ptype in *.
  eapply has_subtype.
  apply subptype_to_subtype; eassumption.
  apply H0.
Qed.

Lemma has_ptype_sub':
  forall ty1 ty2 v,
  subptype ty1 (high_bound ty2) -> has_ptype v ty1 -> has_ptype v ty2.
Proof.
  intros. unfold has_ptype in *.
  eapply has_subtype.
  apply subptype_to_subtype'; eassumption.
...
Lemma has_ptype_sub_list:
  forall tyl1 tyl2 vl,
  list_forall2 subptype tyl1 tyl2 -> has_ptype_list vl tyl1 -> has_ptype_list vl tyl2.
Proof.
  induction tyl1; destruct tyl2, vl; intros; inv H; inv H0.
  - constructor. 
  - cbn. split.
    + eapply has_ptype_sub; eauto with ty.
    + apply IHtyl1; eassumption.
Qed.

Lemma has_ptype_sub_list':
  forall tyl1 tyl2 vl,
  list_forall2 subptype tyl1 (map high_bound tyl2) -> has_ptype_list vl tyl1 -> has_ptype_list vl tyl2.
Proof.
  induction tyl1; destruct tyl2, vl; intros; inv H; inv H0.
  - constructor. 
  - cbn. split.
...
Definition pcast (v:val): val :=
  match v with
  | Vint _ | Vundef | Vptr _ _ => v
  | _ => Vundef
  end.    

(** Arithmetic operations *)

(*- E_COMPCERT_FTR_Function_Values_Val_neg_001 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_intofsingle_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_intuofsingle_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_singleofint_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_singleofintu_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_is_bool_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition is_bool (v: val) : bool := eq v Vtrue || eq v Vfalse.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Values_Val_norm_bool_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_sub_overflow_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
Definition sub_borrow (v1 v2 cin: val) : val :=
  match v1, v2, cin with
  | Vint n1, Vint n2, Vint c => Vint(Int.sub_borrow n1 n2 c)
  | _, _, _ => Vundef
  end.

(*- E_COMPCERT_FTR_Function_Values_Val_negative_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_ror_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_bitsoffloat_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition bitsoffloat (v1: val) : val :=
  match v1 with
...
(*- E_COMPCERT_FTR_Function_Values_Val_floatofsingles_001 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_lowordoffloat_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_hiwordoffloat_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_lowordoflong_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
(*- E_COMPCERT_FTR_Function_Values_Val_hiwordoflong_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
Definition mulls' (v1 v2: val) : val :=
  match v1, v2 with
  | Vint n1, Vint n2 => Vlong (Int64.muls' n1 n2)
  | _, _ => Vundef
  end.
...
(*- E_COMPCERT_FTR_Function_Values_Val_combine_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_005 *)
...
Definition to_optbool (b : val) : option bool :=
  match b with
  | Vint i => if Int.eq i Int.one then Some true
             else if Int.eq i Int.zero then Some false
             else None
  | _ => None
  end.

Lemma to_optbool_of_optbool:
  forall b, to_optbool (of_optbool b) = b.
Proof.
  intros. destruct b; auto. simpl. destruct b; auto.
Qed.
...
(*- #Link_to E_COMPCERT_TOR_Function_BUILTIN_SEL_001 *)
...
Definition select_bool (c v1 v2: val) (ty : typ) :=
  select (to_optbool c) v1 v2 ty.
...
Proof.
  intros. rewrite <- proj_xtype_typ_of_chunk. apply has_proj_xtype_typ.
...
Theorem sign_ext_shr_shl:
  forall x y,
  Int.ltu Int.zero y && Int.ltu y Int.iwordsize = true ->
  let sa := Int.sub Int.iwordsize y in
  Val.shr (Val.shl x (Vint sa)) (Vint sa) =
    Val.sign_ext (Int.unsigned y) x.
Proof.
  intros. destruct x; auto. simpl.
  unfold sa, Int.sub, Int.ltu in *.
  rewrite Int.unsigned_zero in *.
  change (Int.unsigned Int.iwordsize) with Int.zwordsize in *.
  destruct (zlt 0 (Int.unsigned y)); inv H.
  destruct (zlt (Int.unsigned y) Int.zwordsize); inv H1.
  assert (Int.zwordsize < Int.max_unsigned) by (compute; auto).
  rewrite Int.unsigned_repr by lia. rewrite zlt_true by lia.
  unfold shr. unfold Int.ltu.
  change (Int.unsigned Int.iwordsize) with Int.zwordsize in *.
  rewrite Int.unsigned_repr by lia. rewrite zlt_true by lia.
 f_equal. symmetry. apply Int.sign_ext_shr_shl. lia.
Qed.
...
Lemma shl_zero v n: v = Vint n ->  Val.shl v (Vint Int.zero) = v.
Proof.
  unfold Val.shl. intros eq; subst. rewrite Int.shl_zero.
...
Theorem loword_addl:
  forall x y, lowordoflong (addl x y) = add (lowordoflong x) (lowordoflong y).
Proof.
  intros. destruct x, y; simpl; try (destruct Archi.ptr64; auto; fail); auto.
  rewrite <- (Int64.ofwords_recompose i), <- (Int64.ofwords_recompose i0) at 1.
  rewrite Int64.decompose_add. rewrite Int64.lo_ofwords. auto.
Qed.
...
Theorem loword_negl:
  forall x, lowordoflong (negl x) = neg (lowordoflong x).
Proof.
  unfold negl; intros. destruct x; auto. simpl.
  rewrite <- (Int64.ofwords_recompose i) at 1. rewrite Int64.decompose_neg.
...
Theorem loword_subl:
  forall x y,
    Archi.ptr64 = false ->
    lowordoflong (subl x y) = sub (lowordoflong x) (lowordoflong y).
Proof.
  intros. unfold subl. destruct x, y; try rewrite H; auto. simpl.
  rewrite <- (Int64.ofwords_recompose i), <- (Int64.ofwords_recompose i0) at 1.
  rewrite Int64.decompose_sub. rewrite Int64.lo_ofwords. auto.
Qed.
...
Theorem cmp_bool_le_lt:
  forall x i,
 Int.signed i < Int.max_signed ->
 cmp_bool Cle x (Vint i) = cmp_bool Clt x (Vint (Int.add i Int.one)).
Proof.
  intros. destruct x;  auto. simpl. rewrite Int.le_lt; auto.
  unfold Int.zwordsize; simpl; lia.
Qed.

Theorem cmpu_bool_le_lt:
  forall valid_ptr x i,
  Int.unsigned i < Int.max_unsigned ->
  cmpu_bool valid_ptr Cle x (Vint i) = cmpu_bool valid_ptr Clt x (Vint (Int.add i Int.one)).
Proof.
  unfold cmpu_bool; intros.  destruct Archi.ptr64 eqn:SF, x; auto.
  - rewrite Int.leu_ltu; auto.
  - rewrite Int.leu_ltu; auto.
  - destruct (Int.eq i Int.zero && (valid_ptr b (Ptrofs.unsigned i0) || valid_ptr b (Ptrofs.unsigned i0 - 1)));
    destruct (Int.eq (Int.add i Int.one) Int.zero && (valid_ptr b (Ptrofs.unsigned i0) || valid_ptr b (Ptrofs.unsigned i0 - 1)));
    auto.
Qed.

Theorem cmp_bool_ge_gt:
  forall x i,
  Int.min_signed < Int.signed i ->
  cmp_bool Cge x (Vint i) = cmp_bool Cgt x (Vint (Int.sub i Int.one)).
Proof.
  intros. destruct x; auto. simpl. rewrite Int.ge_gt; auto.
  unfold Int.zwordsize; simpl; lia.
Qed.

Theorem cmpu_bool_ge_gt:
  forall valid_ptr x i,
  0 < Int.unsigned i ->
  cmpu_bool valid_ptr Cge x (Vint i) = cmpu_bool valid_ptr Cgt x (Vint (Int.sub i Int.one)).
Proof.
  unfold cmpu_bool; intros.  destruct Archi.ptr64 eqn:SF, x; auto.
  - simpl. rewrite Int.geu_gtu; auto.
  - simpl. rewrite Int.geu_gtu; auto.
  - destruct (Int.eq i Int.zero && (valid_ptr b (Ptrofs.unsigned i0) || valid_ptr b (Ptrofs.unsigned i0 - 1)));
    destruct (Int.eq (Int.sub i Int.one) Int.zero && (valid_ptr b (Ptrofs.unsigned i0) || valid_ptr b (Ptrofs.unsigned i0 - 1)));
    auto.
Qed.
...
Lemma pcast_lessdef v1 v2: lessdef v1 v2 -> lessdef (Val.pcast v1) (Val.pcast v2).
Proof.
  intros H. inv H; cbn; constructor.
Qed.
...
Lemma addl_hiword_lessdef:
  forall xh xl yh yl,
    lessdef (hiword (addl (combine xh xl) (combine yh yl)))
            (add (add xh yh) (add_carry xl yl Vzero)).
Proof.
  intros. destruct xh, xl, yh, yl; auto. simpl.
  rewrite Int64.decompose_add, Int64.hi_ofwords. auto.
Qed.

Lemma addl_loword_lessdef:
  forall xh xl yh yl,
    lessdef (loword (addl (combine xh xl) (combine yh yl)))
            (add xl yl).
Proof.
  intros. destruct xh, xl, yh, yl; auto. simpl.
  rewrite Int64.decompose_add, Int64.lo_ofwords. auto.
Qed.

Lemma subl_hiword_lessdef:
  forall xh xl yh yl,
    lessdef (hiword (subl (combine xh xl) (combine yh yl)))
            (sub (sub xh yh) (sub_borrow xl yl Vzero)).
Proof.
  intros. destruct xh, xl, yh, yl; auto. simpl.
  rewrite Int64.decompose_sub, Int64.hi_ofwords. auto.
Qed.

Lemma subl_loword_lessdef:
  forall xh xl yh yl,
    lessdef (loword (subl (combine xh xl) (combine yh yl)))
            (sub xl yl).
Proof.
  intros. destruct xh, xl, yh, yl; auto. simpl.
  rewrite Int64.decompose_sub, Int64.lo_ofwords. auto.
Qed.

Lemma subl'_hiword_lessdef:
  forall xh xl yh yl,
    lessdef (hiword (subl (combine xh xl) (combine yh yl)))
            (add (add xh (notint yh)) (add_carry xl (notint yl) Vone)).
Proof.
  intros. destruct xh, xl, yh, yl; auto. simpl.
  rewrite Int64.decompose_sub', Int64.hi_ofwords. auto.
Qed.
...
Lemma select_bool_lessdef:
  forall c c' v1 v1' v2 v2' ty,
  lessdef c c' -> lessdef v1 v1' -> lessdef v2 v2' ->
  lessdef (select_bool c v1 v2 ty) (select_bool c' v1' v2' ty).
Proof.
  intros; unfold select_bool. destruct c; inv H; auto.
  apply select_lessdef; auto.
Qed.
...
- if [f b = Some(b', ofs)], the block [b] of [m1] corresponds to
...
Lemma inject_injective:
  ...
  v1 = v2.
Proof.
  intros. inv H0; inv H1; congruence.
Qed.
...
Lemma load_result_inject':
  ...
  inject j v1 v2 ->
  has_type v1 ty ->
  inject j v1 (Val.load_result (chunk_of_type ty) v2).
Proof.
  intros until v1; unfold Val.has_type, Val.load_result; destruct Archi.ptr64;
  destruct 1; intros; auto; destruct ty; simpl;
  try contradiction; try discriminate; econstructor; eauto.
Qed.

Remark pcast_inject v1 v2: inject f v1 v2 -> inject f (Val.pcast v1) (Val.pcast v2).
Proof.
  intros. inv H; cbn; try constructor.  eapply inject_ptr; eauto.
Qed.
...
Lemma select_bool_inject:
  forall c c' v1 v1' v2 v2' ty,
  inject f c c' -> inject f v1 v1' -> inject f v2 v2' ->
  inject f (select_bool c v1 v2 ty) (select_bool c' v1' v2' ty).
Proof.
  intros; unfold select_bool. destruct c; auto; inv H.
  apply select_inject; auto.
Qed.
