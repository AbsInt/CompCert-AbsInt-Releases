...
(** Trivially, a forward simulation is reflexive. 
    Used for no-op passes. *)

Theorem forward_simulation_refl:
  forall (L: semantics), forward_simulation L L.
Proof.
  intros. eapply forward_simulation_step.
  - intros. reflexivity.
  - intros. exists s1. split. exact H. reflexivity.
  - intros. rewrite <- H. exact H0.
  - intros. exists s1'. split.
    rewrite <- H0. exact H. reflexivity.
Qed.
