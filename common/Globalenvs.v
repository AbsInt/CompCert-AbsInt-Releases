...
(*- E_COMPCERT_FTR_Function_Globalenvs_store_zeros_001 *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Senv_t_0_001 *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Senv_symbol_address_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Senv_equiv_001 *)
...
Lemma equiv_symmetric se1 se2: equiv se1 se2 -> equiv se2 se1.
Proof.
  unfold equiv. intros (H & H' & H''). repeat split; congruence.
Qed.

Lemma equiv_trans se1 se2 se3: equiv se1 se2 -> equiv se2 se3 -> equiv se1 se3.
Proof.
  intros (A & B & C) (D & E & F). repeat split; congruence.
Qed.
End Senv.
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_t_0_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_001 *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_symbol_001 *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_symbol_address_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition symbol_address (ge: t) (id: ident) (ofs: ptrofs) : val :=
  match find_symbol ge id with
  | Some b => Vptr b ofs
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_public_symbol_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_def_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_funct_ptr_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_funct_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_invert_symbol_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_var_info_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_block_is_volatile_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_add_global_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_add_globals_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_empty_genv_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Program Definition empty_genv (pub: list ident): t :=
  @mkgenv pub (PTree.empty _) (PTree.empty _) 1%positive _ _ _.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_globalenv_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition globalenv (p: program F V) :=
  add_globals (empty_genv p.(prog_public)) p.(prog_defs).
(*- #End *)

Lemma add_global_genv_defs ge id g b: ((b <> (genv_next ge)) /\ (genv_defs (add_global ge (id, g))) ! b = (genv_defs ge) ! b) \/ (b = (genv_next ge) /\ (genv_defs (add_global ge (id, g))) ! b = Some g).
Proof.
  destruct ge. cbn. rewrite PTree.gsspec. destruct (peq b genv_next0); auto.
Qed.

Corollary add_global_genv_defs_some ge id g b f: (genv_defs (add_global ge (id, g))) ! b = Some f -> ((b <> (genv_next ge)) /\ (genv_defs ge) ! b  = Some f) \/ (b = (genv_next ge)) /\ f = g.
Proof.
  destruct (add_global_genv_defs ge id g b) as [[eq eq1] | [eq eq2]].
  - rewrite eq1. auto.
  - intros. right. split; congruence.
Qed.    


Lemma no_pointer_in_empty_genv ls b: find_funct_ptr (empty_genv ls) b = None.
Proof.
  unfold empty_genv; cbn. unfold find_funct_ptr; cbn. unfold find_def; cbn.
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_public_symbol_exists_001 *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_var_info_iff_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_invert_find_symbol_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_find_invert_symbol_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_block_is_volatile_below_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_to_senv_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_store_init_data_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_store_init_data_list_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_perm_globvar_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_alloc_global_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_alloc_globals_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Globalenvs_Genv_init_mem_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEMANTIC_PRESERVATION_002 *)
...
Lemma block_is_volatile_preserved {F F' V} (ge: Genv.t F V) (ge': Genv.t F' V) b: find_var_info ge b = find_var_info ge' b -> block_is_volatile ge b = block_is_volatile ge' b.
Proof.
  intros eq. unfold block_is_volatile. rewrite eq. now destruct (find_var_info ge' b).
Qed.
...
Section TRANSFORM_TOTAL.
  Context {A B V: Type} {transf: A -> B}.

  Definition map_globdef (gd: globdef A V) :=
    match gd with
    | Gfun g => Gfun (transf g)
    | Gvar v => Gvar v
    end.

  Context {p: program A V}.
                                                                                                    
Theorem find_def_transform gd b: Genv.find_def (Genv.globalenv (transform_program transf p)) b = Some gd -> exists gd', Genv.find_def (Genv.globalenv p) b = Some gd' /\ gd = map_globdef gd'.
Proof.
  intros H.
  pose proof (find_def_inversion _ _ H) as (id & H').
  eapply (@find_def_match unit _ _ _ _ _ (fun _ f1 f2 => (f1 = transf f2))) in H as (tg & eq1 & H).
  - exists tg. split.
    + exact eq1.
    + inv H.
      * cbn. reflexivity.
      * cbn. inv H0. repeat f_equal. apply H. 
  - split.
    + cbn. induction (prog_defs p).
      * cbn. constructor.
      * cbn. constructor.
        -- unfold transform_program_globdef. destruct a; split.
           ++ destruct g; reflexivity.
           ++ cbn.  destruct g.
              ** cbn. eapply match_globdef_fun; eauto. unfold linkorder. cbn. apply (linkorder_refl tt).
              ** cbn. eapply match_globdef_var. destruct v. constructor. reflexivity.         
        -- assumption.          
    + cbn.  split; reflexivity.
Qed.

Theorem find_def_transform_Gfun f b: Genv.find_def (Genv.globalenv (transform_program transf p)) b = Some (Gfun f) -> exists f', Genv.find_def (Genv.globalenv p) b = Some (Gfun f') /\ f = transf f'.
Proof.
  intros. apply find_def_transform in H as (rd & eq1 & eq2).
  destruct rd.
  - cbn in eq2. inv eq2. now exists f0. 
  - cbn in eq2. discriminate eq2.
Qed.

Context {LA: Linker A} {LV: Linker V} {tp: program B V}.
...
Section TRANSFORM_TOTAL'.
  Context {A B V: Type} {transf: B -> A}.
  Context {LA: Linker A} {LV: Linker V} {p: program A V} {tp: program B V}.

Hypothesis progmatch: match_program (fun cu f tf => f = transf tf) eq p tp.
Theorem init_mem_transf':
  forall m, init_mem p = Some m -> init_mem tp = Some m.
Proof.
  eapply (init_mem_match progmatch).
