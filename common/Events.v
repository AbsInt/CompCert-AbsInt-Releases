...
Lemma volatile_load_ok:
  ...
  extcall_properties (volatile_load_sem chunk)
                     (mksignature (Taptr :: nil) (rettype_of_chunk chunk) cc_default).
Proof.
...
Lemma volatile_store_ok:
  ...
  extcall_properties (volatile_store_sem chunk)
                     (mksignature (Taptr :: argtype_of_chunk chunk :: nil) Tvoid cc_default).
Proof.
  intros; constructor; intros.
(* well typed *)
...
Lemma extcall_malloc_ok:
  extcall_properties extcall_malloc_sem
                     (mksignature (Targ Tptr :: nil) Trptr cc_default).
Proof.
  assert (UNCHANGED:
  ...
  constructor; intros.
(* well typed *)
- inv H. simpl. unfold Tptr. destruct Archi.ptr64 eqn:?; simpl; auto.
(* symbols preserved *)
...
Lemma extcall_free_ok:
  extcall_properties extcall_free_sem
                     (mksignature (Taptr :: nil) Tvoid cc_default).
Proof.
  constructor; intros.
(* well typed *)
- inv H; simpl; auto.
...
Lemma extcall_memcpy_ok:
  ...
  extcall_properties (extcall_memcpy_sem sz al)
                     (mksignature (Taptr :: Taptr :: nil) Tvoid cc_default).
Proof.
  intros. constructor.
- (* return type *)
...
Lemma extcall_annot_ok:
  ...
  extcall_properties (extcall_annot_sem text targs)
                     (mksignature (List.map Targ targs) Tvoid cc_default).
Proof.
  intros; constructor; intros.
(* well typed *)
- inv H. simpl. auto.
...
Lemma extcall_annot_val_ok:
  ...
  extcall_properties (extcall_annot_val_sem text targ)
                     (mksignature (Targ targ :: nil) targ cc_default).
Proof.
  intros; constructor; intros.
(* well typed *)
