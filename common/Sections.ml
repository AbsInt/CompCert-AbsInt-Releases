...
(*- E_COMPCERT_CODE_Sections_initialized_001 *)
...
(*- E_COMPCERT_CODE_Sections_section_name_001 *)
(*- #Justify_Derived "Type definition" *)
type section_name =
  | Section_text
...
(*- E_COMPCERT_CODE_Sections_with_size_001 *)
...
(*- E_COMPCERT_CODE_Sections_access_mode_001 *)
(*- #Justify_Derived "Type definition" *)
type access_mode =
  | Access_default
  | Access_near
...
(*- E_COMPCERT_CODE_Sections_section_info_001 *)
(*- #Justify_Derived "Type definition" *)
type section_info = {
...
(*- E_COMPCERT_CODE_Sections_default_section_info_001 *)
...
(*- E_COMPCERT_CODE_Sections_builtin_sections_001 *)
(*- #Justify_Derived "Utility constant" *)
...
(*- E_COMPCERT_CODE_Sections_current_section_table_001 *)
...
(*- E_COMPCERT_CODE_Sections_use_section_table_001 *)
(*- #Justify_Derived "Variable for global state" *)
let use_section_table : (AST.ident, section_info) Hashtbl.t =
  Hashtbl.create 51
(*- #End *)

(*- E_COMPCERT_CODE_Sections_initialize_001 *)
(*- #Justify_Derived "Utility function" *)
let initialize () =
...
(*- E_COMPCERT_CODE_Sections_define_section_001 *)
...
(*- E_COMPCERT_CODE_Sections_use_section_for_001 *)
...
(*- E_COMPCERT_CODE_Sections_gcc_section_001 *)
(*- #Link_to E_COMPCERT_TR_Function_C2C_010 *)
...
(*- E_COMPCERT_CODE_Sections_get_attr_section_001 *)
(*- #Link_to E_COMPCERT_TR_Robustness_C2C_029 *)
...
(*- E_COMPCERT_CODE_Sections_for_variable_001 *)
(*- #Link_to E_COMPCERT_TR_Function_C2C_010 *)
  ...
  let si =
    ...
    with Not_found ->
      ...
      | None ->
        ...
        let size =
          match Cutil.sizeof env ty with Some sz -> sz | None -> Int64.max_int in
        let name =
          if readonly
          then if size <= Int64.of_int !Clflags.option_small_const then "SCONST" else "CONST"
          else if size <= Int64.of_int !Clflags.option_small_data then "SDATA" else "DATA" in
        try
...
(*- E_COMPCERT_CODE_Sections_for_function_001 *)
(*- #Link_to E_COMPCERT_TR_Function_C2C_010 *)
...
(*- E_COMPCERT_CODE_Sections_for_stringlit_001 *)
(*- #Link_to E_COMPCERT_TR_Function_C2C_010 *)
