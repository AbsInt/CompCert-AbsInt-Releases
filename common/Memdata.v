...
(*- E_COMPCERT_FTR_Function_Memdata_size_chunk_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_003 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_size_chunk_nat_001 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_align_chunk_001 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_min_safe_alignment_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_MEM_ALIGNMENT_001 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_quantity_0_001 *)
(*- #Justify_Derived "Auxiliary type" *)
Inductive quantity : Type := Q32 | Q64.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Memdata_quantity_eq_001 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_size_quantity_nat_001 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_memval_0_001 *)
(*- #Justify_Derived "Auxiliary type" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_bytes_of_int_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_int_of_bytes_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_length_bytes_of_int_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_rev_if_be_length_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_encode_int_length_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_inj_bytes_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition inj_bytes (bl: list byte) : list memval :=
  List.map Byte bl.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Memdata_proj_bytes_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_inj_value_rec_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_inj_value_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition inj_value (q: quantity) (v: val): list memval :=
  inj_value_rec (size_quantity_nat q) v q.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Memdata_check_value_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_proj_value_001 *)
(*- #Justify_Derived "Auxiliary function" *)
...
(*- E_COMPCERT_FTR_Function_Memdata_encode_val_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_VALUES_004 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_decode_val_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_VALUES_004 *)
...
Proof.
  intros. rewrite <- proj_xtype_typ_of_chunk.
  apply Val.has_proj_xtype_typ. apply decode_val_xtype.
Qed.
...
(*- E_COMPCERT_FTR_Function_Memdata_memval_inject_0_001 *)
...
(*- E_COMPCERT_FTR_Function_Memdata_int_of_bytes_range_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
