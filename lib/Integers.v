...
(*- E_COMPCERT_FTR_Function_Integers_comparison_0_001 *)
(*- #Justify_Derived "Internal type for different kind of comparisons" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_wordsize_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
Definition wordsize: nat := WS.wordsize.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_zwordsize_001 *)
(*- #Justify_Derived "Auxiliary constant" *)
Definition zwordsize: Z := Z.of_nat wordsize.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_modulus_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition modulus : Z := two_power_nat wordsize.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_half_modulus_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition half_modulus : Z := modulus / 2.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_max_unsigned_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
Definition max_unsigned : Z := modulus - 1.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_max_signed_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
Definition max_signed : Z := half_modulus - 1.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_min_signed_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
Definition min_signed : Z := - half_modulus.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_wordsize_pos_001 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_modulus_power_001 *)
(*- #Justify_Derived "Auxiliary remark" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_modulus_gt_one_001 *)
(*- #Justify_Derived "Auxiliary remark" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_modulus_pos_001 *)
(*- #Justify_Derived "Auxiliary remark" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_int_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TYPE_REPRESENTATION_002 *)
Record int: Type := mkint { intval: Z; intrange: -1 < intval < modulus }.
(*- #End *)

(** Fast normalization modulo [2^wordsize] *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_Z_mod_modulus_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_Z_mod_modulus_range_001 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_Z_mod_modulus_range_p_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma Z_mod_modulus_range':
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_Z_mod_modulus_eq_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_unsigned_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TYPE_REPRESENTATION_002 *)
Definition unsigned (n: int) : Z := intval n.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_signed_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TYPE_REPRESENTATION_002 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_repr_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_TYPE_REPRESENTATION_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_VALUES_001 *)
Definition repr (x: Z) : int :=
  mkint (Z_mod_modulus x) (Z_mod_modulus_range' x).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_zero_001 *)
(*- #Justify_Derived "Auxiliary constant" *)
Definition zero := repr 0.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_one_001 *)
(*- #Justify_Derived "Auxiliary constant" *)
Definition one  := repr 1.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_mone_001 *)
(*- #Justify_Derived "Auxiliary constant" *)
Definition mone := repr (-1).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_iwordsize_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition iwordsize := repr zwordsize.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_mkint_eq_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma mkint_eq:
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eq_dec_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
Lemma repr_mod_eq:
  forall x,
    repr x = repr (x mod modulus).
Proof.
  intros. apply mkint_eq.
  rewrite Z_mod_modulus_eq. rewrite Z_mod_modulus_eq. rewrite Zmod_mod. reflexivity.
Qed.

(** * Arithmetic and logical operations over machine integers *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eq_001 *)
(*- #Justify_Derived "Auxiliary function used by cmp function" *)
Definition eq (x y: int) : bool :=
  if zeq (unsigned x) (unsigned y) then true else false.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_lt_001 *)
(*- #Justify_Derived "Auxiliary function used by cmp function" *)
Definition lt (x y: int) : bool :=
  if zlt (signed x) (signed y) then true else false.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_ltu_001 *)
(*- #Justify_Derived "Auxiliary function used by cmpu function" *)
Definition ltu (x y: int) : bool :=
  if zlt (unsigned x) (unsigned y) then true else false.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_neg_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_UNARY_OPERATORS_004 *)
Definition neg (x: int) : int := repr (- unsigned x).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_add_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_ADD_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition add (x y: int) : int :=
  repr (unsigned x + unsigned y).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_sub_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_009 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_014 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_ADD_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition sub (x y: int) : int :=
  repr (unsigned x - unsigned y).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_mul_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition mul (x y: int) : int :=
  repr (unsigned x * unsigned y).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_divs_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition divs (x y: int) : int :=
  repr (Z.quot (signed x) (signed y)).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_mods_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_divu_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_006 *)
...
Definition divu (x y: int) : int :=
  repr (unsigned x / unsigned y).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_modu_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_MULT_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_MULTIPLICATIVE_OPERATORS_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_and_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_BITWISE_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BITAND_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition and (x y: int): int := repr (Z.land (unsigned x) (unsigned y)).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_or_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_BITWISE_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_BITOR_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition or (x y: int): int := repr (Z.lor (unsigned x) (unsigned y)).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_xor_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_BITWISE_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_BITXOR_OPERATOR_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_UNARY_OPERATORS_005 *)
Definition xor (x y: int) : int := repr (Z.lxor (unsigned x) (unsigned y)).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_not_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_shl_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SHIFT_OPERATORS_004 *)
Definition shl (x y: int): int := repr (Z.shiftl (unsigned x) (unsigned y)).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_shru_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SHIFT_OPERATORS_005 *)
Definition shru (x y: int): int := repr (Z.shiftr (unsigned x) (unsigned y)).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_shr_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SHIFT_OPERATORS_005 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_rolm_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_mulhu_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition mulhu (x y: int): int := repr ((unsigned x * unsigned y) / modulus).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_mulhs_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_negative_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition negative (x: int): int :=
  if lt x zero then one else zero.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_add_carry_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_sub_overflow_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_shr_carry_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_zero_ext_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_007 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_004 *)
Definition zero_ext (n: Z) (x: int) : int := repr (Zzero_ext n (unsigned x)).
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_sign_ext_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_007 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGER_CONVERSION_003 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_cmp_001 *)
...
(*- #Link_to E_COMPCERT_TOR_Function_RELATIONAL_OPERATORS_002 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_cmpu_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_EQUALITY_OPERATORS_003 *)
(*- #Link_to E_COMPCERT_TOR_Function_EQUALITY_OPERATORS_004 *)
(*- #Link_to E_COMPCERT_TOR_Function_EQUALITY_OPERATORS_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_EQUALITY_OPERATORS_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_unsigned_repr_eq_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition eqm := eqmod modulus.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_refl_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_sym_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_trans_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_add_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma eqm_add:
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_neg_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma eqm_neg:
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_samerepr_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_unsigned_repr_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_eqm_unsigned_repr_l_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_repr_unsigned_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_unsigned_zero_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_add_commut_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
Theorem add_commut: forall x y, add x y = add y x.
Proof. intros; unfold add. decEq. lia. Qed.
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_add_zero_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_add_assoc_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_add_neg_zero_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
Theorem add_carry_lt:
  forall x y,
    add_carry x y zero = if ltu (add x y) y then one else zero.
Proof.
  intros.
  generalize (unsigned_range x). generalize (unsigned_range y). intros.
  unfold ltu. rewrite unsigned_add_carry.
  unfold add_carry. rewrite unsigned_zero. rewrite Z.add_0_r.
  destruct (zlt (unsigned x + unsigned y) modulus);
    [rewrite unsigned_zero; rewrite zlt_false |rewrite unsigned_one; rewrite zlt_true];
    try reflexivity; lia.
Qed.
...
Theorem neg_eq_zero: forall x, eq x zero = eq (neg x) zero.
Proof.
  unfold eq, neg; intros. rewrite unsigned_zero.
  destruct (zeq (unsigned x) 0); symmetry. rewrite e. apply zeq_true.
  apply zeq_false. red. intros. rewrite unsigned_repr_eq in H.
  apply Z_mod_zero_opp_full in H.
  replace (- - unsigned x) with (unsigned x) in H by lia.
  rewrite Zmod_small in H by apply unsigned_range. congruence.
Qed.
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_neg_add_distr_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_sub_add_opp_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_sub_add_l_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_sub_shifted_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
Theorem sub_shifted:
  forall x y z,
...
Theorem sub_borrow_lt:
  forall x y,
    sub_borrow x y zero = if ltu x y then one else zero.
Proof.
  intros.
  generalize (unsigned_range x). generalize (unsigned_range y). intros.
  unfold ltu. unfold sub_borrow. rewrite unsigned_zero. rewrite Z.sub_0_r.
  destruct (zlt (unsigned x) (unsigned y)); [rewrite zlt_true | rewrite zlt_false]; auto; lia.
Qed.
...
Lemma bits_signed_2:
  forall x i n, 0 < n < zwordsize ->
                0 <= i < zwordsize ->
                -two_p (n-1) <= signed x < two_p (n-1) ->
                testbit x i = testbit x (if zlt i n then i else n - 1).
Proof.
  intros.
  ...
  assert (signed x < 0 \/ signed x >= 0) by lia.
  destruct H3.
  - assert (Z.testbit (signed x  + modulus) (n - 1) = Z.testbit (signed x + modulus) i).
    { generalize (Zbits.Ztestbit_two_p_below zwordsize). intros.
      rewrite modulus_power.
      rewrite Zbits.Z_add_is_or by (try lia; intros; rewrite H4 by lia; apply andb_false_r).
      rewrite Zbits.Z_add_is_or by (try lia; intros; rewrite H4 by lia; apply andb_false_r).
      replace (Z.testbit (signed x) (n-1)) with true.
      replace (Z.testbit (signed x) i) with true.
      auto.
      symmetry.
      apply (Zbits.Ztestbit_above_neg (Z.to_nat i)); try lia.
      rewrite two_power_nat_two_p, Z2Nat.id by lia.
      exploit (two_p_monotone_strict (n-1) i); lia.
      symmetry.
      apply (Zbits.Ztestbit_above_neg (Z.to_nat (n -1))); try lia.
      rewrite two_power_nat_two_p, Z2Nat.id; lia.
    }
    unfold testbit, signed in *. destruct (zlt (unsigned x) half_modulus).
    generalize (unsigned_range x). lia.
    replace (unsigned x - modulus  + modulus) with (unsigned x) in H4 by lia.
    auto.
  - assert (unsigned x = signed x).
    { symmetry. apply signed_eq_unsigned. apply signed_positive. auto. }
    replace (testbit x i) with false.
    replace (testbit x (n - 1)) with false.
    reflexivity.
    symmetry. apply Zbits.Ztestbit_size_2. apply unsigned_range.
    apply Zbits.Zsize_interval_2. lia. rewrite H4. lia.
    symmetry. apply Zbits.Ztestbit_size_2. apply unsigned_range.
    apply Zbits.Zsize_interval_2. lia. rewrite H4.
    exploit (two_p_monotone_strict (n-1) i); lia.
Qed.
...
Theorem xor_not_xor: forall x y, xor (not x) (not y) = xor x y.
Proof.
  bit_solve.
  destruct (testbit x i), (testbit y i); auto.
Qed.

Theorem xor_lt_zero:
  forall x y, zwordsize > 1 ->
         lt (xor x y) zero = xorb (lt x zero) (lt y zero).
Proof.
  intros. unfold lt. rewrite signed_zero.
  assert (forall x, (if zlt (signed x) 0 then true else false) = (if zlt (unsigned x) half_modulus then false else true)).
  { intros. unfold signed. generalize (unsigned_range x0). intros.
    destruct (zlt (unsigned x0) half_modulus).
    apply zlt_false; lia. apply zlt_true; lia.
  }
  rewrite ! H0. rewrite <- !sign_bit_of_unsigned by lia.
  rewrite bits_xor by lia. reflexivity.
Qed.
...
Remark neg_unsigned_signed:
  forall y, unsigned y >= half_modulus ->
       unsigned (neg y) = - signed y.
Proof.
  unfold neg, signed. intros. rewrite zlt_false by lia. rewrite unsigned_repr_eq.
  replace (-(unsigned y)) with ((modulus - unsigned y) + (-1) * modulus) by lia.
  rewrite Z_mod_plus_full. rewrite Z.mod_small. lia.
  generalize (unsigned_range y). generalize modulus_pos. generalize half_modulus_pos.
  lia.
Qed.
...
Lemma divs_divu:
  forall x y,
    eq y zero = false ->
    let x' := if lt x zero then neg x else x in
    let y' := if lt y zero then neg y else y in
    divs x y = if xorb (lt x zero) (lt y zero) then neg (divu x' y') else divu x' y'.
Proof.
  unfold divs, lt. intros.
  destruct (zlt (unsigned x) half_modulus), (zlt (unsigned y) half_modulus); rewrite signed_zero.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x >= 0) by (unfold signed; rewrite zlt_true; lia).
    assert (signed y >= 0) by (unfold signed; rewrite zlt_true; lia).
    unfold divu.
    rewrite zlt_false by lia.
    rewrite zlt_false by lia. simpl.
    rewrite Zquot_Zdiv_pos; try lia.
    unfold signed. rewrite ! zlt_true by lia. reflexivity.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x >= 0) by (unfold signed; rewrite zlt_true; lia).
    assert (signed y < 0) by (unfold signed; rewrite zlt_false; lia).
    rewrite zlt_false by lia. rewrite zlt_true by lia. simpl.
    unfold divu. rewrite neg_unsigned_signed by lia.
    unfold signed. rewrite zlt_true by lia. rewrite zlt_false by lia.
    replace (unsigned y - modulus) with (- (modulus - unsigned y)) at 1 by lia.
    rewrite Zquot_opp_r. rewrite Zquot_Zdiv_pos by lia.
    rewrite neg_repr.
    replace (- (unsigned y - modulus)) with (modulus - unsigned y) by lia.
    reflexivity.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x < 0) by (unfold signed; rewrite zlt_false; lia).
    assert (signed y >= 0) by (unfold signed; rewrite zlt_true; lia).
    rewrite zlt_true by lia. rewrite zlt_false by lia. simpl.
    unfold divu. rewrite neg_unsigned_signed by lia.
    unfold signed. rewrite zlt_false by lia. rewrite zlt_true by lia.
    replace (unsigned x - modulus) with (- (modulus -  unsigned x)) at 1 by lia.
    rewrite Zquot_opp_l. rewrite Zquot_Zdiv_pos by lia.
    rewrite neg_repr.
    replace (modulus - unsigned x) with (- (unsigned x - modulus)) by lia.
    reflexivity.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x < 0) by (unfold signed; rewrite zlt_false; lia).
    assert (signed y < 0) by (unfold signed; rewrite zlt_false; lia).
    rewrite ! zlt_true by lia. simpl. unfold divu.
    rewrite <- Zquot_opp_opp.
    rewrite <- neg_unsigned_signed by lia. rewrite <- neg_unsigned_signed by lia.
    rewrite Zquot_Zdiv_pos. reflexivity.
    generalize (unsigned_range (neg x)). lia.
    generalize (unsigned_range (neg y)). lia.
Qed.
...
Lemma mods_modu:
  forall x y,
    ...
    let x' := if lt x zero then neg x else x in
    let y' := if lt y zero then neg y else y in
    mods x y = if lt x zero then neg (modu x' y') else modu x' y'.
Proof.
  unfold mods, lt. intros.
  assert (signed y <> 0 /\ unsigned y <> 0).
  {  unfold eq in H. rewrite unsigned_zero in H. destruct (zeq (unsigned y) 0); inv H.
     split; auto.
     unfold signed. destruct (zlt (unsigned y) half_modulus). lia.
     generalize (unsigned_range y). lia.
  }
  destruct H0.
  destruct (zlt (unsigned x) half_modulus), (zlt (unsigned y) half_modulus); rewrite signed_zero.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    ...
    rewrite zlt_false by lia.
    rewrite zlt_false by lia.
    rewrite Zrem_Zmod_pos; try lia.
    unfold signed. rewrite ! zlt_true by lia. reflexivity.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x >= 0) by (unfold signed; rewrite zlt_true; lia).
    assert (signed y < 0) by (unfold signed; rewrite zlt_false; lia).
    rewrite zlt_false by lia. rewrite zlt_true by lia.
    unfold modu. rewrite neg_unsigned_signed by lia.
    unfold signed. rewrite zlt_true by lia. rewrite zlt_false by lia.
    replace (unsigned y - modulus) with (- (modulus - unsigned y)) at 1 by lia.
    rewrite Zrem_opp_r. rewrite Zrem_Zmod_pos by lia.
    replace (- (unsigned y - modulus)) with (modulus - unsigned y) by lia.
    reflexivity.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x < 0) by (unfold signed; rewrite zlt_false; lia).
    ...
    unfold signed. rewrite zlt_false by lia. rewrite zlt_true by lia.
    replace (unsigned x - modulus) with (- (modulus -  unsigned x)) at 1 by lia.
    rewrite Zrem_opp_l. rewrite Zrem_Zmod_pos by lia.
    rewrite neg_repr.
    replace (modulus - unsigned x) with (- (unsigned x - modulus)) by lia.
    reflexivity.
  - generalize (unsigned_range x), (unsigned_range y). intros.
    assert (signed x < 0) by (unfold signed; rewrite zlt_false; lia).
    assert (signed y < 0) by (unfold signed; rewrite zlt_false; lia).
    rewrite ! zlt_true by lia. simpl. unfold modu. rewrite neg_repr.
    unfold signed. rewrite ! zlt_false by lia.
    replace (unsigned x - modulus) with (- (modulus - unsigned x)) by lia.
    replace (unsigned y - modulus) with (- (modulus - unsigned y)) by lia.
    rewrite Zrem_opp_opp.
    rewrite neg_unsigned_signed by lia. rewrite neg_unsigned_signed by lia.
...
Lemma zero_ext_range_eq:
  forall n x, ltu x (repr (two_p n)) = true -> zero_ext n x = x.
Proof.
  intros.
  assert (n < 0 \/ n = 0 \/ n > 0) by lia.
  destruct H0 as [H0 | [H0 | H0]].
  - apply ltu_inv in H.
    replace (two_p n) with 0 in H by (destruct n; try inv H0; auto).
    change (repr 0) with zero in H. rewrite unsigned_zero in H. lia.
  - subst. simpl in H.
    apply ltu_inv in H. change (repr 1) with one in H. rewrite unsigned_one in H.
    rewrite (zero_ext_below 0 x) by lia. transitivity (repr (unsigned x)).
    unfold zero. f_equal. lia.
    apply repr_unsigned.
  - assert (n < zwordsize \/ n >= zwordsize) by lia.
    destruct H1.
    + transitivity (repr (unsigned (zero_ext n x))).
      symmetry; apply repr_unsigned.
      transitivity (repr (unsigned x)); [|apply repr_unsigned].
      f_equal. rewrite zero_ext_mod. apply ltu_inv in H.
      assert (unsigned (repr (two_p n)) = two_p n).
      { rewrite unsigned_repr. reflexivity.
        unfold max_unsigned. rewrite modulus_power.
        split. exploit (two_p_gt_ZERO n); lia.
        replace zwordsize with (Z.succ (zwordsize - 1)); try lia.
        rewrite two_p_S; try lia.
        assert (two_p (zwordsize - 1) > 1).
        exploit (two_p_strict_2 (zwordsize - 1)); lia.
        assert (two_p n <= two_p (zwordsize - 1)).
        apply two_p_monotone. lia.
        lia.
      }
      rewrite H2 in H.
      apply Z.mod_small. assumption. lia.
    + apply zero_ext_above. assumption.
Qed.
...
Lemma sign_ext_range_eq:
  forall x n,
    lt (repr (-two_p (n - 1) -1)) x && lt x (repr (two_p (n - 1))) = true ->
    sign_ext n x = x.
Proof.
  intros until n.
  assert (n <= 0 \/ 0 < n < zwordsize \/ n >= zwordsize) by lia.
  destruct H as [H | [H | H]].
  - unfold lt. replace (two_p (n - 1)) with 0 by (destruct n; auto; lia).
    simpl.
    replace (signed (repr (-1))) with (-1).
    replace (signed (repr 0)) with 0.
    destruct (zlt (-1) (signed x)); try lia.
    destruct (zlt (signed x) 0); try lia.
    rewrite <- signed_zero. rewrite signed_repr. reflexivity.
    apply signed_range.
    rewrite <- signed_mone. rewrite signed_repr. reflexivity.
    apply signed_range.
  - intros. apply same_bits_eq.
    intros. rewrite bits_sign_ext; try lia.
    symmetry. apply bits_signed_2; try lia.
    apply andb_true_iff in H0. destruct H0.
    exploit (two_p_monotone_strict (n-1) (zwordsize - 1)); try lia.
    exploit (two_p_gt_ZERO (n-1)); try lia.
    generalize min_signed_neg, max_signed_pos.
    intros.
    unfold lt in H0, H2. rewrite signed_repr in H0, H2.
    destruct (zlt (- two_p (n-1) -1) (signed x)); try inv H0.
    destruct (zlt (signed x) (two_p (n-1))); try inv H2. lia.
    unfold max_signed. rewrite half_modulus_power. lia.
    unfold min_signed. rewrite half_modulus_power. lia.
  - rewrite sign_ext_above; auto.
Qed.
...
Lemma leu_ltu:
  forall x y,
  (unsigned y) < max_unsigned ->
  ltu x (add y one) = negb (ltu y x).
Proof.
  intros.
  unfold ltu. unfold add. rewrite unsigned_one.
  generalize (unsigned_range y). intros.
  rewrite unsigned_repr by lia.
  destruct (zlt (unsigned x) (unsigned y + 1));
    [rewrite zlt_false| rewrite zlt_true]; try reflexivity; lia.
Qed.
...
Lemma le_lt:
  ...
  zwordsize > 1 ->
  signed y < max_signed ->
  lt x (add y one) = negb (lt y x).
Proof.
  intros. unfold lt.
  rewrite add_signed.
  rewrite signed_one; auto.
  generalize (signed_range y). intros.
  rewrite signed_repr by lia.
  destruct (zlt (signed x) (signed y +1));
  [rewrite zlt_false | rewrite zlt_true]; try reflexivity; lia.
Qed.
...
Lemma geu_gtu:
  forall x y,
  0 < unsigned x ->
  ltu (sub x one) y = negb (ltu y x).
Proof.
  intros. unfold ltu. unfold sub. rewrite unsigned_one.
  generalize (unsigned_range x). intros.
  rewrite unsigned_repr by (unfold max_unsigned; lia).
  destruct (zlt (unsigned x - 1) (unsigned y));
  [rewrite zlt_false| rewrite zlt_true]; try reflexivity; lia.
Qed.
...
Proof.
  ...
  generalize (signed_range x). intros.
  rewrite signed_repr by lia.
  destruct (zlt (signed x - 1) (signed y));
  [rewrite zlt_false | rewrite zlt_true]; try reflexivity; lia.
Qed.
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_unsigned_bitfield_extract_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_019 *)
Definition unsigned_bitfield_extract (pos width: Z) (n: int) : int :=
  zero_ext width (shru n (repr pos)).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_signed_bitfield_extract_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_019 *)
Definition signed_bitfield_extract (pos width: Z) (n: int) : int :=
  sign_ext width (shru n (repr pos)).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Wordsize_bitfield_insert_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_019 *)
...
Module Wordsize_32.
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_32_wordsize_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
...
Module Wordsize_8.
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_8_wordsize_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_005 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
...
Module Wordsize_64.
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_64_wordsize_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Int64_iwordsize_p_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
...
Definition shrx' (x: int) (y: Int.int): int :=
  divs x (shl' one y).
(*- E_COMPCERT_FTR_Function_Integers_Int64_shr_carry_p_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
Lemma is_power2'_two_p:
  forall n, 0 <= n < zwordsize ->
  is_power2' (repr (two_p n)) = Some (Int.repr n).
Proof.
  intros. unfold is_power2'. rewrite unsigned_repr. rewrite Z_one_bits_two_p.
  reflexivity. auto.
  apply two_p_range. auto.
Qed.
...
(*- E_COMPCERT_FTR_Function_Integers_Int64_loword_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SHIFT_OPERATORS_004 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Int64_hiword_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SHIFT_OPERATORS_005 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Int64_ofwords_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_BIN_OP_SHIFT_002 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
(*- #Link_to E_COMPCERT_TOR_Function_SHIFT_OPERATORS_004 *)
...
Lemma lo_hi_shru:
  forall n x,
    0 < x < Int.zwordsize ->
    Int.shru (hiword n) (Int.repr x) = loword (shru n (Int64.repr (x + Int.zwordsize))).
Proof.
  intros. apply Int.same_bits_eq; intros.
  rewrite bits_loword; auto. rewrite Int.bits_shru by lia.
  assert (Int.zwordsize = 32) by reflexivity.
  assert (max_unsigned = 18446744073709551615) by reflexivity.
  assert (Int.max_unsigned = 4294967295) by reflexivity.
  assert (zwordsize = 2 * Int.zwordsize) by reflexivity.
  rewrite Int.unsigned_repr by lia.
  rewrite bits_shru by lia.
  rewrite ! unsigned_repr by lia.
  destruct (zlt (i + x) Int.zwordsize).
  rewrite bits_hiword by lia. rewrite zlt_true by lia.
...
Remark ofwords_zero: ofwords Int.zero Int.zero = zero.
Proof.
  rewrite ofwords_add. rewrite Int.unsigned_zero. reflexivity.
Qed.

Remark ofwords_mone : ofwords Int.mone Int.mone = mone.
  apply same_bits_eq. intros. rewrite bits_ofwords by lia.
  rewrite bits_mone by lia.
  destruct (zlt i Int.zwordsize); rewrite Int.bits_mone; auto; try lia.
  change Int.zwordsize with 32 in *. change zwordsize with 64 in H. lia.
Qed.
...
Lemma decompose_neg:
  forall xh xl,
  neg (ofwords xh xl) =
  ofwords (Int.sub (Int.neg xh) (Int.sub_borrow Int.zero xl Int.zero))
          (Int.neg xl).
Proof.
  intros. rewrite <- sub_zero_r.
  replace zero with (ofwords Int.zero Int.zero).
  rewrite decompose_sub. rewrite Int.sub_zero_r.
  reflexivity. rewrite ofwords_add.
...
Lemma decompose_neg':
  forall xh xl,
  neg (ofwords xh xl) =
  ofwords (Int.add (Int.not xh) (Int.add_carry Int.zero (Int.not xl) Int.one))
          (Int.neg xl).
Proof.
  intros. rewrite <- sub_zero_r.
  replace zero with (ofwords Int.zero Int.zero).
...
(*- E_COMPCERT_FTR_Function_Integers_Int64_mul_p_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition mul' (x y: Int.int) : int := repr (Int.unsigned x * Int.unsigned y).
(*- #End *)

Definition muls' (x y: Int.int) : int := repr (Int.signed x * Int.signed y).
...
Lemma muls'_mulhs:
  forall x y, muls' x y = ofwords (Int.mulhs x y) (Int.mul x y).
Proof.
  intros.
  rewrite ofwords_add. unfold muls', Int.mulhs, Int.mul.
  set (p := Int.signed x * Int.signed y).
  set (ph := p / Int.modulus). set (pl := p mod Int.modulus).
  transitivity (repr (ph * Int.modulus + pl)).
- f_equal. rewrite Z.mul_comm. apply Z_div_mod_eq. apply Int.modulus_pos.
- apply eqm_samerepr. apply eqm_add. apply eqm_mul_2p32. auto with ints.
  rewrite Int.unsigned_repr_eq. unfold pl, p. unfold Int.signed.
  destruct (zlt (Int.unsigned x) Int.half_modulus), (zlt (Int.unsigned y) Int.half_modulus).
  apply eqm_refl.
  replace (Int.unsigned y - Int.modulus) with (Int.unsigned y + (- Int.modulus)) by lia.
  rewrite Z.mul_add_distr_l. rewrite <- Zplus_mod_idemp_r.
  rewrite Z.mul_opp_r. rewrite Z_mod_zero_opp_full. rewrite Z.add_0_r.
  apply eqm_refl. apply Z_mod_mult.
  replace (Int.unsigned x - Int.modulus) with (Int.unsigned x + (- Int.modulus)) by lia.
  rewrite Z.mul_add_distr_r. rewrite <- Zplus_mod_idemp_r.
  rewrite Z.mul_opp_l. rewrite Z_mod_zero_opp_full. rewrite Z.add_0_r.
  apply eqm_refl. rewrite Z.mul_comm. apply Z_mod_mult.
  replace (Int.unsigned y - Int.modulus) with (Int.unsigned y + (- Int.modulus)) by lia.
  replace (Int.unsigned x - Int.modulus) with (Int.unsigned x + (- Int.modulus)) by lia.
  rewrite Z.mul_add_distr_l. rewrite Z.mul_add_distr_r.
   rewrite <- Zplus_mod_idemp_r. rewrite Z.mul_opp_r.
   rewrite Z_mod_zero_opp_full. rewrite Z.add_0_r.
   rewrite <- Zplus_mod_idemp_r. rewrite Z.mul_opp_l.
   rewrite Z_mod_zero_opp_full. rewrite Z.add_0_r. apply eqm_refl.
   rewrite Z.mul_comm. apply Z_mod_mult. apply Z_mod_mult.
Qed.
...
Lemma mulhs_mulhu:
  forall x y,
  let z':= if lt x zero then sub (mulhu x y) y else (mulhu x y) in
  mulhs x y = if lt y zero then sub z' x else z'.
Proof.
  intros. unfold z', mulhs, lt, signed, sub.
  generalize half_modulus_pos.  generalize modulus_pos.
  generalize (unsigned_range x). generalize (unsigned_range y). intros.
  set (x' := unsigned x) in *.
  set (y' := unsigned y) in *.
  rewrite unsigned_zero in *.
  rewrite (zlt_true _ 0 half_modulus) by lia.
  destruct (zlt x' half_modulus), (zlt y' half_modulus).
  - simpl. rewrite zlt_false by lia. rewrite zlt_false by lia. reflexivity.
  - rewrite zlt_true by lia. rewrite zlt_false by lia.
    rewrite Z.mul_sub_distr_l.
    replace (x' * y' - x' * modulus) with (x' * y' + (-x') * modulus) by lia.
    rewrite Z_div_plus by lia.
    apply eqm_samerepr. unfold mulhu. apply eqm_sub; auto with ints.
  - rewrite zlt_false by lia. rewrite zlt_true by lia.
    rewrite Z.mul_sub_distr_r.
    replace (x' * y' - modulus * y') with (x' * y' + (-y') * modulus) by lia.
    rewrite Z_div_plus by lia.
    apply eqm_samerepr; auto with ints. unfold mulhu. apply eqm_sub; auto with ints.
  - rewrite zlt_true by lia. rewrite zlt_true by lia.
    rewrite <- add_zero.
    rewrite Z.mul_sub_distr_r, Z.mul_sub_distr_l,  Z.mul_sub_distr_l.
    replace (x' * y' - x' * modulus - (modulus * y' - modulus * modulus)) with (x' * y' - x' * modulus - y' * modulus + modulus * modulus) by lia.
    rewrite Z_div_plus by lia.
    apply eqm_samerepr. rewrite unsigned_zero.
    replace (x' * y' - x' * modulus - y' * modulus) with (x' * y' + (-x' * modulus) + (-y' * modulus)) by lia.
    rewrite Z_div_plus by lia. rewrite Z_div_plus by lia.
    replace (x' * y' / modulus + - x' + - y') with (x' * y' / modulus - y' - x') by lia.
    apply eqm_add.
    apply eqm_unsigned_repr_r. unfold mulhu.
    apply eqm_sub; auto with ints.
    exists 1; auto.
Qed.
...
Lemma decompose_mulhu:
  forall xh xl yh yl,
    let xlyl := Int.mulhu xl yl in
    let xhyl_l := Int.mul xh yl  in
    let xlyh_l := Int.mul xl yh  in
    let xhyl_h := Int.mulhu xh yl in
    let xlyh_h := Int.mulhu xl yh in
    let k1 := ofwords Int.zero xlyl in
    let k2 := add (ofwords Int.zero xhyl_l) (ofwords Int.zero xlyh_l) in
    let k3 := add (ofwords Int.zero xhyl_h) (ofwords Int.zero xlyh_h) in
    mulhu (ofwords xh xl) (ofwords yh yl) = add (mul' xh yh) (add k3 (shru' (add k2 k1) (Int.repr 32))).
Proof.
  intros.
  assert (add k2 k1 = repr (Int.unsigned xhyl_l + Int.unsigned xlyh_l + Int.unsigned xlyl)).
  { subst k2. subst k1.  unfold add.
    rewrite ! ofwords_add'. rewrite ! Z.mul_0_l.  rewrite ! Z.add_0_l.
    apply eqm_samerepr. apply eqm_add; auto with ints.
  }
  rewrite H.
  assert (forall x, shru' x (Int.repr 32) = shru x (repr 32)) by reflexivity. rewrite !H0. rewrite shru_div_two_p.
  change (two_p (unsigned (repr 32))) with (two_p 32).
  subst k3. unfold add.  unfold mulhu.
  rewrite ! ofwords_add'. rewrite ! Z.mul_0_l. rewrite ! Z.add_0_l.
  rewrite ! Z.mul_add_distr_r. rewrite ! Z.mul_add_distr_l.
  rewrite ! Z.mul_assoc. rewrite ! Z.add_assoc.
  set (XL := Int.unsigned xl). set (XH := Int.unsigned xh).
  set (YL := Int.unsigned yl). set (YH := Int.unsigned yh).
  replace (XH * two_p 32 * YH * two_p 32) with (XH * YH * two_p 32 * two_p 32) by lia.
  replace (XH * two_p 32 * YL + XL * YH * two_p 32 + XL * YL) with
    ((XH * YL * two_p 32 + XL * YH * two_p 32 + XL * YL)) by lia.
  rewrite <- Z.add_assoc. rewrite <- Z.add_assoc. rewrite <- Z.mul_assoc.
  rewrite <- two_p_is_exp by lia. change (two_p (32 + 32)) with modulus.
  rewrite Z_div_plus_full_l by (generalize modulus_pos; lia).
  apply eqm_samerepr. unfold mul'. apply eqm_add; auto with ints.
  replace (XH * two_p 32 * YL + (XL * YH * two_p 32 + XL * YL)) with ((XH * YL + XL * YH) * two_p 32 + XL * YL) by lia.
  change modulus with ((two_p 32) * (two_p 32)).
  rewrite <- Zdiv_Zdiv by (simpl; compute; auto).
  rewrite Z_div_plus_full_l by (simpl; compute; lia).
  assert (forall x y, Int.unsigned x * Int.unsigned y = unsigned (mul' x y)).
  { intros. unfold mul'. symmetry. apply unsigned_repr.
    generalize (Int.unsigned_range x), (Int.unsigned_range y).
    intros. split. lia.
    exploit (Z.mul_lt_mono_nonneg (Int.unsigned x) Int.modulus (Int.unsigned y) Int.modulus); try lia.
    change (Int.modulus * Int.modulus) with modulus. unfold max_unsigned. lia.
  }
  unfold XH, XL, YL, YH. rewrite ! H1.
  rewrite ! mul'_mulhu. rewrite ! ofwords_add'.
  rewrite Z_div_plus_full_l by (simpl; compute; lia).
  exploit (Zdiv_small (Int.unsigned (Int.mul xl yl)) (two_p 32)). apply Int.unsigned_range.
  intros. rewrite H2, Z.add_0_r.
  fold xhyl_h. fold xlyh_h. fold xhyl_l. fold xlyh_l. fold xlyl.
  rewrite Z.add_assoc.
  replace (Int.unsigned xhyl_h * two_p 32 + Int.unsigned xhyl_l + Int.unsigned  xlyh_h * two_p 32 + Int.unsigned xlyh_l + Int.unsigned xlyl)
    with ((Int.unsigned xhyl_h * two_p 32 + Int.unsigned xlyh_h * two_p 32) + (Int.unsigned xhyl_l + Int.unsigned xlyh_l + Int.unsigned xlyl)) by lia.
  rewrite <- Z.mul_add_distr_r. rewrite Z_div_plus_full_l by (simpl; compute; lia).
  apply eqm_unsigned_repr_r. apply eqm_add; auto with ints.
  apply eqm_unsigned_repr_r. rewrite unsigned_repr; auto with ints.
  generalize (Int.unsigned_range xhyl_l), (Int.unsigned_range xlyh_l), (Int.unsigned_range xlyl).
  change Int.modulus with 4294967296. change max_unsigned with 18446744073709551615. lia.
Qed.
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_Ptrofs_wordsize_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_INTEGERS_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_NUMERICAL_LIMITS_002 *)
  Definition wordsize := if Archi.ptr64 then 64%nat else 32%nat.
(*- #End *)
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_Ptrofs_wordsize_not_zero_001 *)
(*- #Justify_Derived "Auxiliary remark" *)
  Remark wordsize_not_zero: wordsize <> 0%nat.
...
(*- E_COMPCERT_FTR_Function_Integers_Ptrofs_to_int_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition to_int (x: int): Int.int := Int.repr (unsigned x).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Ptrofs_to_int64_001 *)
(*- #Justify_Derived "Auxiliary definition" *)
Definition to_int64 (x: int): Int64.int := Int64.repr (unsigned x).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Integers_Ptrofs_of_int_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_009 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_014 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Ptrofs_of_intu_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_009 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_014 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Ptrofs_of_ints_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_009 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Ptrofs_of_int64_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_008 *)
(*- #Link_to E_COMPCERT_TOR_Function_ADDITIVE_OPERATORS_009 *)
(*- #Link_to E_COMPCERT_TOR_Function_ANNEX_J_014 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
