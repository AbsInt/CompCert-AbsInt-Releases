...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_unsigned_range_001 *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_unsigned_repr_001 *)
(*- #Justify_Derived "Auxiliary theorem" *)
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_ltu_inv_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma ltu_inv:
...
(*- E_COMPCERT_FTR_Function_Integers_Wordsize_zero_ext_range_eq_001 *)
(*- #Justify_Derived "Auxiliary lemma" *)
Lemma zero_ext_range_eq:
  forall n x, 0 <= n < zwordsize -> ltu x (repr (two_p n)) = true -> zero_ext n x = x.
Proof.
  intros.
  apply ltu_inv in H0.
  unfold zero_ext. rewrite Zzero_ext_mod by lia.
  rewrite Zmod_small. apply repr_unsigned.
  split. lia. rewrite unsigned_repr in H0. lia.
  split. exploit (two_p_gt_ZERO n); lia.
  unfold max_unsigned. rewrite modulus_power.
  exploit (two_p_monotone_strict n zwordsize); lia.
Qed.
(*- #End *)
