...
(*- E_COMPCERT_CODE_Tokenize_identstart_001 *)
(*- #Justify_Derived "Utility definition" *)
let identstart = [ '0'-'9' 'A'-'Z' 'a'-'z' '$' '_' ]
(*- #End *)

(*- E_COMPCERT_CODE_Tokenize_identcont_001 *)
(*- #Justify_Derived "Utility definition" *)
let identcont  = [ '0'-'9' 'A'-'Z' 'a'-'z' '$' '_' '-' '.' ]
(*- #End *)

(*- E_COMPCERT_CODE_Tokenize_tokenize_001 *)
...
(*- E_COMPCERT_CODE_Tokenize_tok_dquote_001 *)
(*- #Link_to E_COMPCERT_TR_Function_CPRAGMAS_001 *)
(*- #Link_to E_COMPCERT_TR_Function_CPRAGMAS_002 *)
(*- #Link_to E_COMPCERT_TR_Function_CPRAGMAS_003 *)
...
(*- E_COMPCERT_CODE_Tokenize_tok_squote_001 *)
(*- #Link_to E_COMPCERT_TR_Function_CPRAGMAS_001 *)
(*- #Link_to E_COMPCERT_TR_Function_CPRAGMAS_002 *)
(*- #Link_to E_COMPCERT_TR_Function_CPRAGMAS_003 *)
...
{
(*- E_COMPCERT_CODE_Tokenize_string_001 *)
