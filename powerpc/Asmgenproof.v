...
- destruct (preg_rpair_of r); try discriminate; destruct (preg_rpair_of r0). destruct r1, r2; inv H; TailNoLabel. destruct r1; inv H; TailNoLabel.
...
- destruct (preg_rpair_of r); inv EQ0. destruct r2; monadInv H0. eapply transl_select_op_label; eauto. eapply transl_fselect_op_label; eauto.
Qed.
...
- (* Mrestorecallee *)
  ...
  exploit compute_ireg_list_correct; eauto. intros. apply eqb_prop in H0. exploit exec_lmw_correct; eauto with asmgen.
  rewrite <- (sp_val _ _ _ AG); eauto. intros (rs3' & C & D & F).
...
- (* Msavecallee *)
  ...
  exploit compute_ireg_list_correct; eauto. intros. apply eqb_prop in H1. exploit exec_stmw_correct; eauto. rewrite <- (sp_val _ _ _ AG); eauto.
