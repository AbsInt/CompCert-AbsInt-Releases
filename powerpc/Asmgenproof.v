...
- (* Mrestorecallee *)
  ...
  simpl in Heqb. rewrite andb_false_r in Heqb. discriminate. intros E.
  ...
  exploit exec_lmw_correct. eapply eqb_prop. symmetry in Heqb. InvBooleans; auto.
  ...
  rewrite nextinstr_inv; eauto with asmgen. eapply load_stack_pregs_mregs; eauto with asmgen. discriminate.
...
- (* Msavecallee *) 
  ...
  exploit exec_stmw_correct. eapply eqb_prop. symmetry in Heqb. InvBooleans; auto.
  apply C. apply E. rewrite <- Pnt. rewrite (ireg_of_eq _ _ EQ).
  intros.
  destruct l1.
  (* Float list empty *)
  ...
  intros. apply nextinstr_inv; auto with asmgen. discriminate.
  ...
  simpl. split.
  rewrite G2; eauto with asmgen. rewrite G2; eauto with asmgen.
