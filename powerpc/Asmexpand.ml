...
(*- E_COMPCERT_CODE_Asmexpand_integer_cond_move_001 *)
(*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_025 *)
(*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_071 *)
...
let expand_builtin_inline name args res =
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_023 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_004 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_006 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_059 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_029 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_013 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_016 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_035 *)
  | "__builtin_eieio", [], _ ->
      emit (Peieio)
  (*- #End *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_049 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_051 *)
  ...
  (*- E_COMPCERT_CODE_Asmexpand_builtin_inline_050 *)
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_025 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_052 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_053 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_055 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_A_054 *)
...
let expand_instruction instr =
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_003 *)
  | Pextzw(r1, r2) ->
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_006 *)
  | Pfcfl(r1, r2) ->
      assert (Archi.ppc64);
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_008 *)
  | Pfcti(r1, r2) ->
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_010 *)
  | Pfctid(r1, r2) ->
      assert (Archi.ppc64);
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_011 *)
  | Pfxdp(r1, r2) ->
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_013 *)
  | Pllo r1 ->
      ()   (* no computational content *)
  (*- #End *)

  (*- E_COMPCERT_CODE_Asmexpand_instruction_015 *)
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_ASM_C_014 *)
  | Plhi(r1, r2) ->
