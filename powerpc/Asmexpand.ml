...
let expand_builtin_inline name args res =
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_FSEL_001 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_READ64_REVERSED_001 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_WRITE64_REVERSED_001 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_GET_SPR64_001 *)
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_SET_SPR64_001 *)
...
let expand_instruction instr =
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_PEXTZW_001 *)
  | Pextzw(r1, r2) ->
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_PFCFL_001 *)
  | Pfcfl(r1, r2) ->
      assert (Archi.ppc64);
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_PFCTID_001 *)
  | Pfctid(r1, r2) ->
      assert (Archi.ppc64);
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_PLMAKE_001 *)
  | Plmake(r1, rhi, rlo) ->
      if r1 = rlo then
  ...
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_PLLO_001 *)
  | Pllo r1 ->
      ()   (* no computational content *)
  (*- #End *)

  (*- E_COMPCERT_CODE_Asmexpand_instruction_015 *)
  (*- #Link_to E_COMPCERT_TR_Function_EXPAND_PLHI_001 *)
  | Plhi(r1, r2) ->
