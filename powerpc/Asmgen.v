...
Definition classify_condition (c: condition) (args: list mreg): condition_class c args :=
  ...
  | Ccompimm Cle n, r :: nil =>
      if  high_s_check n (Int.add n Int.one) then
...
Definition transl_op
  ...
  | Omove, a1 :: nil =>
      ...
      | One (IR r), One (IR a) => OK (Pmr r a :: k)
      | One (FR r), One (FR a) => OK (Pfmr r a :: k)
      |  _   ,  _    => Error(msg "Asmgen.Omove")
      end
  | Ointconst n, nil =>
      do r <- ireg_of_rpair res; OK (loadimm r n k)
  | Ofloatconst f, nil =>
      do r <- freg_of_rpair res; OK (Plfi r f :: k)
  | Osingleconst f, nil =>
      do r <- freg_of_rpair res; OK (Plfis r f :: k)
  ...
  | Ocast8signed, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Pextsb r r1 :: k)
  | Ocast16signed, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Pextsh r r1 :: k)
  | Oadd, a1 :: a2 :: nil =>
  ...
  | Onegf, a1 :: nil =>
      do r1 <- freg_of_rpair a1; do r <- freg_of_rpair res;
      OK (Pfneg r r1 :: k)
  | Oabsf, a1 :: nil =>
      do r1 <- freg_of_rpair a1; do r <- freg_of_rpair res;
      OK (Pfabs r r1 :: k)
  | Oaddf, a1 :: a2 :: nil =>
      do r1 <- freg_of_rpair a1; do r2 <- freg_of_rpair a2; do r <- freg_of_rpair res;
      OK (Pfadd r r1 r2 :: k)
  | Osubf, a1 :: a2 :: nil =>
      do r1 <- freg_of_rpair a1; do r2 <- freg_of_rpair a2; do r <- freg_of_rpair res;
      OK (Pfsub r r1 r2 :: k)
  ...
  | Ofloatofsingle, a1 :: nil =>
      ...
      OK (Pfxdp r r1 :: k)
  | Ointoffloat, a1 :: nil =>
      do r1 <- freg_of_rpair a1; do r <- ireg_of_rpair res;
      OK (Pfcti r r1 :: k)
  | Ofloatofwords, a1 :: a2 :: nil =>
      do r1 <- ireg_of_rpair a1; do r2 <- ireg_of_rpair a2; do r <- freg_of_rpair res;
      OK (Pfmake r r1 r2 :: k)
  | Ofsel, a1 :: a2 :: a3 :: nil =>
      do r1 <- freg_of_rpair a1; do r2 <- freg_of_rpair a2; do r3 <- freg_of_rpair a3; do r <- freg_of_rpair res;
      OK (Pfsel r r1 r2 r3 :: k)
  | Omakelong, a1 :: a2 :: nil =>
      do r1 <- ireg_of_rpair a1; do r2 <- ireg_of_rpair a2; do r <- ireg_of_rpair res; OK (Plmake r r1 r2 :: k)
  | Olowlong, a1 :: nil =>
      ...
      OK (Pllo r :: k)
  | Ohighlong, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res; OK (Plhi r r1 :: k)
  | Ocmp cmp, _ =>
...
(*c PPC64 operations *)
  | Olongconst n, nil =>
      do r <- ireg_of_rpair res; OK (loadimm64 r n k)
  ...
  | Oaddl, a1 :: a2 :: nil =>
      if Archi.splitlong then
        ...
        if ireg_eq rl ah || ireg_eq rl bh then
          OK (Paddc GPR0 al bl :: Padde rh ah bh :: Pmr rl GPR0 :: k)
        else
  ...
  | Osubl, a1 :: a2 :: nil =>
      if Archi.splitlong then
        ...
        do (bh, bl) <- iregs_of_rpair a2;
        if ireg_eq rl ah || ireg_eq rl bh then
          OK (Psubfc GPR0 bl al :: Psubfe rh bh ah :: Pmr rl GPR0 :: k)
        else
  ...
  | Onegl, a1 :: nil =>
      if Archi.splitlong then
        ...
        if ireg_eq rl ah then
          OK (Psubfic GPR0 al (Cint Int.zero) :: Psubfze rh ah :: Pmr rl GPR0 :: k)
        else
          OK (Psubfic rl al (Cint Int.zero) :: Psubfze rh ah :: k)
      else
        do r1 <- ireg_of_rpair a1; do r <- ireg_of_rpair res;
  ...
  | Olongoffloat, a1 :: nil =>
      ...
      OK (Pfctid r r1 :: k)
  | Ofloatoflong, a1 :: nil =>
      do r1 <- ireg_of_rpair a1; do r <- freg_of_rpair res;
      OK (Pfcfl r r1 :: k)
  | _, _ =>
...
(* If you alter this function please adjust expand_volatile_access in
   Asmexpand too *)
...
Definition transl_load_store_multiple_condition l ofs :=
  match l with
  | (m1 :: m2 :: l0) => eqb ppc64 false
                       && list_eq_dec preg_eq (map preg_of (m1 :: m2 :: l0)) (map IR (compute_ireg_list (preg_of m1)))
                       && Int.eq (high_s (Int.repr ofs)) Int.zero && (Int.eq (Int.mods (Int.repr ofs) (Int.repr 4)) Int.zero)
  | _ => false
  end.
...
Definition transl_instr (f: Mach.function) (i: Mach.instruction)
  ...
  | Mrestorecallee ofs l =>
      ...
      if transl_load_store_multiple_condition l ofs then
        ...
        | (m1 :: l1) => do r1 <- ireg_of m1;
                       OK (Plmw r1 SP (Cint (Int.repr (align ofs 4))) :: k)
  ...
  | Msavecallee ofs l =>
      ...
      if transl_load_store_multiple_condition l ofs then
        match l with
        | (m1 :: l1) => do r1 <- ireg_of m1;
                      OK (Pstmw r1 SP (Cint (Int.repr (align ofs 4))) :: k)
        | _ => Error (msg "Msavecallee nil")
        end
      else
