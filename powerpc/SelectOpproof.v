...
Proof.
  ...
  - (* BI_mull *)
    inv ARGS; try discriminate. inv H0; try discriminate. inv H2; inv SEL; inv SEM.
    exploit (eval_mulhu le a1 v1 a0 v0); auto. intros (hi & evalhi & lessdefhi).
    exploit (eval_mul le a1 v1 a0 v0); auto. intros (lo & evallo & lessdeflo).
    econstructor; split. EvalOp. reflexivity. rewrite Val.mull'_mulhu.
