...
module type SYSTEM =
    sig
      ...
      val cfi_adjust: out_channel -> Ptrofs.int -> unit
      val cfi_rel_offset: out_channel -> string -> Ptrofs.int -> unit
...
(*- E_COMPCERT_CODE_TargetPrinter_float_reg_name_001 *)
(*- #Justify_Derived "Utility function" *)
...
(*- E_COMPCERT_DEACTIVATED_CODE_Module_Diab_System_001 *)
...
module Target (System : SYSTEM):TARGET =
  struct
    ...
    (*- E_COMPCERT_CODE_TargetPrinter_ireg_or_zero_001 *)
    (*- #Justify_Derived "Utility function" *)
    ...
    (*- E_COMPCERT_CODE_TargetPrinter_rolm64_mask_001 *)
    (*- #Justify_Derived "Utility function" *)
    let rolm64_mask n =
    ...
    let print_instruction oc tbl pc fallthrough = function
      ...
      | Paddi64(r1, r2, n) ->
          fprintf oc "	addi	%a, %a, %a\n" ireg r1 ireg_or_zero r2 coqint64 n
      | Paddic(r1, r2, c) ->
      ...
      | Pcmpldi(r1, n) ->
          fprintf oc "	cmpldi	%a, %a, %a\n" creg 0 ireg r1 coqint64 n
      | Pcmplw(r1, r2) ->
      ...
      (*- #Link_to E_COMPCERT_TR_Function_PRINT_PLDI_PLFI_PLFIS_001 *)
      | Pldi(r1, c) ->
      ...
      | Poris64(r1, r2, n) ->
          fprintf oc "	oris	%a, %a, %a\n" ireg r1 ireg r2 coqint64 n
      | Prldicl(r1, r2, c1, c2) ->
          fprintf oc "	rldicl	%a, %a, %a, %a\n"
            ireg r1 ireg r2 coqint c1 coqint c2

      (*- - *)
      | Prldinm(r1, r2, c1, c2) ->
          let amount = camlint_of_coqint c1 in
          ...
          else if last = 63 - Int32.to_int amount then
      ...
      | Prldimi(r1, r2, c1, c2) ->
          ...
          let mask = camlint64_of_coqint c2 in
          let (first, last) = rolm64_mask mask in
          assert (last = 63 - Int32.to_int amount);
