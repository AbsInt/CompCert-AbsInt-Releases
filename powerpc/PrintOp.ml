...
let print_operation reg pp = function
  ...
  | Oaddsymbol(id, ofs), [r1] ->
      fprintf pp "\"%s\" + %Ld + %a" (extern_atom id) (camlint64_of_ptrofs ofs) reg r1
  ...
  | Ofsel, [r1;r2;r3] -> fprintf pp "%a >= 0. ? %a : %a" reg r1 reg r2 reg r3
  ...
  | Orolml(n,m), [r1] ->
      fprintf pp "(%a rol %ld) &l 0x%Lx"
              reg r1 (camlint_of_coqint n) (camlint64_of_coqint m)
