...
(*- E_COMPCERT_FTR_Function_Op_condition_0_001 *)
...
(*- E_COMPCERT_FTR_Function_Op_operation_0_001 *)
(*- #Justify_Derived "Internal type" *)
...
(*c Floating-point arithmetic: *)
  ...
  | Ofsel: operation                    (**r [rd = rc >= 0 ? r1 : r2]  *)
...
(*c Boolean tests: *)
  ...
  | Osel: condition -> typ -> operation. (**r [rd = rs1] if condition holds, [rd = rs2] otherwise. *)
(*- #End *)

(** Addressing modes.  [r1], [r2], etc, are the arguments to the
  addressing. *)

(*- E_COMPCERT_FTR_Function_Op_addressing_0_001 *)
(*- #Justify_Derived "Internal type" *)
...
Definition eval_operation
  ...
  | Ofsel, vc::v1::v2::nil => Some (Val.select (Val.cmpf_bool Cge vc (Vfloat Float.zero)) v1 v2 Tfloat)
...
Definition type_of_operation_typ (op: operation) : list typ * typ :=
  ...
  | Ofsel => (Tfloat :: Tfloat :: Tfloat :: nil, Tfloat)
  | Omakelong => (Tint :: Tint :: nil, Tlong)
  | Olowlong => (Tlong :: nil, Tint)
  | Ohighlong => (Tlong :: nil, Tint)
  | Ocmp c => (type_of_condition_typ c, Tint)
  | Osel c ty => (ty :: ty :: type_of_condition_typ c, ty)
  end.
...
Proof with (try exact I; try reflexivity).
  ...
  destruct v0...
  destruct v0...
  unfold Val.select. destruct (Val.cmpf_bool Cge v0 (Vfloat Float.zero)). apply Val.normalize_type. exact I.
...
Proof.
  ...
  destruct (Val.cmpf_bool Cge v (Vfloat Float.zero)) eqn:?; auto.
  right; symmetry. destruct v; inv Heqo. inv H4. auto.
