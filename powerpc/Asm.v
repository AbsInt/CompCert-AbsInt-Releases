...
Module IndexedPreg <: INDEXED_TYPE.
  Definition all_pregs : list preg :=
    IR GPR0  :: IR GPR1  :: IR GPR2  :: IR GPR3  :: IR GPR4  :: IR GPR5  :: IR GPR6
  :: IR GPR7  :: IR GPR8  :: IR GPR9  :: IR GPR10 :: IR GPR11 :: IR GPR12 :: IR GPR13
  :: IR GPR14 :: IR GPR15 :: IR GPR16 :: IR GPR17 :: IR GPR18 :: IR GPR19 :: IR GPR20
  :: IR GPR21 :: IR GPR22 :: IR GPR23 :: IR GPR24 :: IR GPR25 :: IR GPR26 :: IR GPR27
  :: IR GPR28 :: IR GPR29 :: IR GPR30 :: IR GPR31 :: FR FPR0  :: FR FPR1  :: FR FPR2
  :: FR FPR3  :: FR FPR4  :: FR FPR5  :: FR FPR6  :: FR FPR7  :: FR FPR8  :: FR FPR9
  :: FR FPR10 :: FR FPR11 :: FR FPR12 :: FR FPR13 :: FR FPR14 :: FR FPR15 :: FR FPR16
  :: FR FPR17 :: FR FPR18 :: FR FPR19 :: FR FPR20 :: FR FPR21 :: FR FPR22 :: FR FPR23
  :: FR FPR24 :: FR FPR25 :: FR FPR26 :: FR FPR27 :: FR FPR28 :: FR FPR29 :: FR FPR30
  :: FR FPR31 :: PC :: LR :: CTR :: CARRY :: CR0_0 :: CR0_1 :: CR0_2 :: CR0_3 :: CR1_2 :: nil.

  Lemma all_pregs_complete:
    forall (r: preg), In r all_pregs.
  Proof.
    assert (forall r, proj_sumbool (In_dec preg_eq r all_pregs) = true).
    { intros. case r; try intro r'; try destruct r'; reflexivity. }
  ...
  Definition index (r: preg): positive :=
    ...
    | GPR30 => 31 | GPR31 => 32 | FPR0 => 33 | FPR1 => 34 | FPR2 => 35
    | FPR3 => 36 | FPR4 => 37 | FPR5 => 38 | FPR6 => 39 | FPR7 => 40
    | FPR8 => 41 | FPR9 => 42 | FPR10 => 43 | FPR11 => 44 | FPR12 => 45
    | FPR13 => 46 | FPR14 => 47 | FPR15 => 48 | FPR16 => 49 | FPR17 => 50
    | FPR18 => 51 | FPR19 => 52 | FPR20 => 53 | FPR21 => 54 | FPR22 => 55
    | FPR23 => 56 | FPR24 => 57 | FPR25 => 58 | FPR26 => 59 | FPR27 => 60
    | FPR28 => 61 | FPR29 => 62 | FPR30 => 63 | FPR31 => 64 | PC => 65
    | LR => 66 | CTR => 67 | CARRY => 68 | CR0_0 => 69 | CR0_1 => 70
    | CR0_2 => 71 | CR0_3 => 72 | CR1_2 => 73
    end.
  (*- #End *)

  Local Open Scope positive_scope.
  (*- E_COMPCERT_FTR_Function_Asm_IndexedPreg_reverse_ireg_index_001 *)
  (*- #Justify_Derived "Internal definition to map integers to pregs" *)
  Definition reverse_ireg_index (p: positive) :=
    match p with
    | 1 => GPR0 | 2 => GPR1 | 3 => GPR2 | 4 => GPR3 | 5 => GPR4
    | 6 => GPR5 | 7 => GPR6 | 8 => GPR7 | 9 => GPR8 | 10 => GPR9
    | 11 => GPR10 | 12 => GPR11 | 13 => GPR12 | 14 => GPR13 | 15 => GPR14
    | 16 => GPR15 | 17 => GPR16 | 18 => GPR17 | 19 => GPR18 | 20 => GPR19
    | 21 => GPR20 | 22 => GPR21 | 23 => GPR22 | 24 => GPR23 | 25 => GPR24
    | 26 => GPR25 | 27 => GPR26 | 28 => GPR27 | 29 => GPR28 | 30 => GPR29
    | 31 => GPR30 | _ => GPR31
    end.
  (*- #End *)
...
Inductive instruction : Type :=
  ...
  | Plmw: ireg -> ireg -> constant -> instruction             (**r load multiple 32-bit int *)
  ...
  | Pstmw: ireg -> ireg -> constant -> instruction            (**r store multiple 32-bit int *)                                
  ...
  | Pcfi_rel_offset: ptrofs -> instruction.                   (**r .cfi_rel_offset lr debug directive *)
(*- #End *)
...
(*- E_COMPCERT_FTR_Function_Asm_load_store_multiple_condition_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Definition load_store_multiple_condition (r1: ireg) (ra: ireg) :=
  plt (IndexedPreg.index (IR ra)) (IndexedPreg.index (IR r1))
  && negb (preg_eq ra GPR0).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Asm_compute_ireg_list_001 *)
(*- #Justify_Derived "Auxiliary function to compute register list from start and end register" *)
Definition compute_ireg_list (r : preg) :=
  Pos.peano_rect (fun _ => list ireg) (GPR31 :: nil)
    (fun p l => (IndexedPreg.reverse_ireg_index (32 - p)) :: l) (33 - (IndexedPreg.index r)).
(*- #End *)

(*- E_COMPCERT_FTR_Function_Asm_exec_lmw_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Fixpoint exec_lmw (base: val) (l : list ireg) (rs: regset) (m: mem) :=
  match l with
  | r::l => match Mem.loadv Many32 m base with
          | Some v => exec_lmw (Val.offset_ptr base (Ptrofs.repr 4)) l (rs#r <- v) m
          | None => Stuck
          end
...
(*- E_COMPCERT_FTR_Function_Asm_exec_stmw_001 *)
(*- #Link_to E_COMPCERT_TOR_Function_SEM_ASM_006 *)
Fixpoint exec_stmw (base: val) (l: list ireg) (rs: regset) (m: mem) :=
  match l with
  | r::l => match Mem.storev Many32 m base (rs r) with
           | Some m' => exec_stmw (Val.offset_ptr base (Ptrofs.repr 4)) l rs m'
           | None => Stuck
           end
  | nil => Next (nextinstr rs) m
  end.
...
Definition exec_instr (f: function) (i: instruction) (rs: regset) (m: mem) : outcome :=
  ...
  | Plmw r1 ra d =>
      if load_store_multiple_condition r1 ra
      then exec_lmw (Val.add (gpr_or_zero rs ra) (const_low d)) (compute_ireg_list (IR r1)) rs m
      else Stuck
  | Plwz rd cst r1 =>
  ...
  | Pstmw r1 ra d =>
      if load_store_multiple_condition r1 ra
      then exec_stmw (Val.add (gpr_or_zero rs ra) (const_low d)) (compute_ireg_list (IR r1)) rs m
      else Stuck
  | Pstw rd cst r1 =>
  ...
  | Psubfze rd r1 =>
      Next (nextinstr (rs#rd <- (Val.add (Val.notint rs#r1) rs#CARRY))) m
  | Pxor rd r1 r2 =>
